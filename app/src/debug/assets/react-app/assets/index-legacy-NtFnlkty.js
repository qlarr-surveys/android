    ...
    return {
      execute: function execute() {
        ...
        if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
          try {
            __vitePreload(() => module.import('./browser-ponyfill-legacy-RRb-fXFO.js').then(n => n.b), false ? __VITE_PRELOAD__ : void 0).then(function (mod) {
        ...
        */
        ...
        const Web = null;
        const Android = reactExports.lazy(() => __vitePreload(() => module.import('./Android-legacy-DzAx3JE1.js').then(n => n.ao), false ? __VITE_PRELOAD__ : void 0));
        function App() {
...
//# sourceMappingURL=index-legacy-NtFnlkty.js.map
