...
(function () {
  ...
  System.register(['./index-legacy-1AolfYmu.js', './Android-legacy-BuzJjxPU.js'], function (exports, module) {
    ...
    var getAugmentedNamespace, commonjsGlobal, getDefaultExportFromCjs, reactExports, jsxs, jsx, Fragment, propTypesExports, useService, useSelector, useDispatch, downloadFileAsBase64, previewUrlByFilename, Box, Button, uploadDataUrl, valueChange;
    return {
      setters: [module => {
        ...
        downloadFileAsBase64 = module.X;
        previewUrlByFilename = module.Y;
        Box = module.Z;
        Button = module.x;
        uploadDataUrl = module.$;
...
//# sourceMappingURL=Signature-legacy-CQSpTNpn.js.map
