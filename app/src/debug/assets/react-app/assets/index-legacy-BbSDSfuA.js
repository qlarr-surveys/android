...
(function () {
  ...
  System.register(['./index-legacy-DHZhPI7F.js', './use-service-legacy-Dvd5TXWp.js', './Image-legacy-CUlM-pl3.js', './DateUtils-legacy-Dg58phWT.js', './Web-legacy-DvtjkKFa.js', './dayjs.min-legacy-CpSITYE_.js', './Delete-legacy-BR1NG7Na.js', './common-legacy-B-ynqPDp.js', './TextField-legacy-C04XnsWd.js', './Check-legacy-_76K18mG.js', './Card-legacy-C3ntY_pV.js', './CardMedia-legacy-0wAW1jt0.js', './Divider-legacy-CQNr_ICh.js', './yup-legacy-CU6Kjk4F.js', './survey-legacy-CmPJYFAs.js', './TablePagination-legacy-BaU0TWu-.js', './Checkbox-legacy-DFqn5IuL.js', './SwitchBase-legacy-Bo564_DK.js', './Tabs-legacy-CR0rpc1G.js', './radioClasses-legacy-BjRfdHDd.js', './tableRowClasses-legacy-6YY-TDzx.js', './FormControlLabel-legacy-CSy-e4Kr.js', './TableCell-legacy-CywGf8iD.js', './Toolbar-legacy-Bj141DPD.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        processApiError = module.be;
        getDirFromSession = module.bf;
        Container = module.aK;
        Button = module.aD;
        Fade = module.aY;
        Close = module.aO;
...
//# sourceMappingURL=index-legacy-BbSDSfuA.js.map
