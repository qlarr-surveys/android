const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Android-BBYOUnem.js","assets/Android-BsuRnH6J.css"])))=>i.map(i=>d[i]);
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    __vitePreload(() => import("./browser-ponyfill-Bdk4z0Kj.js").then((n2) => n2.b), true ? [] : void 0).then(function(mod) {
...
const Android = reactExports.lazy(() => __vitePreload(() => import("./Android-BBYOUnem.js").then((n2) => n2.ap), true ? __vite__mapDeps([0,1]) : void 0));
...
//# sourceMappingURL=index-CM5T10V1.js.map
