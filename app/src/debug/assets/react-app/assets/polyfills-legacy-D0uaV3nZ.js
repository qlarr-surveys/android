(function () {
	...
	var toString$o = uncurryThis$10({}.toString);
	...
	var toString$n = uncurryThis$Y(1.1.toString);
	...
	var isForced$4 = function (feature, detection) {
	  ...
	  return value === POLYFILL ? true
	    : value === NATIVE ? false
	    : isCallable$o(detection) ? fails$J(detection)
	    : !!detection;
	};
	...
	*/
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  $$1d({ global: true, constructor: true, arity: 1, forced: FORCED$g }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    $$1d({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$g }, O);
	  }
	};
	...
	var isConstructor$5 = !construct || fails$H(function () {
	  var called;
	...
	$$1c({ target: 'Array', proto: true, arity: 1, forced: FORCED$f }, {
	...
	// `Array.from` method
	// https://tc39.es/ecma262/#sec-array.from
	$$1a({ target: 'Array', stat: true, forced: INCORRECT_ITERATION }, {
	  from: from
	});
	...
	// `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	$$19({ target: 'Array', proto: true, forced: BROKEN_ON_SPARSE }, {
	...
	// `Array.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-array.prototype.indexof
	$$18({ target: 'Array', proto: true, forced: FORCED$e }, {
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$l(IteratorPrototype$4) || fails$B(function () {
	  var test = {};
	...
	$$15({ target: 'Array', proto: true, arity: 1, forced: FORCED$d }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	// `Array.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-array.prototype.reduce
	$$14({ target: 'Array', proto: true, forced: FORCED$c }, {
	...
	// with adding support of @@species
	$$11({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	...
	$$10({ target: 'Array', proto: true, arity: 1, forced: FORCED$a }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$$({ global: true, forced: globalThis$O.globalThis !== globalThis$O }, {
	...
	var FORCED$9 = !isCallable$g(NativeIterator)
	...
	$$_({ global: true, constructor: true, forced: FORCED$9 }, {
	...
	$$Z({ target: 'Iterator', proto: true, real: true, forced: everyWithoutClosingOnEarlyError }, {
	...
	$$X({ target: 'Iterator', proto: true, real: true, forced: findWithoutClosingOnEarlyError }, {
	...
	$$W({ target: 'Iterator', proto: true, real: true, forced: forEachWithoutClosingOnEarlyError }, {
	...
	$$V({ target: 'Iterator', proto: true, real: true, forced: FORCED$7 }, {
	...
	var FAILS_ON_INITIAL_UNDEFINED = fails$x(function () {
	...
	$$U({ target: 'Iterator', proto: true, real: true, forced: FAILS_ON_INITIAL_UNDEFINED || reduceWithoutClosingOnEarlyError }, {
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var REPLACE = isForced$2(
	    CONSTRUCTOR_NAME,
	    !isCallable$d(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$s(function () {
	...
	$$Q({ target: 'Object', stat: true, sham: !DESCRIPTORS$i }, {
	...
	var FLAGS_GETTER_IS_CORRECT = !fails$q(function () {
	...
	var exec$7 = uncurryThis$F(RegExpPrototype$2.exec);
	...
	var BASE_FORCED = DESCRIPTORS$g &&
	  (!CORRECT_NEW || MISSED_STICKY || UNSUPPORTED_DOT_ALL$2 || UNSUPPORTED_NCG$1 || fails$m(function () {
	    re2[MATCH$1] = false;
	...
	var FORCED$6 = SET_LIKE_INCORRECT_BEHAVIOR || fails$l(function () {
	...
	// `Set.prototype.difference` method
	// https://tc39.es/ecma262/#sec-set.prototype.difference
	$$F({ target: 'Set', proto: true, real: true, forced: FORCED$6 }, {
	...
	// `Set.prototype.symmetricDifference` method
	// https://tc39.es/ecma262/#sec-set.prototype.symmetricdifference
	$$A({ target: 'Set', proto: true, real: true, forced: FORCED$5 }, {
	...
	// `Set.prototype.union` method
	// https://tc39.es/ecma262/#sec-set.prototype.union
	$$z({ target: 'Set', proto: true, real: true, forced: FORCED$4 }, {
	  union: union
	});
	...
	var slice$4 = uncurryThis$B(''.slice);
	var min$6 = Math.min;
	...
	fixRegExpWellKnownSymbolLogic$3('match', function (MATCH, nativeMatch, maybeCallNative) {
	  return [
	    ...
	    function match(regexp) {
	      ...
	      return matcher ? call$g(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$b(O));
	    },
	...
	var stringIndexOf = uncurryThis$w(''.indexOf);
	  ...
	  return [
	    ...
	    function replace(searchValue, replaceValue) {
	      ...
	      return replacer
	        ...
	        : call$f(nativeReplace, toString$a(O), searchValue, replaceValue);
	    },
	...
	fixRegExpWellKnownSymbolLogic$1('search', function (SEARCH, nativeSearch, maybeCallNative) {
	  return [
	    ...
	    function search(regexp) {
	      ...
	      return searcher ? call$e(searcher, regexp, O) : new RegExp(regexp)[SEARCH](toString$9(O));
	    },
	  ...
	  return [
	    ...
	    function split(separator, limit) {
	      ...
	      return splitter
	        ...
	        : call$d(internalSplit, toString$8(O), separator, limit);
	    },
	...
	$$t({ global: true, constructor: true, forced: FORCED_CONSTRUCTOR }, { // TODO: fix export logic
	...
	$$s({ global: true, bind: true, enumerable: true, forced: globalThis$s.clearImmediate !== clearImmediate }, {
	...
	$$r({ global: true, bind: true, enumerable: true, forced: globalThis$q.setImmediate !== setImmediate }, {
	...
	$$q({ global: true, enumerable: true, dontCallGetSet: true, forced: WRONG_ARITY }, {
	...
	try {
	  ...
	  } else $$p({ global: true, simple: true, forced: INCORRECT_VALUE }, {
	    self: globalThis$o
	  });
	} catch (error) { /* empty */ }
	...
	var exec$3 = uncurryThis$n(regexSeparators.exec);
	...
	$$o({ target: 'String', stat: true, arity: 1, forced: INCORRECT_LENGTH }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var replace = uncurryThis$k(''.replace);
	...
	$$m({ global: true, constructor: true, forced: !USE_NATIVE_URL, sham: !DESCRIPTORS$6 }, {
	  URL: URLConstructor
	});
	...
	var arrayLastIndexOf = FORCED$3 ? function lastIndexOf(searchElement /* , fromIndex = @[*-1] */) {
	  ...
	  var index = length - 1;
	  if (arguments.length > 1) index = min$2(index, toIntegerOrInfinity$8(arguments[1]));
	...
	var arrayValues = uncurryThis$b(ArrayIterators.values);
	var arrayKeys = uncurryThis$b(ArrayIterators.keys);
	var arrayEntries = uncurryThis$b(ArrayIterators.entries);
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (globalThis$4.Uint8Array) $$5({ target: 'Uint8Array', proto: true }, {
