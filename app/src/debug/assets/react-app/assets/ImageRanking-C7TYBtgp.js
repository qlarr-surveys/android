...
import { B as Box, u as useTheme, m as css } from "./mui-D3o-L0Jn.js";
import { u as useSelector, s as shallowEqual, b as useDispatch } from "./redux-CLa1pDoQ.js";
import { e as buildResourceUrl, C as Content, s as setDirty, v as valueChange, r as rtlLanguage } from "./Android-BzAC49gk.js";
...
function ImageRankingItem(props) {
  ...
  return /* @__PURE__ */ jsxs(Box, { "data-code": props.option.code, sx: {
    ...
    !props.hideText && /* @__PURE__ */ jsx(Content, { customStyle: "\n                             text-align: center;\n                             margin-top: 8px;\n                           ", content: (_b = props.option.content) == null ? void 0 : _b.label })
  ] }, props.option.code);
}
export {
  ImageRanking as default
};
//# sourceMappingURL=ImageRanking-C7TYBtgp.js.map
