import { h as capitalize, r as reactExports, b as _objectWithoutPropertiesLoose, _ as _extends, d as clsx, j as jsxRuntimeExports, q as interopRequireDefaultExports, B as Box, s as useNavigate, aj as useTheme, z as LoadingDots } from "./index-GLBW3_uR.js";
import { f as styled, j as useDefaultProps, x as useSlotProps, c as composeClasses, e as createSvgIcon, K as requireCreateSvgIcon, T as Typography, bf as truncateWithEllipsis, I as IconButton, M as useTranslation, R as useService, U as useDispatch, aO as Stack, X as setLoading, aR as PROCESSED_ERRORS, bg as processApiError, V as getDirFromSession, aN as Container, aQ as Button, a_ as Fade, J as TokenService } from "./use-service-BKPqOjBj.js";
import { u as usePreviousProps, d as default_1$3, a as default_1$5, D as DeleteModal } from "./Image-Cc_S3M1y.js";
import { s as serverDateTimeToLocalDateTime, l as localDateToServerDateTime } from "./DateUtils-D9XCaXee.js";
import { b as badgeClasses, g as getBadgeUtilityClass, T as Tooltip, E as Edit, S as SavingSurvey, a as Snackbar, A as Alert, i as isSurveyAdmin, d as default_1$4, c as default_1$6, e as RHFSelect, u as useForm, F as FormProvider, R as RHFTextField, f as SurveyClone, h as ROLES } from "./Web-DadasGuA.js";
import { d as dayjs } from "./dayjs.min-C0qtLe5E.js";
import { d as default_1$7 } from "./Delete-BAVnZigu.js";
...
import { c as create$3, a as create$6, o, L as LoadingButton } from "./yup-DOAccs7R.js";
...
const EditableSurveyTitle = ({ survey, onSave, isEditable = true }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { className: styles$2.titleContainer, children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    TextField,
    {
      sx: { px: 3, flexGrow: 1 },
      value: title,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Tooltip,
      {
        ...
        arrow: true,
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h4", sx: { px: 3 }, noWrap: true, children: truncateWithEllipsis(title, 18) })
      }
    ),
...
const EditableSurveyDescription = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { className: styles$2.descriptionContainer, children: isDescriptionEditing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    TextField,
    {
      sx: { px: 3 },
      value: description,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Tooltip,
      {
        title: (description == null ? void 0 : description.length) > charLimit ? description : "",
        sx: {
          fontSize: "1.2rem"
        },
        arrow: true,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Stack, { spacing: 0.5, sx: { mb: 1 }, children: [
              ...
              !example && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { sx: { px: 3, display: "flex", gap: 2, my: 0.5 }, children: [
                  !example && survey.status !== "closed" && survey.latestVersion.published === false && /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: "Has unpublished changes", children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1, { sx: { color: "text.secondary" } }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Tooltip,
                    {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Stack,
            {
              ...
              children: [
                ...
                isSurveyAdmin() && !example && survey.status === "active" && /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: t("edit_survey.close_title"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  IconButton,
                  {
                    className: styles$2.iconButton,
                    "aria-label": "stop",
                ...
                isSurveyAdmin() && /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: t("edit_survey.clone_survey"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  IconButton,
                  {
                    className: styles$2.iconButton,
                    "aria-label": "clone",
                ...
                !example && survey.status !== STATUS.ACTIVE && /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { title: t("action_btn.delete"), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  IconButton,
                  {
                    className: styles$2.iconButton,
                    "aria-label": "delete",
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles$3.mainContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Container, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles$3.content, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Stack,
        {
      ...
      isCreateSurveyOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(Fade, { in: isCreateSurveyOpen, timeout: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "relative" }, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CreateSurvey, { onSurveyCreated: fetchSurveys })
      ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { className: styles$3.surveyCardsContainer, children: !fetchingSurveys ? /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: ((_a = surveys == null ? void 0 : surveys.surveys) == null ? void 0 : _a.length) > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        Box,
        {
          sx: {
            mt: 3,
          ...
          children: (_b = surveys == null ? void 0 : surveys.surveys) == null ? void 0 : _b.map((survey) => {
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              Survey,
              {
                survey,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h6", color: "textSecondary", sx: { mt: 2 }, children: t("create_survey.empty_state_message") })
      ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingDots, {}) }),
...
//# sourceMappingURL=index-O6k4ewB-.js.map
