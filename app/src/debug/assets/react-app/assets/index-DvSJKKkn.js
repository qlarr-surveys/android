const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Android-D3DmgCW3.js","assets/Android-CSOnaIVM.css"])))=>i.map(i=>d[i]);
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    __vitePreload(() => import("./browser-ponyfill-Bt7HCUL9.js").then((n2) => n2.b), true ? [] : void 0).then(function(mod) {
...
const Web = null;
const Android = reactExports.lazy(() => __vitePreload(() => import("./Android-D3DmgCW3.js").then((n2) => n2.ao), true ? __vite__mapDeps([0,1]) : void 0));
function App() {
...
//# sourceMappingURL=index-DvSJKKkn.js.map
