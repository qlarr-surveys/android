import { P as THEME_ID, x as _objectWithoutPropertiesLoose, X as React, z as _extends, r as reactExports, H as generateUtilityClass, t as generateUtilityClasses, o as extendSxProp, m as jsxRuntimeExports, F as clsx$1, K as resolveBreakpointValues, J as handleBreakpoints, h as capitalize, e as getDefaultExportFromCjs, au as commonjsGlobal, u as useTheme$1, as as jsx, aw as Fragment } from "./index-CM5T10V1.js";
import { u as useThemeProps$1, d as defaultTheme, _ as _inheritsLoose, f as forceReflow, T as Transition, a as useDefaultProps, b as useTheme, s as styled, c as composeClasses, e as useFormControl, F as FormControlContext, g as Typography, B as ButtonBase, h as createSvgIcon, i as useEnhancedEffect, j as debounce, o as ownerWindow, k as useRtl, l as useSlotProps, m as useEventCallback, n as ownerDocument, p as alpha, q as useControlled, r as Fade, t as TransitionGroup, v as useForkRef, I as IconButton, w as useId, x as Button, D as DialogActions, G as Grow, y as FocusTrap, P as Popper, z as Paper, A as Dialog, C as dialogClasses, E as DialogContent, H as useMediaQuery, J as useSelector, K as shallowEqual, L as useDispatch, M as TextField, N as valueChange } from "./Android-BBYOUnem.js";
let cachedType;
...
function DateTimeQuestion(props) {
  ...
  return /* @__PURE__ */ jsx("div", { className: styles.wrapper, children: /* @__PURE__ */ jsx(LocalizationProvider, { dateAdapter: AdapterDayjs, adapterLocale: "ar-sa", children: props.component.type == "date_time" ? /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(DateTimePicker, { renderInput: (props2) => /* @__PURE__ */ jsx(TextField, { size: "small", onKeyDown: (e) => e.preventDefault(), ...props2 }), margin: "normal", value: state.value, inputFormat: dateFormat + " " + (props.component.fullDayFormat ? "HH:mm" : "hh:mm A"), PaperProps: {
    sx: {
  ...
  }, ampm: props.component.fullDayFormat ? false : true, openTo: "year", views: ["year", "month", "day", "hours", "minutes"], id: props.component.qualifiedCode, minDate: props.component.minDate ? dayjs(window.QlarrScripts.dateStringToDate(props.component.minDate)) : void 0, maxDate: props.component.maxDate ? dayjs(window.QlarrScripts.dateStringToDate(props.component.maxDate)) : void 0, error: state.invalid, onChange: handleDateChange }) }) : props.component.type == "time" ? /* @__PURE__ */ jsx(TimePicker, { renderInput: (params) => /* @__PURE__ */ jsx(TextField, { size: "small", onKeyDown: (e) => e.preventDefault(), ...params }), margin: "normal", openTo: "hours", views: ["hours", "minutes"], ampm: props.component.fullDayFormat ? false : true, inputFormat: props.component.fullDayFormat ? "HH:mm" : "hh:mm A", id: props.component.qualifiedCode, value: state.value, error: state.invalid, onChange: handleDateChange, PaperProps: {
    sx: {
      backgroundColor: "white",
      "& .MuiPickersDay-root": {
        backgroundColor: "white"
  ...
  } }) : /* @__PURE__ */ jsx(DatePicker, { renderInput: (params) => /* @__PURE__ */ jsx(TextField, { size: "small", onKeyDown: (e) => e.preventDefault(), ...params }), margin: "normal", openTo: "year", views: ["year", "month", "day"], ampm: props.component.fullDayFormat ? false : true, id: props.component.qualifiedCode, inputFormat: dateFormat, value: state.value, minDate: props.component.minDate ? window.QlarrScripts.dateStringToDate(props.component.minDate) : void 0, PaperProps: {
    sx: {
      backgroundColor: "white",
      "& .MuiPickersDay-root": {
        backgroundColor: "white"
  ...
  }, maxDate: props.component.maxDate ? window.QlarrScripts.dateStringToDate(props.component.maxDate) : void 0, error: state.invalid, onChange: handleDateChange }) }) });
}
export {
  DateTimeQuestion as default
};
//# sourceMappingURL=DateTimeQuestion-glfAS_2N.js.map
