    ...
    return {
      execute: function execute() {
        ...
        if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
          try {
            __vitePreload(() => module.import('./browser-ponyfill-legacy-C3_cAuXt.js').then(n => n.b), false ? __VITE_PRELOAD__ : void 0).then(function (mod) {
        ...
        const Web = null;
        const Android = reactExports.lazy(() => __vitePreload(() => module.import('./Android-legacy-CjEUwhux.js').then(n => n.au), false ? __VITE_PRELOAD__ : void 0));
        function App() {
...
//# sourceMappingURL=index-legacy-Dac_YmKi.js.map
