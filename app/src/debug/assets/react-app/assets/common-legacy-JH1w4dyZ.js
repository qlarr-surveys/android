...
(function () {
  ...
  System.register(['./use-service-legacy-uNDfwPef.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        CLOUD_URL = module.bv;
        BACKEND_BASE_URL = module.bw;
        PROTOCOL = module.bx;
        FRONT_END_HOST = module.by;
      }],
...
//# sourceMappingURL=common-legacy-JH1w4dyZ.js.map
