...
(function () {
  ...
  System.register(['./index-legacy-BTM6HcrS.js', './Android-legacy-Cy_R2t8i.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        __vitePreload = module.ae;
        getAugmentedNamespace = module.N;
        commonjsGlobal = module.a9;
        getDefaultExportFromCjs = module.e;
      }, module => {
        propTypesExports = module.a0;
      }],
      execute: function execute() {
        ...
        var players_default = [{
          ...
          './FilePlayer-legacy-Dnqig9iP.js').then(n => n.F), false ? __VITE_PRELOAD__ : void 0))
        }];
        ...
        './Preview-legacy-BJsc1J9S.js').then(n => n.P), false ? __VITE_PRELOAD__ : void 0));
...
//# sourceMappingURL=index-legacy-DBQQjEsp.js.map
