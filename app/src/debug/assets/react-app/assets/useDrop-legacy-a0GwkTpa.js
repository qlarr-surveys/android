...
(function () {
  ...
  System.register(['./use-service-legacy-BbL3A7cT.js', './index-legacy-ppEgxGbl.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        invariant = module.bC;
        shallowEqual = module.bM;
        wrapConnectorHooks = module.bN;
        isRef = module.bO;
        useDragDropManager = module.bP;
        useIsomorphicLayoutEffect = module.bQ;
        registerTarget = module.bR;
        useOptionalFactory = module.bS;
        useCollectedProps = module.bT;
      }, module => {
...
//# sourceMappingURL=useDrop-legacy-a0GwkTpa.js.map
