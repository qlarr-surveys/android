...
(function () {
  ...
  System.register(['./index-legacy-DHZhPI7F.js', './index-legacy-EC0VeEyt.js', './index-legacy--euVf_EY.js', './Web-legacy-DvtjkKFa.js', './survey-legacy-CmPJYFAs.js', './use-service-legacy-Dvd5TXWp.js', './DateUtils-legacy-Dg58phWT.js', './index-legacy-C-5PdcPg.js', './common-legacy-B-ynqPDp.js', './Tabs-legacy-CR0rpc1G.js', './TextField-legacy-C04XnsWd.js', './index-legacy-Dek6s2x3.js', './dayjs.min-legacy-CpSITYE_.js', './DateTimePicker-legacy-YrOj92Gf.js', './InputAdornment-legacy-Bj6eETKt.js', './Checkbox-legacy-DFqn5IuL.js', './SwitchBase-legacy-Bo564_DK.js', './radioClasses-legacy-BjRfdHDd.js', './tableRowClasses-legacy-6YY-TDzx.js', './FormControlLabel-legacy-CSy-e4Kr.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        Typography = module.T;
        IconButton = module.I;
        surveyAttributeChanged = module.bY;
        requireCreateSvgIcon = module.K;
        propTypesExports = module.F;
        Button = module.aD;
        SurveyIcon = module.aQ;
        useService = module.R;
        setSaving = module.bZ;
        newVersionReceived = module.b_;
      }, module => {
...
//# sourceMappingURL=index-legacy-Bq5sGX5q.js.map
