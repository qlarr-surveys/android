const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-ponyfill-BfQkcz9z.js","assets/vendor-C1A_Wzx1.js"])))=>i.map(i=>d[i]);
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    __vitePreload(() => import("./browser-ponyfill-BfQkcz9z.js").then((n) => n.b), true ? __vite__mapDeps([0,1]) : void 0).then(function(mod) {
...
//# sourceMappingURL=i18n-CpdhL4GU.js.map
