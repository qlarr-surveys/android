;
(function () {
  System.register(['./index-legacy-DbBgSDRL.js', './Android-legacy-DTaKd7fz.js', './Checkbox-legacy-BxAdWEnp.js', './RadioGroup-legacy-CuS4YHwa.js', './SwitchBase-legacy-Ecb0WmFB.js', './RadioGroupContext-legacy-W3VXuwxF.js'], function (exports, module) {
    'use strict';

    var reactExports, jsx, css, useTheme, useDispatch, useSelector, shallowEqual, Content, valueChange, setDirty, FormControl, TextField, Validation, Checkbox, FormControlLabel, RadioGroup;
    return {
      setters: [module => {
...
//# sourceMappingURL=Mcq-legacy-DEmTXROb.js.map
