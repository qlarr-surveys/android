    ...
    return {
      execute: function execute() {
        ...
        if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
          try {
            __vitePreload(() => module.import('./browser-ponyfill-legacy-C-t6IXRa.js').then(n => n.b), false ? __VITE_PRELOAD__ : void 0).then(function (mod) {
        ...
        */
        ...
        const Web = null;
        const Android = reactExports.lazy(() => __vitePreload(() => module.import('./Android-legacy-CUP-ssMq.js').then(n => n.ao), false ? __VITE_PRELOAD__ : void 0));
        function App() {
...
//# sourceMappingURL=index-legacy-JN-cdx_K.js.map
