...
(function () {
  System.register(['./index-legacy-DbBgSDRL.js', './Android-legacy-DTaKd7fz.js'], function (exports, module) {
    ...
    var reactExports, generateUtilityClass, generateUtilityClasses, _objectWithoutPropertiesLoose, _extends, jsxRuntimeExports, clsx, capitalize, lighten_1, darken_1, alpha_1, useDefaultProps, styled, composeClasses;
    return {
      setters: [module => {
      ...
      execute: function execute() {
        ...
        const Table = exports("d", /* @__PURE__ */reactExports.forwardRef(function Table2(inProps, ref) {
    ...
    ${theme.palette.mode === "light" ? lighten_1(alpha_1(theme.palette.divider, 1), 0.88) : darken_1(alpha_1(theme.palette.divider, 1), 0.68)}`,
        ...
        const TableCell = exports("b", /* @__PURE__ */reactExports.forwardRef(function TableCell2(inProps, ref) {
          const props = useDefaultProps({
            props: inProps,
            name: "MuiTableCell"
          });
        ...
        const TableContainer = exports("e", /* @__PURE__ */reactExports.forwardRef(function TableContainer2(inProps, ref) {
          const props = useDefaultProps({
            props: inProps,
            name: "MuiTableContainer"
          });
        ...
        const TableRow = exports("a", /* @__PURE__ */reactExports.forwardRef(function TableRow2(inProps, ref) {
          const props = useDefaultProps({
            props: inProps,
            name: "MuiTableRow"
          });
...
//# sourceMappingURL=TableRow-legacy-DBZtWfqw.js.map
