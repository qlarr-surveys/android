...
(function () {
  ...
  System.register(['./index-legacy-ppEgxGbl.js', './yup-legacy-hoJlT6dt.js', './Web-legacy-fPm5GX2O.js', './router-link-legacy-CnEAm5KO.js', './use-service-legacy-BbL3A7cT.js', './Link-legacy-CyFPht-Y.js', './Checkbox-legacy-BOCzBChM.js', './SwitchBase-legacy-tIJzAgb-.js', './Tabs-legacy-CXNTfVGs.js', './radioClasses-legacy-Cc_gAbFN.js', './tableRowClasses-legacy-DKGRrcou.js', './TextField-legacy-Dle1a096.js', './FormControlLabel-legacy-BPCe018b.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, useNavigate, Box, reactExports, create$3, create$6, LoadingButton, o, useForm, FormProvider, RHFTextField, routes, Iconify, RouterLink, createSvgIcon, Typography, Button, useService, useTranslation, useDispatch, setLoading, Stack, Image, Link;
    return {
      setters: [module => {
...
//# sourceMappingURL=index-legacy-Cyygz7p9.js.map
