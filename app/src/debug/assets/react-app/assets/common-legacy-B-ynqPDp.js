...
(function () {
  ...
  System.register(['./use-service-legacy-Dvd5TXWp.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        CLOUD_URL = module.bx;
        BACKEND_BASE_URL = module.by;
        PROTOCOL = module.bz;
        FRONT_END_HOST = module.bA;
      }],
...
//# sourceMappingURL=common-legacy-B-ynqPDp.js.map
