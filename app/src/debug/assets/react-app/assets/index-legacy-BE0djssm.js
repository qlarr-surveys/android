  ...
  System.register([], function (exports, module) {
    ...
    return {
      execute: function execute() {
        ...
        var commonjsGlobal = exports("a5", typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {});
        ...
        var reactDomExports = exports("a2", reactDom.exports);
        ...
        const seen = {};
        const __vitePreload = exports("a9", function preload(baseModule, deps, importerUrl) {
        ...
        if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
          try {
            __vitePreload(() => module.import('./browser-ponyfill-legacy-CfdRTZL3.js').then(n => n.b), false ? __VITE_PRELOAD__ : void 0).then(function (mod) {
        ...
        var createCache = exports("a6", function createCache(options) {
          var key = options.key;
          if (key === 'css') {
        ...
        var CacheProvider = exports("ac", EmotionCacheContext.Provider);
        ...
        var useTheme$2 = exports("a4", function useTheme() {
        ...
        var darken_1 = exports("ag", colorManipulator.darken = darken);
        ...
        var lighten_1 = exports("af", colorManipulator.lighten = lighten);
        ...
        const Box = exports("a7", createBox({
          themeId: THEME_ID,
          defaultTheme,
        ...
        const Web = null;
        const Android = reactExports.lazy(() => __vitePreload(() => module.import('./Android-legacy-DcRmsPsH.js').then(n => n.as), false ? __VITE_PRELOAD__ : void 0));
        function App() {
...
//# sourceMappingURL=index-legacy-BE0djssm.js.map
