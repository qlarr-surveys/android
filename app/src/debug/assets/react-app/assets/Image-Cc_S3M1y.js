import { r as reactExports, q as interopRequireDefaultExports, j as jsxRuntimeExports, x as createTheme, B as Box } from "./index-GLBW3_uR.js";
import { K as requireCreateSvgIcon, ao as palette, M as useTranslation, aP as Modal, aS as SurveyIcon, T as Typography, aQ as Button } from "./use-service-BKPqOjBj.js";
...
const DeleteModal = ({ title, open, handleClose, handleDelete, description }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles.modalBox, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { display: "flex", gap: 2, justifyContent: "center", alignItems: "center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { id: "delete-modal", variant: "h4", fontWeight: 600, component: "h2", children: modalTitle })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { id: "modal-description", sx: { mt: 2, overflowWrap: "break-word" }, children: description }),
...
//# sourceMappingURL=Image-Cc_S3M1y.js.map
