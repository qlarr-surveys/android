...
(function () {
  ...
  System.register(['./use-service-legacy-Dvd5TXWp.js', './index-legacy-DHZhPI7F.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        invariant = module.bB;
        shallowEqual = module.bL;
        wrapConnectorHooks = module.bM;
        isRef = module.bN;
        useDragDropManager = module.bO;
        useIsomorphicLayoutEffect = module.bP;
        registerTarget = module.bQ;
        useOptionalFactory = module.bR;
        useCollectedProps = module.bS;
      }, module => {
...
//# sourceMappingURL=useDrop-legacy-CIEtVtvH.js.map
