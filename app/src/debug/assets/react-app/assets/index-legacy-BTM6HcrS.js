  ...
  System.register([], function (exports, module) {
    ...
    return {
      execute: function execute() {
        ...
        const seen = {};
        const __vitePreload = exports("ae", function preload(baseModule, deps, importerUrl) {
        ...
        if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
          try {
            __vitePreload(() => module.import('./browser-ponyfill-legacy-Dfu92n9f.js').then(n => n.b), false ? __VITE_PRELOAD__ : void 0).then(function (mod) {
        ...
        const Web = null;
        const Android = reactExports.lazy(() => __vitePreload(() => module.import('./Android-legacy-Cy_R2t8i.js').then(n => n.au), false ? __VITE_PRELOAD__ : void 0));
        function App() {
...
//# sourceMappingURL=index-legacy-BTM6HcrS.js.map
