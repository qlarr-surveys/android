...
(function () {
  ...
  System.register(['./use-service-legacy-uNDfwPef.js', './index-legacy-VHGc_nGn.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        invariant = module.bz;
        shallowEqual = module.bJ;
        wrapConnectorHooks = module.bK;
        isRef = module.bL;
        useDragDropManager = module.bM;
        useIsomorphicLayoutEffect = module.bN;
        registerTarget = module.bO;
        useOptionalFactory = module.bP;
        useCollectedProps = module.bQ;
      }, module => {
...
//# sourceMappingURL=useDrop-legacy-BTGolgYQ.js.map
