;
(function () {
  System.register(['./index-legacy-CZICsoLH.js', './SwitchBase-legacy-D7FXQbp2.js', './Android-legacy-B5yqEvUd.js', './RadioGroupContext-legacy-DIJcB8lX.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, _extends, reactExports, generateUtilityClasses, generateUtilityClass, _objectWithoutPropertiesLoose, clsx, alpha_1, SwitchBase, createSvgIcon, styled, rootShouldForwardProp, useDefaultProps, createChainedFunction, capitalize, composeClasses, RadioGroupContext;
    return {
      setters: [module => {
        ...
        styled = module.s;
        rootShouldForwardProp = module.ad;
        useDefaultProps = module.a;
        createChainedFunction = module.ae;
        capitalize = module.h;
...
//# sourceMappingURL=Radio-legacy-VKLJfwnI.js.map
