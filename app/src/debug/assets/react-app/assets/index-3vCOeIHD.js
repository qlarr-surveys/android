import { j as jsxRuntimeExports, B as Box, p as commonjsGlobal, w as getDefaultExportFromCjs, R as React, r as reactExports, u as useParams, A as LoadingDots, L as Link } from "./index-X8N9IRh7.js";
import { d as default_1 } from "./Delete-CegMG_AQ.js";
import { f as formatlocalDateTime, s as serverDateTimeToLocalDateTime } from "./DateUtils-D9XCaXee.js";
import { e as createSvgIcon, M as useTranslation, aM as Modal, T as Typography, aD as Button, R as useService, h as Paper, bi as stripTags, I as IconButton, bc as truncateWithEllipsis, b0 as previewUrl } from "./use-service-CuBoVPEx.js";
import { t as RHFSwitch, C as CustomTooltip } from "./Web-D9a6B_N2.js";
import { T as Tabs, c as Tab } from "./Tabs-CLdH6uZ6.js";
    ...
    Modal,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles.wrapper, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles.action, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: onClose, color: "primary", variant: "contained", children: t("action_btn.cancel") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "secondary", onClick: onDelete, children: t("action_btn.delete") })
        ] })
      ] })
    }
  );
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: allResponse == null ? void 0 : allResponse.responses.map((response) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { sx: { minHeight: "100px" }, children: [
            ...
            Object.keys(response.values).map((key) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { align: "left", children: value === null || value === void 0 || value === "" ? " - " : typeof value === "string" ? /* @__PURE__ */ jsxRuntimeExports.jsx(CustomTooltip, { showIcon: false, title: value, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: truncateWithEllipsis(value, 25) }) }) : typeof value === "object" && "size" in value && "filename" in value && "stored_filename" in value ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
                {
                  target: "_blank",
...
//# sourceMappingURL=index-3vCOeIHD.js.map
