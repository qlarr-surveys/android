;
(function () {
  System.register(['./index-legacy-VHGc_nGn.js', './use-service-legacy-uNDfwPef.js', './common-legacy-JH1w4dyZ.js', './Radio-legacy-dg8Bfgp8.js', './SwitchBase-legacy-CGnhZDR0.js', './RadioGroupContext-legacy-i7ufngjp.js', './radioClasses-legacy-C6EYZIXu.js'], function (exports, module) {
    'use strict';

    var useTheme, jsxRuntimeExports, Box, useSelector, shallowEqual, useDispatch, valueChange, rtlLanguage, buildResourceUrl, Radio;
    return {
      setters: [module => {
        useTheme = module.y;
      ...
      execute: function execute() {
        ...
        __vite_style__.textContent = "._imageContainer_12a8a_1 {\n  background-size: cover;\n  position: relative;\n  background-position: center;\n  background-repeat: no-repeat;\n  cursor: pointer;\n\n}\n\n._imageGrid_12a8a_10 {\n  margin-top: 16px;\n}\n\n._selection_12a8a_14 {\n  position: absolute;\n  top: 0;\n  border-radius: 50% !important;\n  background-color: #ffffffcc !important;\n}\n\n\n@media (max-width: 768px) {\n  ._radioCheck_12a8a_23 {\n    display: none;\n  }\n}\n\n._radioCheck_12a8a_23 {\n  width: 15px;\n  height: 15px;\n}\n\n\n._imageFlexContainer_12a8a_34{\n  display: flex;\n  flex-wrap: wrap;\n}/*$vite$:1*/";
...
//# sourceMappingURL=ImageScq-legacy-CGvn8gEa.js.map
