...
(function () {
  ...
  System.register(['./vendor-legacy-HgAAkC3y.js', './player-legacy-D4XdQu3u.js'], function (exports, module) {
    'use strict';
    ...
    return {
      ...
      execute: function execute() {
        ...
        class FilePlayer extends import_react.Component {
          constructor() {
            ...
            __publicField(this, "onPresentationModeChange", e => {
              if (this.player && (0, import_utils.supportsWebKitPresentationMode)(this.player)) {
                const webkitPresentationMode = this.player.webkitPresentationMode;
          ...
          load(url) {
            const _this$props$config = this.props.config,
        ...
        const FilePlayer_default = /*@__PURE__*/getDefaultExportFromCjs(FilePlayer_1);
        const FilePlayer$1 = /*#__PURE__*/_mergeNamespaces({
          __proto__: null,
          default: FilePlayer_default
        }, [FilePlayer_1]);
        exports("F", FilePlayer$1);
      }
    };
  });
})();
//# sourceMappingURL=FilePlayer-legacy-DmJ7J48N.js.map
