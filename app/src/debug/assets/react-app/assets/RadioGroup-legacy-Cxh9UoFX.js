...
(function () {
  ...
  System.register(['./index-legacy-Dxk271B4.js', './Android-legacy-BamMTOdE.js', './RadioGroupContext-legacy-m3qZ0Kit.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        formControlState = module.a8;
        Typography = module.g;
        styled = module.s;
        Stack = module.a9;
        capitalize = module.h;
        composeClasses = module.c;
        useControlled = module.r;
        useForkRef = module.w;
        useId = module.x;
      }, module => {
...
//# sourceMappingURL=RadioGroup-legacy-Cxh9UoFX.js.map
