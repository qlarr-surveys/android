;
(function () {
  System.register(['./index-legacy-VHGc_nGn.js', './use-service-legacy-uNDfwPef.js', './common-legacy-JH1w4dyZ.js', './Checkbox-legacy-CWdBtU_X.js', './SwitchBase-legacy-CGnhZDR0.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, Box, useTheme, useSelector, shallowEqual, useDispatch, rtlLanguage, valueChange, setDirty, buildResourceUrl, Checkbox;
    return {
      setters: [module => {
      ...
      execute: function execute() {
        ...
        __vite_style__.textContent = "._imageGrid_1oq83_1 {\n  margin-top: 16px;\n}\n\n._imageContainer_1oq83_5 {\n  position: relative;\n  background-size: cover;\n  background-position: center;\n  background-repeat: no-repeat;\n  cursor: pointer;\n}\n\n._selection_1oq83_13 {\n  position: absolute;\n  top: 0;\n  border-radius: 0 !important;\n  background-color: #ffffffcc !important;\n}\n\n@media (max-width: 768px) {\n  ._radioCheck_1oq83_21 {\n    display: none;\n  }\n}\n\n._radioCheck_1oq83_21 {\n  width: 15px;\n  height: 15px;\n}\n\n._imageFlexContainer_1oq83_31 {\n  display: flex;\n  flex-wrap: wrap;\n}/*$vite$:1*/";
        document.head.appendChild(__vite_style__);
        exports("default", ImageMcq);
        const imageGrid = "_imageGrid_1oq83_1";
        const imageContainer = "_imageContainer_1oq83_5";
        const selection = "_selection_1oq83_13";
        const radioCheck = "_radioCheck_1oq83_21";
        const imageFlexContainer = "_imageFlexContainer_1oq83_31";
        const styles = {
          imageGrid: imageGrid,
...
//# sourceMappingURL=ImageMcq-legacy-C4hdpDL3.js.map
