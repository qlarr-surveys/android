;
(function () {
  System.register(['./index-legacy-CoMmlwbr.js', './redux-legacy-ZqSxVvAn.js', './Android-legacy-Csf5qFR4.js', './player-legacy-BtDP29wV.js', './mui-legacy-b38CRKaY.js', './vendor-legacy-lhtLtiSI.js', './i18n-legacy-BRT6G2_g.js', './editor-legacy-Dx3AxXyy.js', './dnd-legacy-DGW9B2he.js', './charts-legacy-BBm9rbLh.js'], function (exports, module) {
    'use strict';

    var jsxs, jsx, useSelector, useDispatch, useService, previewUrlByFilename, getFileFromPath, uploadFile, valueChange, ReactPlayer, Box;
    return {
      setters: [module => {
        jsxs = module.o;
        jsx = module.n;
...
//# sourceMappingURL=VideoCapture-legacy-CS4KzzdJ.js.map
