...
(function () {
  ...
  System.register(['./use-service-legacy-BbL3A7cT.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        CLOUD_URL = module.by;
        BACKEND_BASE_URL = module.bz;
        PROTOCOL = module.bA;
        FRONT_END_HOST = module.bB;
      }],
...
//# sourceMappingURL=common-legacy-Cdw-XyXm.js.map
