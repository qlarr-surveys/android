...
(function () {
  ...
  System.register(['./index-legacy-VHGc_nGn.js', './use-service-legacy-uNDfwPef.js', './isTouchDevice-legacy-Ch1rHmnJ.js', './common-legacy-JH1w4dyZ.js', './Close-legacy-DueKC2rz.js', './Card-legacy-D9YP2dW9.js', './Toolbar-legacy-HvxMh-_e.js'], function (exports, module) {
    'use strict';
    ...
    return {
      setters: [module => {
        ...
        getDrawerUtilityClass = module.bh;
        ...
        Button = module.aD;
        navigatePrevious = module.bj;
        navigateNext = module.bk;
        ...
        Select = module.S;
        langChange = module.bn;
        MenuItem = module.N;
        useService = module.R;
        isEquivalent = module.bo;
        setFetching = module.bp;
        continueNavigation = module.bq;
        stateReceived = module.br;
        loadScript = module.bs;
        defualtTheme = module.bt;
        cacheRtl = module.av;
        ThemeProvider = module.ar;
        ErrorLayout = module._;
        CompactLayout = module.as;
        Image = module.at;
        PROCESSED_ERRORS = module.aN;
        startNavigation = module.bu;
      }, module => {
      ...
      execute: function execute() {
        ...
        const DateTimeQuestion = React.lazy(() => __vitePreload(() => module.import('./DateTimeQuestion-legacy-BfhquDLj.js'), false ? __VITE_PRELOAD__ : void 0));
        const SCQ = React.lazy(() => __vitePreload(() => module.import('./Scq-legacy-CyGf3lLp.js'), false ? __VITE_PRELOAD__ : void 0));
        const SCQArray = React.lazy(() => __vitePreload(() => module.import('./SCQArray-legacy-Bmni7p9M.js'), false ? __VITE_PRELOAD__ : void 0));
        const Signature = React.lazy(() => __vitePreload(() => module.import('./Signature-legacy-BHBdLXPN.js'), false ? __VITE_PRELOAD__ : void 0));
        const PhotoCapture = React.lazy(() => __vitePreload(() => module.import('./PhotoCapture-legacy-NEnInkIh.js'), false ? __VITE_PRELOAD__ : void 0));
        const VideoCapture = React.lazy(() => __vitePreload(() => module.import('./VideoCapture-legacy-CxcBnxBw.js'), false ? __VITE_PRELOAD__ : void 0));
        const MCQ = React.lazy(() => __vitePreload(() => module.import('./Mcq-legacy-BAAJSVnh.js'), false ? __VITE_PRELOAD__ : void 0));
        const NumberQuestion = React.lazy(() => __vitePreload(() => module.import('./NumberQuestion-legacy-DXbP42OD.js'), false ? __VITE_PRELOAD__ : void 0));
        const TextQuestion = React.lazy(() => __vitePreload(() => module.import('./TextQuestion-legacy-Dt6sngcp.js'), false ? __VITE_PRELOAD__ : void 0));
        const VideoDisplay = React.lazy(() => __vitePreload(() => module.import('./VideoDisplay-legacy-DhPO3D7t.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageDisplay = React.lazy(() => __vitePreload(() => module.import('./ImageDisplay-legacy-DAppjifQ.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageRanking = React.lazy(() => __vitePreload(() => module.import('./ImageRanking-legacy-FnGwPJ3k.js'), false ? __VITE_PRELOAD__ : void 0));
        const ParagraphQuestion = React.lazy(() => __vitePreload(() => module.import('./ParagraphQuestion-legacy-gC1efeKy.js'), false ? __VITE_PRELOAD__ : void 0));
        const Barcode = React.lazy(() => __vitePreload(() => module.import('./Barcode-legacy-D9WHds4B.js'), false ? __VITE_PRELOAD__ : void 0));
        const EmailQuestion = React.lazy(() => __vitePreload(() => module.import('./EmailQuestion-legacy-BLIp3DnQ.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageScq = React.lazy(() => __vitePreload(() => module.import('./ImageScq-legacy-CGvn8gEa.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageMcq = React.lazy(() => __vitePreload(() => module.import('./ImageMcq-legacy-C4hdpDL3.js'), false ? __VITE_PRELOAD__ : void 0));
        const Ranking = React.lazy(() => __vitePreload(() => module.import('./Ranking-legacy-BcfCBKks.js'), false ? __VITE_PRELOAD__ : void 0));
        const NPS = React.lazy(() => __vitePreload(() => module.import('./NPS-legacy-DYPJGSaj.js'), false ? __VITE_PRELOAD__ : void 0));
        const Content$2 = React.lazy(() => __vitePreload(() => Promise.resolve().then(() => index$1), false ? __VITE_PRELOAD__ : void 0));
        const FileUpload = React.lazy(() => __vitePreload(() => module.import('./FileUpload-legacy-C10Tfl1t.js'), false ? __VITE_PRELOAD__ : void 0));
        const IconScq = React.lazy(() => __vitePreload(() => module.import('./IconScq-legacy-D60xyI_1.js'), false ? __VITE_PRELOAD__ : void 0));
        const IconMcq = React.lazy(() => __vitePreload(() => module.import('./IconMcq-legacy-Db5W0reb.js'), false ? __VITE_PRELOAD__ : void 0));
        const SCQIconArray = React.lazy(() => __vitePreload(() => module.import('./SCQIconArray-legacy-k5DyHRyv.js'), false ? __VITE_PRELOAD__ : void 0));
        ...
        function SurveyDrawer({
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(Drawer, {
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
              ...
              children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: styles$1.drawerHeader,
...
//# sourceMappingURL=index-legacy-XRFhxuym.js.map
