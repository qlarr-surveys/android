...
(function () {
  ...
  System.register(['./index-legacy-DbBgSDRL.js', './Android-legacy-DTaKd7fz.js'], function (exports, module) {
    ...
    var reactExports, useTheme, jsxs, jsx, invariant, shallowEqual, wrapConnectorHooks, isRef, useDragDropManager, useIsomorphicLayoutEffect, registerTarget, useOptionalFactory, useCollectedProps, useDispatch, useSelector, shallowEqual$1, valueChange, orderChange, Box, useDrag, Content;
    return {
      setters: [module => {
        ...
        invariant = module.aa;
        shallowEqual = module.ab;
        wrapConnectorHooks = module.ac;
        isRef = module.ad;
        useDragDropManager = module.ae;
        useIsomorphicLayoutEffect = module.af;
        registerTarget = module.ag;
        useOptionalFactory = module.ah;
        useCollectedProps = module.ai;
        useDispatch = module.L;
        useSelector = module.J;
        shallowEqual$1 = module.K;
      ...
      execute: function execute() {
        ...
        function Ranking(props) {
          ...
          return /* @__PURE__ */jsxs("div", {
            ...
            children: [/* @__PURE__ */jsx(RankingContainer, {
              styles,
              theme,
...
//# sourceMappingURL=Ranking-legacy-15A4rTxJ.js.map
