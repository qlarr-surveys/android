import { V as generateUtilityClasses, U as generateUtilityClass, ae as getPath, a0 as alpha_1, r as reactExports, w as _objectWithoutPropertiesLoose, y as _extends, m as jsxRuntimeExports, D as clsx, Y as React, a8 as LoadingDots } from "./index-DKzDOClZ.js";
import { a as useDefaultProps, ap as useIsFocusVisible, y as useForkRef, s as styled, e as capitalize, g as composeClasses, j as Typography, $ as useService, b as useTheme, aa as useTranslation, aq as fileTypesToMimesArray, E as useSelector, J as useDispatch, z as Button, ar as ValidationItem, a1 as previewUrlByFilename, Q as setDirty, a5 as uploadFile, L as valueChange } from "./Android-DISKZema.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    isUploading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { textAlign: "center" }, children: [
      ...
      window["Android"] ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { target: "_blank", onClick: previewAndroid, children: [
        ...
        "K"
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { target: "_blank", href: previewUrlByFilename(state.stored_filename), children: [
        state.filename,
        " - ",
        Math.round(state.size / 1024),
        "K"
...
//# sourceMappingURL=FileUpload-DSVRgqxa.js.map
