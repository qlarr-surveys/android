  ...
  System.register(['./index-legacy-DB81dhIr.js', './Android-legacy-v562C-F4.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        clsx = module.D;
        React = module.Y;
        LoadingDots = module.ad;
      }, module => {
        useDefaultProps = module.a;
        useIsFocusVisible = module.ar;
        useForkRef = module.w;
        styled = module.s;
        capitalize = module.h;
        ...
        fileTypesToMimesArray = module.as;
        useSelector = module.K;
        useDispatch = module.M;
        Button = module.y;
        ValidationItem = module.at;
...
//# sourceMappingURL=FileUpload-legacy-Ds14cj6z.js.map
