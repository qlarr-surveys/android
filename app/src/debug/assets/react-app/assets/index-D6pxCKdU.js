const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Android-yc1ng5Rp.js","assets/Android-C7STdX08.css"])))=>i.map(i=>d[i]);
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    __vitePreload(() => import("./browser-ponyfill-BKlR8VBT.js").then((n2) => n2.b), true ? [] : void 0).then(function(mod) {
...
const Web = null;
const Android = reactExports.lazy(() => __vitePreload(() => import("./Android-yc1ng5Rp.js").then((n2) => n2.ao), true ? __vite__mapDeps([0,1]) : void 0));
function App() {
...
//# sourceMappingURL=index-D6pxCKdU.js.map
