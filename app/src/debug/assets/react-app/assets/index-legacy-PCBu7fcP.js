...
(function () {
  ...
  System.register(['./index-legacy-BLatMfxz.js', './use-service-legacy-DLuVKbJp.js', './yup-legacy-k3dYfHQc.js', './Web-legacy-G20LTzwp.js', './Tabs-legacy-DSWwlWIj.js', './Card-legacy-DAyj9G4N.js', './TableRow-legacy-CbWVNbnA.js', './tableRowClasses-legacy-BNdXjQON.js', './TableCell-legacy-BTEC8sBz.js', './Divider-legacy-9ldxDN5q.js', './Checkbox-legacy-B_Sa2GUd.js', './SwitchBase-legacy-C9xQX8jx.js', './radioClasses-legacy-DphQBUmK.js', './TextField-legacy-Cn7jw8uN.js', './FormControlLabel-legacy-CA95rTY_.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, generateUtilityClasses, generateUtilityClass, capitalize, _extends, reactExports, _objectWithoutPropertiesLoose, clsx, Box, React, createSvgIcon, styled, ButtonBase, useDefaultProps, composeClasses, useTranslation, Modal, Typography, Button, useService, useDispatch, setLoading, PROCESSED_ERRORS, Stack, TokenService, IconButton, Popover, MenuItem, LoadingButton, addMethod, create$6, create$3, create$2, o, useForm, useWatch, ROLES, FormProvider, RHFTextField, RHFMultiSelect, Iconify, Dialog, Card, TableContainer, Table, TableHead, TableRow, TableBody, tableCellClasses, TableCell, Divider;
    return {
      setters: [module => {
...
//# sourceMappingURL=index-legacy-PCBu7fcP.js.map
