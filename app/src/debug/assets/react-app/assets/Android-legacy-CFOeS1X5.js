  ...
  System.register(['./index-legacy-BxErIW5G.js', './vendor-legacy-HgAAkC3y.js', './redux-legacy-N3F3Fg7Q.js', './mui-legacy-CrWa9ZRQ.js', './i18n-legacy-QVJZeAmy.js', './dnd-legacy-Cs5Ow6iI.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        commonjsGlobal = module.e;
        useNavigate = module.u;
        useLocation = module.f;
        useParams = module.h;
      }, module => {
        ...
        Tooltip = module.T;
        Button = module.f;
        getContrastRatio = module.g;
        FormatListBulleted = module.F;
        css = module.k;
        ErrorOutlineOutlined = module.l;
        Box = module.B;
        TextField = module.m;
        ...
        Container = module.o;
        Stack = module.S;
        createTheme = module.q;
        DialogTitle = module.r;
        Typography = module.s;
        DialogContent = module.t;
        DialogActions = module.v;
        Dialog = module.w;
      ...
      execute: function execute() {
        ...
        const getContrastColor = exports("f", (hexColor, opacity = 0.2) => {
        ...
        function NewComponentsPanel({
          ...
          return /* @__PURE__ */jsxs("div", {
            ...
            }, index)), QUESTION_TYPES.map((item, index) => /* @__PURE__ */jsxs("div", {
              className: styles$d.leftPanelGroupItem,
              children: [/* @__PURE__ */jsx("div", {
                className: styles$d.groupTitle,
                children: t(item.name)
        ...
        const fileTypesToMimesArray = exports("h", fileTypes => {
          let accepted = [];
        ...
        class SurveyService extends BaseService {
          ...
          eventResponse(responseId) {
            ...
            return _asyncToGenerator(function* () {
              const surveyId = sessionStorage.getItem("surveyId");
              const response = yield _this17.handleRequest(() => instance$1.get(`/survey/${surveyId}/response/${responseId}/events`));
              return response;
            })();
          }
          importSurvey(file, onProgress) {
            ...
            return _asyncToGenerator(function* () {
              const formData = new FormData();
              formData.append("file", file);
              const response = yield _this18.handleRequest(() => instance$1.post(`/survey/import`, formData, {
          ...
          createSurveyWithAI(prompt) {
            var _this19 = this;
            return _asyncToGenerator(function* () {
              const response = yield _this19.handleRequest(() => instance$1.post(`/survey/generate_ai`, {
                prompt
              }));
              return response.data;
            })();
          ...
          exportSurvey(surveyId) {
            ...
            return _asyncToGenerator(function* () {
              ...
              const response = yield _this20.handleRequest(() => instance$1.get(`/survey/${surveyId}/export`, {
                responseType: "blob"
              }));
        ...
        class AuthService extends BaseService {
          login(email, password) {
            var _this21 = this;
            return _asyncToGenerator(function* () {
              const response = yield _this21.handleRequest(() => instance.post("/user/login", {
                email,
                password
              }));
              if (response.data) {
          ...
          forgotPassword(email) {
            var _this22 = this;
            return _asyncToGenerator(function* () {
              return _this22.handleRequest(() => instance.post("/user/forgot_password", {
                email
              }));
            })();
          }
          resetPassword(confirmNewUser, refreshToken, newPassword) {
            var _this23 = this;
            return _asyncToGenerator(function* () {
              const response = yield _this23.handleRequest(() => instance.post(confirmNewUser ? "/user/confirm_new_user" : "/user/reset_password", confirmNewUser ? {
                token: refreshToken,
                newPassword
              } : {
                refreshToken,
          ...
          logout() {
            ...
            return _asyncToGenerator(function* () {
              try {
                const response = yield _this24.handleRequest(() => instance$1.post("/logout"));
        ...
        class RunService extends BaseService {
          start(_x23) {
            ...
            return _asyncToGenerator(function* (lang, preview = false, mode = "online", navigationMode) {
              const surveyId = sessionStorage.getItem("surveyId");
              if (preview) {
                const response = yield _this25.handleRequest(() => instance$1.post(`/survey/${surveyId}/preview/start?mode=${mode}`, {
                  lang,
                  navigationMode
                }));
                return response.data;
              } else {
                const response = yield _this25.handleRequest(() => instance.post(`/survey/${surveyId}/run/start`, {
                  lang,
                  navigationMode
                }));
                return response.data;
          ...
          runtimeJs(preview) {
            ...
            return _asyncToGenerator(function* () {
              const surveyId = sessionStorage.getItem("surveyId");
              if (preview) {
                const response = yield _this26.handleRequest(() => instance$1.get(`/survey/${surveyId}/preview/runtime.js`));
                return response.data;
              } else {
                const response = yield _this26.handleRequest(() => instance.get(`/survey/${surveyId}/run/runtime.js`));
                return response.data;
              }
            })();
          }
          ...
          searchAutoComplete(uuid, query) {
            ...
            return _asyncToGenerator(function* () {
              const surveyId = sessionStorage.getItem("surveyId");
              const response = yield _this27.handleRequest(() => instance.get(`/survey/${surveyId}/autocomplete/${uuid}?q=${query}`));
              return response.data;
            })();
          }
        ...
        class UserService extends BaseService {
          getCountByRole() {
            var _this28 = this;
            return _asyncToGenerator(function* () {
              const response = yield _this28.handleRequest(() => instance$1.get(`/user/count_by_role`));
              return response.data;
            })();
          }
          getAllUsers() {
            var _this29 = this;
            return _asyncToGenerator(function* () {
              const response = yield _this29.handleRequest(() => instance$1.get(`/user/all`));
              return response.data;
            })();
          }
          getUser(_x25) {
            ...
            return _asyncToGenerator(function* ({
              ...
              const response = yield _this30.handleRequest(() => instance$1.get(`/user/${userId}`));
              return response.data;
            }).apply(this, arguments);
          }
          deleteUser(_x26) {
            ...
            return _asyncToGenerator(function* ({
              ...
              const response = yield _this31.handleRequest(() => instance$1.delete(`/user/${userId}`));
              return response.data;
            }).apply(this, arguments);
          }
          createUser(data) {
            var _this32 = this;
            return _asyncToGenerator(function* () {
              const response = yield _this32.handleRequest(() => instance$1.post(`/user/create`, data));
              return response.data;
            })();
          }
          updateUser(_x27) {
            ...
            return _asyncToGenerator(function* ({
              ...
              const response = yield _this33.handleRequest(() => instance$1.put(`/user/${userId}`, data));
              return response.data;
            }).apply(this, arguments);
          }
          updateUserProfile(data) {
            var _this34 = this;
            return _asyncToGenerator(function* () {
              const response = yield _this34.handleRequest(() => instance$1.put(`/user/profile`, data));
              return response.data;
            })();
          }
          confirmEmail(data) {
            var _this35 = this;
            return _asyncToGenerator(function* () {
              const response = yield _this35.handleRequest(() => instance$1.post(`/user/confirm_new_email`, data));
              return response.data;
            })();
          }
        }
        ...
        function AutoCompleteQuestion(props) {
          ...
          const fetchOptions = reactExports.useCallback(debounce$1(/*#__PURE__*/function () {
        ...
        const DateTimeQuestion = React.lazy(() => __vitePreload(() => module.import('./DateTimeQuestion-legacy-C54v6G6J.js'), false ? __VITE_PRELOAD__ : void 0));
        const SCQ = React.lazy(() => __vitePreload(() => module.import('./Scq-legacy-DW7iDcw_.js'), false ? __VITE_PRELOAD__ : void 0));
        const Array$1 = React.lazy(() => __vitePreload(() => module.import('./Array-legacy-B1BK9Ucj.js'), false ? __VITE_PRELOAD__ : void 0));
        const Signature = React.lazy(() => __vitePreload(() => module.import('./Signature-legacy-BK84RZip.js'), false ? __VITE_PRELOAD__ : void 0));
        const PhotoCapture = React.lazy(() => __vitePreload(() => module.import('./PhotoCapture-legacy-D27qEgWP.js'), false ? __VITE_PRELOAD__ : void 0));
        const VideoCapture = React.lazy(() => __vitePreload(() => module.import('./VideoCapture-legacy-fSvanqv9.js'), false ? __VITE_PRELOAD__ : void 0));
        const MCQ = React.lazy(() => __vitePreload(() => module.import('./Mcq-legacy-CIkyGp_L.js'), false ? __VITE_PRELOAD__ : void 0));
        const NumberQuestion = React.lazy(() => __vitePreload(() => module.import('./NumberQuestion-legacy-Bbe5zrdt.js'), false ? __VITE_PRELOAD__ : void 0));
        const TextQuestion = React.lazy(() => __vitePreload(() => module.import('./TextQuestion-legacy-Be2g6O5L.js'), false ? __VITE_PRELOAD__ : void 0));
        const VideoDisplay = React.lazy(() => __vitePreload(() => module.import('./VideoDisplay-legacy-D20gRBRz.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageDisplay = React.lazy(() => __vitePreload(() => module.import('./ImageDisplay-legacy-CVITTVD4.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageRanking = React.lazy(() => __vitePreload(() => module.import('./ImageRanking-legacy-D1JAiJw0.js'), false ? __VITE_PRELOAD__ : void 0));
        const ParagraphQuestion = React.lazy(() => __vitePreload(() => module.import('./ParagraphQuestion-legacy-Dr6LysPM.js'), false ? __VITE_PRELOAD__ : void 0));
        const Barcode = React.lazy(() => __vitePreload(() => module.import('./Barcode-legacy-CcRc0o3o.js'), false ? __VITE_PRELOAD__ : void 0));
        const EmailQuestion = React.lazy(() => __vitePreload(() => module.import('./EmailQuestion-legacy-NgIcD1PT.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageScq = React.lazy(() => __vitePreload(() => module.import('./ImageScq-legacy-BDYTulkd.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageMcq = React.lazy(() => __vitePreload(() => module.import('./ImageMcq-legacy-JCM-3ylc.js'), false ? __VITE_PRELOAD__ : void 0));
        const Ranking = React.lazy(() => __vitePreload(() => module.import('./Ranking-legacy-B0-ftljU.js'), false ? __VITE_PRELOAD__ : void 0));
        const NPS = React.lazy(() => __vitePreload(() => module.import('./NPS-legacy-MgT25GT1.js'), false ? __VITE_PRELOAD__ : void 0));
        const Content = React.lazy(() => __vitePreload(() => Promise.resolve().then(() => index), false ? __VITE_PRELOAD__ : void 0));
        const FileUpload = React.lazy(() => __vitePreload(() => module.import('./FileUpload-legacy-ChRf7JhS.js'), false ? __VITE_PRELOAD__ : void 0));
        const IconScq = React.lazy(() => __vitePreload(() => module.import('./IconScq-legacy-BUxLbr14.js'), false ? __VITE_PRELOAD__ : void 0));
        const IconMcq = React.lazy(() => __vitePreload(() => module.import('./IconMcq-legacy-C1_HPm_g.js'), false ? __VITE_PRELOAD__ : void 0));
        const SCQIconArray = React.lazy(() => __vitePreload(() => module.import('./SCQIconArray-legacy-BgwDIjNR.js'), false ? __VITE_PRELOAD__ : void 0));
        ...
        `,
                  ...
                  return visibleQuestions.map((quest, idx) => /* @__PURE__ */jsxs(React.Fragment, {
                    children: [/* @__PURE__ */jsx(Question$1, {
                      component: quest
                    }), idx < visibleQuestions.length - 1 && /* @__PURE__ */jsx(Divider, {
                      sx: {
                        mt: "12px",
                        mb: "12px"
                      }
...
//# sourceMappingURL=Android-legacy-CFOeS1X5.js.map
