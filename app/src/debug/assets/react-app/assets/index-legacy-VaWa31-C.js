...
(function () {
  ...
  System.register(['./index-legacy-ppEgxGbl.js', './use-service-legacy-BbL3A7cT.js', './isTouchDevice-legacy-D04XAr6x.js', './common-legacy-Cdw-XyXm.js', './Close-legacy-CkOaATYN.js', './Card-legacy-nTgNTVv-.js', './Toolbar-legacy-CAJae3Jn.js'], function (exports, module) {
    'use strict';

    var generateUtilityClasses, createBox, ClassNameGenerator, reactExports, _objectWithoutPropertiesLoose, jsxRuntimeExports, _extends, capitalize, clsx, Box$1, React, __vitePreload, LoadingDots, useTheme$1, interopRequireDefaultExports, useLocation, createTheme, useNavigate, CacheProvider, useTheme, useForkRef, debounce, ownerWindow, Transition, reflow, getTransitionProps, styled, Modal, rootShouldForwardProp, Paper, useDefaultProps, useRtl, composeClasses, getDrawerUtilityClass, useTranslation, useSelector, stripTags, rtlLanguage, shallowEqual, useDispatch, Button, navigatePrevious, navigateNext, questionIconByType, truncateWithEllipsis, jump, Typography, IconButton, requireCreateSvgIcon, FormControl, Select, langChange, MenuItem, useService, isEquivalent, setFetching, continueNavigation, stateReceived, loadScript, defualtTheme, cacheRtl, ThemeProvider, ErrorLayout, CompactLayout, Image, PROCESSED_ERRORS, startNavigation, ErrorOutlineOutlined, createSelector, DndProvider, isTouchDevice, TouchBackend, HTML5Backend, buildResourceUrl, CardMedia, Close, Card, Toolbar;
    return {
      setters: [module => {
        ...
        useForkRef = module.b;
        debounce = module.b0;
        ownerWindow = module.a$;
        Transition = module.bh;
        reflow = module.bi;
        getTransitionProps = module.bj;
        styled = module.f;
        Modal = module.aP;
        ...
        getDrawerUtilityClass = module.bk;
        ...
        Button = module.aQ;
        navigatePrevious = module.bm;
        navigateNext = module.bn;
        questionIconByType = module.bo;
        truncateWithEllipsis = module.bf;
        jump = module.bp;
        Typography = module.T;
        IconButton = module.I;
        ...
        Select = module.S;
        langChange = module.bq;
        MenuItem = module.N;
        useService = module.R;
        isEquivalent = module.br;
        setFetching = module.bs;
        continueNavigation = module.bt;
        stateReceived = module.bu;
        loadScript = module.bv;
        defualtTheme = module.bw;
        cacheRtl = module.at;
        ThemeProvider = module.ap;
        ErrorLayout = module.Y;
        CompactLayout = module.aq;
        Image = module.ar;
        PROCESSED_ERRORS = module.aR;
        startNavigation = module.bx;
      }, module => {
      ...
      execute: function execute() {
        ...
        const DateTimeQuestion = React.lazy(() => __vitePreload(() => module.import('./DateTimeQuestion-legacy-nU2ZBK0z.js'), false ? __VITE_PRELOAD__ : void 0));
        const SCQ = React.lazy(() => __vitePreload(() => module.import('./Scq-legacy-CZ687iwH.js'), false ? __VITE_PRELOAD__ : void 0));
        const SCQArray = React.lazy(() => __vitePreload(() => module.import('./SCQArray-legacy-C9JttPnU.js'), false ? __VITE_PRELOAD__ : void 0));
        const Signature = React.lazy(() => __vitePreload(() => module.import('./Signature-legacy-D3N_B3kE.js'), false ? __VITE_PRELOAD__ : void 0));
        const PhotoCapture = React.lazy(() => __vitePreload(() => module.import('./PhotoCapture-legacy-Dnu-n2D-.js'), false ? __VITE_PRELOAD__ : void 0));
        const VideoCapture = React.lazy(() => __vitePreload(() => module.import('./VideoCapture-legacy-DmCqpN42.js'), false ? __VITE_PRELOAD__ : void 0));
        const MCQ = React.lazy(() => __vitePreload(() => module.import('./Mcq-legacy-CICiFVcT.js'), false ? __VITE_PRELOAD__ : void 0));
        const NumberQuestion = React.lazy(() => __vitePreload(() => module.import('./NumberQuestion-legacy-CXQHBBPF.js'), false ? __VITE_PRELOAD__ : void 0));
        const TextQuestion = React.lazy(() => __vitePreload(() => module.import('./TextQuestion-legacy-zsVt7PEL.js'), false ? __VITE_PRELOAD__ : void 0));
        const VideoDisplay = React.lazy(() => __vitePreload(() => module.import('./VideoDisplay-legacy-B-n8rZhh.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageDisplay = React.lazy(() => __vitePreload(() => module.import('./ImageDisplay-legacy-sJu1f--M.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageRanking = React.lazy(() => __vitePreload(() => module.import('./ImageRanking-legacy-u-_PTI_L.js'), false ? __VITE_PRELOAD__ : void 0));
        const ParagraphQuestion = React.lazy(() => __vitePreload(() => module.import('./ParagraphQuestion-legacy-mMI5vAIc.js'), false ? __VITE_PRELOAD__ : void 0));
        const Barcode = React.lazy(() => __vitePreload(() => module.import('./Barcode-legacy-BqfBvihD.js'), false ? __VITE_PRELOAD__ : void 0));
        const EmailQuestion = React.lazy(() => __vitePreload(() => module.import('./EmailQuestion-legacy-CRf0qlW1.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageScq = React.lazy(() => __vitePreload(() => module.import('./ImageScq-legacy-BRnEri_m.js'), false ? __VITE_PRELOAD__ : void 0));
        const ImageMcq = React.lazy(() => __vitePreload(() => module.import('./ImageMcq-legacy-Dgow4A2P.js'), false ? __VITE_PRELOAD__ : void 0));
        const Ranking = React.lazy(() => __vitePreload(() => module.import('./Ranking-legacy-CdRAXtHK.js'), false ? __VITE_PRELOAD__ : void 0));
        const NPS = React.lazy(() => __vitePreload(() => module.import('./NPS-legacy-ClsdBiWn.js'), false ? __VITE_PRELOAD__ : void 0));
        const Content$2 = React.lazy(() => __vitePreload(() => Promise.resolve().then(() => index$1), false ? __VITE_PRELOAD__ : void 0));
        const FileUpload = React.lazy(() => __vitePreload(() => module.import('./FileUpload-legacy-DKKrM6Ez.js'), false ? __VITE_PRELOAD__ : void 0));
        const IconScq = React.lazy(() => __vitePreload(() => module.import('./IconScq-legacy-Rjbu_Ai8.js'), false ? __VITE_PRELOAD__ : void 0));
        const IconMcq = React.lazy(() => __vitePreload(() => module.import('./IconMcq-legacy-Cx8OiOFk.js'), false ? __VITE_PRELOAD__ : void 0));
        const SCQIconArray = React.lazy(() => __vitePreload(() => module.import('./SCQIconArray-legacy-BtlEzXgd.js'), false ? __VITE_PRELOAD__ : void 0));
            ...
            children: [showHeader && /* @__PURE__ */jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, {
              children: [showTitle && /* @__PURE__ */jsxRuntimeExports.jsx(Box$1, {
                ...
                children: /* @__PURE__ */jsxRuntimeExports.jsx(Content$2, {
                  className: `${styles$7.content} ${styles$7.question}`,
                  name: "label",
                  lang: props.lang,
                ...
                className: styles$7.textDescription,
                children: /* @__PURE__ */jsxRuntimeExports.jsx(Content$2, {
        ...
        const QuestionWrapper = React.memo(props => {
          ...
          return /* @__PURE__ */jsxRuntimeExports.jsx(Box$1, {
            ...
            className: `${styles$7.groupQuestion} ${invalid ? "invalidQuestion" : ""}`,
            children: props.children
          });
        });
            ...
            return /* @__PURE__ */jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {
              children: /* @__PURE__ */jsxRuntimeExports.jsxs(Box$1, {
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                  className: styles$5.groupHeader,
                  ...
                  }), ((_props$group$content2 = props.group.content) === null || _props$group$content2 === void 0 ? void 0 : _props$group$content2.description) && /* @__PURE__ */jsxRuntimeExports.jsx(Box$1, {
                    className: styles$5.textDescription,
                    children: /* @__PURE__ */jsxRuntimeExports.jsx(Content$1, {
                      elementCode: props.group.code,
                      name: "description",
                      lang: props.lang,
        ...
        function Survey() {
          ...
          const _ref = surveyState || {},
            surveyLang = _ref.lang,
            additionalLang = _ref.additionalLang;
          [{
            code: surveyLang.code,
            name: surveyLang.name
          }, ...(additionalLang || [])];
          return /* @__PURE__ */jsxRuntimeExports.jsx(DndProvider, {
            ...
            children: /* @__PURE__ */jsxRuntimeExports.jsx("form", {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs("div", {
                className: styles$3.surveyGroups,
                ...
                children: [/* @__PURE__ */jsxRuntimeExports.jsxs(Box, {
                  ...
                  return /* @__PURE__ */jsxRuntimeExports.jsxs(Box, {
                    ...
                    children: [/* @__PURE__ */jsxRuntimeExports.jsx("span", {
                      className: styles$2.questionIcon,
                      children: questionIconByType(question.type)
                    }), stripTags(truncateWithEllipsis((_question$content = question.content) === null || _question$content === void 0 ? void 0 : _question$content.label, 32)), !validity_map[question.code] && /* @__PURE__ */jsxRuntimeExports.jsx("span", {
                      className: styles$2.redAsterix,
                      children: "*"
                    })]
                  }, question.code);
                })]
        ...
        function SurveyAppBar({
          ...
          useSelector(state => {
            ...
            return (_state$runState$data6 = state.runState.data) === null || _state$runState$data6 === void 0 || (_state$runState$data6 = _state$runState$data6.survey) === null || _state$runState$data6 === void 0 || (_state$runState$data6 = _state$runState$data6.content) === null || _state$runState$data6 === void 0 ? void 0 : _state$runState$data6.label;
          }, shallowEqual);
          const lang = useSelector(state => {
            var _state$runState$data7;
            return (_state$runState$data7 = state.runState.data) === null || _state$runState$data7 === void 0 ? void 0 : _state$runState$data7.lang;
          }, shallowEqual);
          const additionalLang = useSelector(state => {
            var _state$runState$data8;
            return (_state$runState$data8 = state.runState.data) === null || _state$runState$data8 === void 0 ? void 0 : _state$runState$data8.additionalLang;
          }, shallowEqual);
        ...
        function RunSurvey({
          ...
          const surveyTheme = useSelector(state => {
            ...
            return (_state$runState$data9 = state.runState.data) === null || _state$runState$data9 === void 0 || (_state$runState$data9 = _state$runState$data9.survey) === null || _state$runState$data9 === void 0 ? void 0 : _state$runState$data9.theme;
          }, isEquivalent);
          const navResponseId = useSelector(state => {
            var _state$runState$data10;
            return (_state$runState$data10 = state.runState.data) === null || _state$runState$data10 === void 0 ? void 0 : _state$runState$data10.responseId;
          });
          useSelector(state => {
            var _state$runState$data11;
            return (_state$runState$data11 = state.runState.data) === null || _state$runState$data11 === void 0 || (_state$runState$data11 = _state$runState$data11.survey) === null || _state$runState$data11 === void 0 ? void 0 : _state$runState$data11.allowJump;
          }, shallowEqual);
          const backgroundImage = useSelector(state => {
            var _state$runState$data12;
            return (_state$runState$data12 = state.runState.data) === null || _state$runState$data12 === void 0 || (_state$runState$data12 = _state$runState$data12.survey) === null || _state$runState$data12 === void 0 || (_state$runState$data12 = _state$runState$data12.resources) === null || _state$runState$data12 === void 0 ? void 0 : _state$runState$data12.backgroundImage;
          });
            ...
            children: [/* @__PURE__ */jsxRuntimeExports.jsx(CacheProvider, {
              ...
              children: /* @__PURE__ */jsxRuntimeExports.jsxs(ThemeProvider, {
                ...
                children: [error && /* @__PURE__ */jsxRuntimeExports.jsx(ErrorLayout, {
                  ...
                  children: [/* @__PURE__ */jsxRuntimeExports.jsx(RunLoadingDots, {}), /* @__PURE__ */jsxRuntimeExports.jsx(SurveyAppBar, {
                    toggleDrawer
...
//# sourceMappingURL=index-legacy-VaWa31-C.js.map
