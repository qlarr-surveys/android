    ...
    return {
      execute: function execute() {
        ...
        if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
          try {
            __vitePreload(() => module.import('./browser-ponyfill-legacy-CGlaAzsW.js').then(n => n.b), false ? __VITE_PRELOAD__ : void 0).then(function (mod) {
        ...
        const Android = reactExports.lazy(() => __vitePreload(() => module.import('./Android-legacy-DTaKd7fz.js').then(n => n.ap), false ? __VITE_PRELOAD__ : void 0));
...
//# sourceMappingURL=index-legacy-DbBgSDRL.js.map
