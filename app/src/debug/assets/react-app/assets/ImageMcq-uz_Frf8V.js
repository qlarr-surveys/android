import { as as jsx, av as Box, ar as useTheme, at as jsxs } from "./index-CM5T10V1.js";
import { J as useSelector, K as shallowEqual, L as useDispatch, a6 as buildResourceUrl, a7 as rtlLanguage, N as valueChange, R as setDirty } from "./Android-BBYOUnem.js";
...
function ImageMcqItem(props) {
  ...
  return /* @__PURE__ */ jsxs(Box, { "data-code": props.option.code, sx: {
    ...
    !props.hideText && /* @__PURE__ */ jsx(Box, { children: (_c = props.option.content) == null ? void 0 : _c.label })
  ] }, props.option.code);
}
export {
  ImageMcq as default
};
//# sourceMappingURL=ImageMcq-uz_Frf8V.js.map
