const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Android-BjPMgENh.js","assets/Android-apmvPHd3.css"])))=>i.map(i=>d[i]);
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    __vitePreload(() => import("./browser-ponyfill-CdMGqtFU.js").then((n2) => n2.b), true ? [] : void 0).then(function(mod) {
...
const Web = null;
const Android = reactExports.lazy(() => __vitePreload(() => import("./Android-BjPMgENh.js").then((n2) => n2.au), true ? __vite__mapDeps([0,1]) : void 0));
function App() {
...
//# sourceMappingURL=index-jw8wap8F.js.map
