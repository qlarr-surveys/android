...
(function () {
  ...
  System.register(['./index-legacy-Dac_YmKi.js', './Android-legacy-CjEUwhux.js'], function (exports, module) {
    ...
    var THEME_ID, _objectWithoutPropertiesLoose, React, _extends, reactExports, generateUtilityClass, generateUtilityClasses, extendSxProp, jsxRuntimeExports, clsx$1, resolveBreakpointValues, handleBreakpoints, getDefaultExportFromCjs, commonjsGlobal, useTheme$1, useThemeProps$1, defaultTheme, _inheritsLoose, forceReflow, Transition, useDefaultProps, useTheme, styled, composeClasses$1, useFormControl, FormControlContext, Typography, capitalize, ButtonBase, createSvgIcon, useEnhancedEffect$1, debounce, ownerWindow, useRtl, useSlotProps, useEventCallback, ownerDocument, alpha, useControlled$1, Fade, TransitionGroup, useForkRef, IconButton, useId, Button, DialogActions, Grow, FocusTrap, Popper, Paper, Dialog, dialogClasses, DialogContent, useMediaQuery, useSelector, shallowEqual, useDispatch, TextField, valueChange;
    return {
      setters: [module => {
        THEME_ID = module.M;
        ...
        useTheme = module.b;
        styled = module.s;
        composeClasses$1 = module.c;
        useFormControl = module.e;
        FormControlContext = module.F;
        Typography = module.g;
        capitalize = module.h;
        ButtonBase = module.B;
        createSvgIcon = module.i;
        useEnhancedEffect$1 = module.j;
        debounce = module.k;
        ownerWindow = module.o;
        useRtl = module.l;
        useSlotProps = module.m;
        useEventCallback = module.n;
        ownerDocument = module.p;
        alpha = module.q;
        useControlled$1 = module.r;
        Fade = module.t;
        TransitionGroup = module.v;
        useForkRef = module.w;
        IconButton = module.I;
        useId = module.x;
        Button = module.y;
        ...
        Paper = module.A;
        Dialog = module.C;
        dialogClasses = module.E;
        DialogContent = module.H;
        useMediaQuery = module.J;
...
//# sourceMappingURL=DateTimeQuestion-legacy-B-UJEA8H.js.map
