...
(function () {
  ...
  System.register(['./index-legacy-DbBgSDRL.js', './Android-legacy-DTaKd7fz.js'], function (exports, module) {
    ...
    var getAugmentedNamespace, commonjsGlobal, getDefaultExportFromCjs, reactExports, jsxs, jsx, Fragment, propTypesExports, useService, useTranslation, NAMESPACES, useSelector, useDispatch, downloadFileAsBase64, previewUrlByFilename, Box, Button, uploadDataUrl, valueChange;
    return {
      setters: [module => {
        ...
        downloadFileAsBase64 = module.Z;
        previewUrlByFilename = module.$;
        Box = module.a0;
        Button = module.x;
        uploadDataUrl = module.a1;
...
//# sourceMappingURL=Signature-legacy-DjGCemrB.js.map
