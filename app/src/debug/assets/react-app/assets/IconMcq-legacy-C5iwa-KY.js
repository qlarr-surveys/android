;
(function () {
  System.register(['./index-legacy-1AolfYmu.js', './Android-legacy-BuzJjxPU.js', './index-legacy-CJDc6daD.js'], function (exports, module) {
    'use strict';

    var useTheme, jsx, Box, jsxs, useSelector, shallowEqual, useDispatch, buildResourceUrl, valueChange, Content, DynamicSvg;
    return {
      setters: [module => {
        useTheme = module.ar;
        jsx = module.as;
...
//# sourceMappingURL=IconMcq-legacy-C5iwa-KY.js.map
