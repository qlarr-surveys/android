...
(function () {
  ...
  System.register(['./index-legacy-BLatMfxz.js', './use-service-legacy-DLuVKbJp.js', './DateUtils-legacy-Dg58phWT.js', './survey-legacy-CmPJYFAs.js', './TextField-legacy-Cn7jw8uN.js', './Web-legacy-G20LTzwp.js', './index-legacy-CrjT7QZL.js', './Card-legacy-DAyj9G4N.js', './FormGroup-legacy-DOXCNPX6.js', './Checkbox-legacy-B_Sa2GUd.js', './SwitchBase-legacy-C9xQX8jx.js', './Tabs-legacy-DSWwlWIj.js', './radioClasses-legacy-DphQBUmK.js', './tableRowClasses-legacy-BNdXjQON.js', './FormControlLabel-legacy-CA95rTY_.js', './index-legacy-C4Gq-aSS.js', './dayjs.min-legacy-DVnPMy8l.js', './DateTimePicker-legacy-FFoNYnkB.js', './InputAdornment-legacy-CCb1yK4O.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, useNavigate, reactExports, Box, useTranslation, FormControl, Select, MenuItem, useService, useDispatch, Typography, Stack, Button, routes, setLoading, PROCESSED_ERRORS, localDateToServerDateTime, SURVEY_MODE, InputLabel, TextField, FormHelperText, KeyboardArrowDown, SurveyActiveFromTo, Card, FormGroup;
    return {
      setters: [module => {
...
//# sourceMappingURL=index-legacy-BwCXNXFq.js.map
