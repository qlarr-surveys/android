(function () {
	...
	var toString$o = uncurryThis$$({}.toString);
	var stringSlice$d = uncurryThis$$(''.slice);

	var classofRaw$2 = function (it) {
	  return stringSlice$d(toString$o(it), 8, -1);
	};
	...
	var requireObjectCoercible$e = function (it) {
	  if (isNullOrUndefined$7(it)) throw new $TypeError$v("Can't call method on " + it);
	  return it;
	};
	...
	var aCallable$q = function (argument) {
	  ...
	  throw new $TypeError$u(tryToString$5(argument) + ' is not a function');
	};
	...
	var getMethod$a = function (V, P) {
	  var func = V[P];
	  return isNullOrUndefined$6(func) ? undefined : aCallable$p(func);
	};
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$s(fn = input.toString) && !isObject$y(val = call$I(fn, input))) return val;
	  if (isCallable$s(fn = input.valueOf) && !isObject$y(val = call$I(fn, input))) return val;
	  if (pref !== 'string' && isCallable$s(fn = input.toString) && !isObject$y(val = call$I(fn, input))) return val;
	  throw new $TypeError$t("Can't convert object to primitive value");
	};
	...
	var toString$n = uncurryThis$X(1.1.toString);
	...
	var toPrimitive$2 = function (input, pref) {
	  if (!isObject$x(input) || isSymbol$4(input)) return input;
	  var exoticToPrim = getMethod$9(input, TO_PRIMITIVE);
	  var result;
	  if (exoticToPrim) {
	    if (pref === undefined) pref = 'default';
	    result = call$H(exoticToPrim, input, pref);
	    if (!isObject$x(result) || isSymbol$4(result)) return result;
	...
	objectGetOwnPropertyDescriptor.f = DESCRIPTORS$x ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (hasOwn$p(O, P)) return createPropertyDescriptor$7(!call$G(propertyIsEnumerableModule$1.f, O, P), O[P]);
	};
	...
	var anObject$y = function (argument) {
	  ...
	  throw new $TypeError$r($String$5(argument) + ' is not an object');
	};
	...
	objectDefineProperty.f = DESCRIPTORS$v ? V8_PROTOTYPE_DEFINE_BUG$1 ? function defineProperty(O, P, Attributes) {
	  ...
	  if ('get' in Attributes || 'set' in Attributes) throw new $TypeError$q('Accessors not supported');
	...
	var WeakMap$2 = globalThis$U.WeakMap;
	...
	var set$7, get$5, has$c;

	var enforce = function (it) {
	  return has$c(it) ? get$5(it) : set$7(it, {});
	};

	var getterFor = function (TYPE) {
	  return function (it) {
	    var state;
	    if (!isObject$u(it) || (state = get$5(it)).type !== TYPE) {
	...
	var objectKeysInternal = function (object, names) {
	  ...
	  var result = [];
	  var key;
	  for (key in O) !hasOwn$l(hiddenKeys$3, key) && hasOwn$l(O, key) && push$c(result, key);
	...
	var isForced$4 = function (feature, detection) {
	  ...
	  return value === POLYFILL ? true
	    : value === NATIVE ? false
	    : isCallable$n(detection) ? fails$K(detection)
	    : !!detection;
	};
	...
	*/
	...
	if (DESCRIPTORS$r && isCallable$l(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  // Safari 12 bug
	...
	var functionApply = typeof Reflect == 'object' && Reflect.apply || (NATIVE_BIND$1 ? call$F.bind(apply$7) : function () {
	...
	var functionUncurryThisAccessor = function (object, key, method) {
	  try {
	    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	    return uncurryThis$R(aCallable$o(Object.getOwnPropertyDescriptor(object, key)[method]));
	  } catch (error) { /* empty */ }
	};
	...
	var aPossiblePrototype$1 = function (argument) {
	  ...
	  throw new $TypeError$p("Can't set " + $String$2(argument) + ' as a prototype');
	};
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  $$1g({ global: true, constructor: true, arity: 1, forced: FORCED$g }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    $$1g({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$g }, O);
	  }
	};
	...
	var doesNotExceedSafeInteger$5 = function (it) {
	  if (it > MAX_SAFE_INTEGER) throw $TypeError$o('Maximum allowed index exceeded');
	  return it;
	};
	...
	var arraySetLength = SILENT_ON_NON_WRITABLE_LENGTH_SET ? function (O, length) {
	  if (isArray$7(O) && !getOwnPropertyDescriptor$4(O, 'length').writable) {
	    throw new $TypeError$n('Cannot set read only .length');
	...
	var isConstructor$5 = !construct || fails$I(function () {
	  var called;
	...
	var arraySpeciesConstructor$1 = function (originalArray) {
	  ...
	  if (isArray$6(originalArray)) {
	    ...
	    if (isConstructor$4(C) && (C === $Array$4 || isArray$6(C.prototype))) C = undefined;
	...
	var setArrayLength$5 = arraySetLength;
	...
	$$1f({ target: 'Array', proto: true, arity: 1, forced: FORCED$f }, {
	...
	var createMethod$5 = function (TYPE) {
	  ...
	  return function ($this, callbackfn, that) {
	    ...
	    var index = 0;
	    var resIndex = 0;
	    var target = IS_MAP ? arraySpeciesCreate$3($this, length) : IS_FILTER || IS_FILTER_REJECT ? arraySpeciesCreate$3($this, 0) : undefined;
	    var value, result;
	    for (;length > index; index++) if (NO_HOLES || index in self) {
	      value = self[index];
	      result = boundFunction(value, index, O);
	      if (TYPE) {
	        if (IS_MAP) createProperty$9(target, index, result);    // map
	        else if (result) switch (TYPE) {
	          case 3: return true;                                // some
	          case 5: return value;                               // find
	          case 6: return index;                               // findIndex
	          case 2: createProperty$9(target, resIndex++, value);  // filter
	        } else switch (TYPE) {
	          case 4: return false;                               // every
	          case 7: createProperty$9(target, resIndex++, value);  // filterReject
	        }
	      }
	    }
	...
	var getIteratorMethod$6 = function (it) {
	  if (!isNullOrUndefined$5(it)) return getMethod$7(it, ITERATOR$8)
	...
	var getIterator$4 = function (argument, usingIterator) {
	  ...
	  if (aCallable$m(iteratorMethod)) return anObject$t(call$D(iteratorMethod, argument));
	...
	var setArrayLength$4 = arraySetLength;
	...
	// `Array.from` method
	// https://tc39.es/ecma262/#sec-array.from
	$$1d({ target: 'Array', stat: true, forced: INCORRECT_ITERATION }, {
	  from: from
	});
	...
	// `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	$$1c({ target: 'Array', proto: true, forced: BROKEN_ON_SPARSE }, {
	...
	var FORCED$e = NEGATIVE_ZERO$1 || !arrayMethodIsStrict$4('indexOf');

	// `Array.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-array.prototype.indexof
	$$1b({ target: 'Array', proto: true, forced: FORCED$e }, {
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$n(IteratorPrototype$4) || fails$C(function () {
	  var test = {};
	...
	var iteratorDefine = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (DEFAULT) {
	    ...
	    } else $$1a({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS || INCORRECT_VALUES_NAME }, methods);
	  }
	...
	// https://tc39.es/ecma262/#sec-array.prototype.map
	// with adding support of @@species
	$$19({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$2 }, {
	...
	var setArrayLength$3 = arraySetLength;
	...
	var FORCED$d = INCORRECT_TO_LENGTH || !properErrorOnNonWritableLength$1();
	...
	var deletePropertyOrThrow$3 = function (O, P) {
	  if (!delete O[P]) throw new $TypeError$l('Cannot delete property ' + tryToString$3(P) + ' of ' + tryToString$3(O));
	};
	...
	$$16({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	  splice: function splice(start, deleteCount /* , ...items */) {
	    ...
	    if (argumentsLength === 0) {
	      ...
	      actualDeleteCount = min$7(max$3(toIntegerOrInfinity$a(deleteCount), 0), len - actualStart);
	    }
	    ...
	    setArrayLength$1(A, actualDeleteCount);
	...
	$$15({ target: 'Array', proto: true, arity: 1, forced: FORCED$c }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$14({ global: true, forced: globalThis$P.globalThis !== globalThis$P }, {
	  globalThis: globalThis$P
	});
	...
	var NativeIterator = globalThis$O[ITERATOR$4];

	// FF56- have non-standard global helper `Iterator`
	var FORCED$b = !isCallable$f(NativeIterator)
	...
	var IteratorConstructor = function Iterator() {
	  ...
	  if (getPrototypeOf$2(this) === IteratorPrototype$1) throw new $TypeError$j('Abstract class Iterator not directly constructable');
	};
	  ...
	  if (DESCRIPTORS$l) {
	    defineBuiltInAccessor$c(IteratorPrototype$1, key, {
	      ...
	      set: function (replacement) {
	        anObject$q(this);
	        if (this === IteratorPrototype$1) throw new $TypeError$j("You can't redefine this property");
	...
	if (FORCED$b || !hasOwn$f(IteratorPrototype$1, CONSTRUCTOR) || IteratorPrototype$1[CONSTRUCTOR] === Object) {
	...
	$$13({ global: true, constructor: true, forced: FORCED$b }, {
	...
	var iteratorCloseAll$1 = function (iters, kind, value) {
	  for (var i = iters.length - 1; i >= 0; i--) {
	    ...
	    try {
	      value = iteratorClose$d(iters[i].iterator, kind, value);
	    } catch (error) {
	      kind = 'throw';
	      value = error;
	    }
	...
	var createIteratorProxyPrototype = function (IS_ITERATOR) {
	  var getInternalState = InternalStateModule$a.getterFor(IS_ITERATOR ? WRAP_FOR_VALID_ITERATOR : ITERATOR_HELPER);
	  ...
	  return defineBuiltIns$5(create$5(IteratorPrototype), {
	    next: function next() {
	      ...
	      if (state.done) return createIterResultObject$4(undefined, true);
	      try {
	        var result = state.nextHandler();
	        return state.returnHandlerResult ? result : createIterResultObject$4(result, state.done);
	      } catch (error) {
	        state.done = true;
	        throw error;
	      }
	    ...
	    'return': function () {
	      ...
	      if (IS_ITERATOR) {
	        ...
	        return returnMethod ? call$A(returnMethod, iterator) : createIterResultObject$4(undefined, true);
	      }
	      if (state.inner) try {
	        iteratorClose$c(state.inner.iterator, NORMAL);
	      } catch (error) {
	        return iteratorClose$c(iterator, THROW, error);
	      }
	      ...
	      if (iterator) iteratorClose$c(iterator, NORMAL);
	...
	var iteratorHelperWithoutClosingOnEarlyError$9 = function (METHOD_NAME, ExpectedError) {
	  var Iterator = globalThis$N.Iterator;
	...
	var filterWithoutClosingOnEarlyError = !FILTER_WITHOUT_THROWING_ON_INVALID_ITERATOR
	  && iteratorHelperWithoutClosingOnEarlyError$8('filter', TypeError);

	var FORCED$a = FILTER_WITHOUT_THROWING_ON_INVALID_ITERATOR || filterWithoutClosingOnEarlyError;
	...
	var IteratorProxy$3 = createIteratorProxy$3(function () {
	  ...
	  while (true) {
	    result = anObject$p(call$z(next, iterator));
	...
	$$12({ target: 'Iterator', proto: true, real: true, forced: FORCED$a }, {
	...
	var iterate$f = function (iterable, unboundFunction, options) {
	  ...
	  if (IS_RECORD) {
	    ...
	    if (!iterFn) throw new $TypeError$i(tryToString$2(iterable) + ' is not iterable');
	    // optimisation for array iterators
	    if (isArrayIteratorMethod$1(iterFn)) {
	      for (index = 0, length = lengthOfArrayLike$h(iterable); length > index; index++) {
	...
	$$11({ target: 'Iterator', proto: true, real: true, forced: forEachWithoutClosingOnEarlyError }, {
	  forEach: function forEach(fn) {
	    ...
	    if (forEachWithoutClosingOnEarlyError) return call$x(forEachWithoutClosingOnEarlyError, this, fn);

	    var record = getIteratorDirect$a(this);
	    var counter = 0;
	    iterate$e(record, function (value) {
	      fn(value, counter++);
	    }, { IS_RECORD: true });
	  }
	});
	...
	var FORCED$9 = MAP_WITHOUT_THROWING_ON_INVALID_ITERATOR || mapWithoutClosingOnEarlyError;

	var IteratorProxy$2 = createIteratorProxy$2(function () {
	  var iterator = this.iterator;
	  var result = anObject$m(call$w(this.next, iterator));
	...
	$$10({ target: 'Iterator', proto: true, real: true, forced: FORCED$9 }, {
	  map: function map(mapper) {
	    ...
	    if (mapWithoutClosingOnEarlyError) return call$w(mapWithoutClosingOnEarlyError, this, mapper);
	...
	var parseJsonString = function (source, i) {
	  ...
	  while (i < source.length) {
	    ...
	    if (chr === '\\') {
	      ...
	      if (hasOwn$e(codePoints, twoChars)) {
	...
	var JSON$1 = globalThis$M.JSON;
	var Number$1 = globalThis$M.Number;
	...
	var $parse = function (source, reviver) {
	  ...
	  if (endIndex < source.length) {
	    throw new SyntaxError$4('Unexpected extra character: "' + at$1(source, endIndex) + '" after the parsed data at: ' + endIndex);
	  }
	  return isCallable$e(reviver) ? internalize({ '': value }, '', reviver, root) : value;
	};
	...
	var internalize = function (holder, name, reviver, node) {
	  ...
	  if (isObject$l(val)) {
	    var nodeIsArray = isArray$3(val);
	    var nodes = unmodified ? node.nodes : nodeIsArray ? [] : {};
	    if (nodeIsArray) {
	      elementRecordsLen = nodes.length;
	      len = lengthOfArrayLike$g(val);
	      for (i = 0; i < len; i++) {
	        internalizeProperty(val, i, internalize(val, '' + i, reviver, i < elementRecordsLen ? nodes[i] : undefined));
	      }
	    } else {
	      keys = enumerableOwnProperties(val);
	      len = lengthOfArrayLike$g(keys);
	      for (i = 0; i < len; i++) {
	        P = keys[i];
	        internalizeProperty(val, P, internalize(val, P, reviver, hasOwn$d(nodes, P) ? nodes[P] : undefined));
	      }
	    }
	  }
	  return call$v(reviver, holder, name, val, context);
	};
	...
	var internalizeProperty = function (object, key, value) {
	  ...
	  else createProperty$4(object, key, value);
	};
	...
	Context.prototype = {
	  ...
	  parse: function () {
	    ...
	    } throw new SyntaxError$4('Unexpected character: "' + chr + '" at: ' + i);
	  },
	  ...
	  object: function () {
	    ...
	    while (i < source.length) {
	      ...
	      createProperty$4(nodes, key, result);
	      createProperty$4(object, key, result.value);
	  ...
	  number: function () {
	    ...
	    else if (exec$7(IS_NON_ZERO_DIGIT, at$1(source, i))) i = this.skip(IS_DIGIT, i + 1);
	    else throw new SyntaxError$4('Failed to parse number at: ' + i);
	    ...
	    if (at$1(source, i) === 'e' || at$1(source, i) === 'E') {
	      ...
	      if (exponentStartIndex === i) throw new SyntaxError$4("Failed to parse number's exponent value at: " + i);
	    }
	  ...
	  keyword: function (value) {
	    ...
	    if (slice$4(this.source, index, endIndex) !== keyword) throw new SyntaxError$4('Failed to parse value at: ' + index);
	...
	var NO_SOURCE_SUPPORT = fails$z(function () {
	...
	var PROPER_BASE_PARSE = NATIVE_SYMBOL$1 && !fails$z(function () {
	  // Safari 9 bug
	...
	var isRawJson = function isRawJSON(O) {
	  ...
	  var state = getInternalState$6(O);
	...
	var nativeRawJson = !fails$y(function () {
	  var unsafeInt = '9007199254740993';
	...
	var numberToString$2 = uncurryThis$I(1.1.toString);
	...
	var WRONG_SYMBOLS_CONVERSION = !NATIVE_SYMBOL || fails$x(function () {
	...
	var stringifyWithProperSymbolsConversion = WRONG_SYMBOLS_CONVERSION ? function (it, replacer) {
	  ...
	  args[1] = function (key, value) {
	    ...
	    if (isCallable$d($replacer)) value = call$u($replacer, this, $String$1(key), value);
	...
	var fixIllFormedJSON = function (match, offset, string) {
	  ...
	  if ((exec$6(lowSurrogates, match) && !exec$6(hiSurrogates, next)) || (exec$6(hiSurrogates, match) && !exec$6(lowSurrogates, prev))) {
	...
	var getReplacerFunction = function (replacer) {
	  ...
	  for (var i = 0; i < rawLength; i++) {
	    ...
	    else if (typeof element == 'number' || classof$e(element) === 'Number' || classof$e(element) === 'String') push$a(keys, toString$i(element));
	  }
	...
	// https://github.com/tc39/proposal-json-parse-with-source
	if ($stringify) $$_({ target: 'JSON', stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE || !NATIVE_RAW_JSON }, {
	  stringify: function stringify(text, replacer, space) {
	    ...
	    var json = stringifyWithProperSymbolsConversion(text, function (key, value) {
	      // some old implementations (like WebKit) could pass numbers as keys
	      var v = isCallable$d(replacerFunction) ? call$u(replacerFunction, this, $String$1(key), value) : value;
	      return !NATIVE_RAW_JSON && isRawJSON(v) ? MARK + (push$a(rawStrings, v.rawJSON) - 1) : v;
	    }, space);

	    if (typeof json != 'string') return json;

	    if (ILL_FORMED_UNICODE) json = replace$7(json, surrogates, fixIllFormedJSON);
	    ...
	    for (var i = 0; i < length; i++) {
	      ...
	      if (chr === '"') {
	        ...
	        var string = slice$3(json, i, end);
	        result += slice$3(string, 0, MARK_LENGTH) === MARK
	          ? rawStrings[slice$3(string, MARK_LENGTH)]
	          : '"' + string + '"';
	        i = end;
	      } else result += chr;
	    }
	...
	var mapHelpers = {
	  // eslint-disable-next-line es/no-map -- safe
	  Map: Map,
	  set: uncurryThis$F(MapPrototype.set),
	  get: uncurryThis$F(MapPrototype.get),
	  has: uncurryThis$F(MapPrototype.has),
	  remove: uncurryThis$F(MapPrototype['delete'])};

	var has$b = mapHelpers.has;

	// Perform ? RequireInternalSlot(M, [[MapData]])
	var aMap$2 = function (it) {
	  has$b(it);
	  return it;
	};
	...
	var get$4 = MapHelpers$2.get;
	var has$a = MapHelpers$2.has;
	var set$6 = MapHelpers$2.set;

	// `Map.prototype.getOrInsert` method
	// https://github.com/tc39/proposal-upsert
	$$X({ target: 'Map', proto: true, real: true, forced: IS_PURE$3 }, {
	  getOrInsert: function getOrInsert(key, value) {
	    if (has$a(aMap$1(this), key)) return get$4(this, key);
	    set$6(this, key, value);
	    return value;
	  }
	});
	...
	// https://github.com/tc39/proposal-upsert
	$$W({ target: 'Map', proto: true, real: true, forced: IS_PURE$2 }, {
	  getOrInsertComputed: function getOrInsertComputed(key, callbackfn) {
	    aMap(this);
	    aCallable$i(callbackfn);
	    if (has$9(this, key)) return get$3(this, key);
	    // CanonicalizeKeyedCollectionKey
	    if (key === 0 && 1 / key === -Infinity) key = 0;
	    var value = callbackfn(key);
	    set$5(this, key, value);
	    return value;
	  }
	});
	...
	var aConstructor$2 = function (argument) {
	  ...
	  throw new $TypeError$h(tryToString$1(argument) + ' is not a constructor');
	};
	...
	var speciesConstructor$3 = function (O, defaultConstructor) {
	  ...
	  var S;
	  return C === undefined || isNullOrUndefined$2(S = anObject$l(C)[SPECIES$2]) ? defaultConstructor : aConstructor$1(S);
	};
	...
	var set$4 = globalThis$I.setImmediate;
	...
	if (!set$4 || !clear) {
	  ...
	  // IE8 has postMessage, but it's sync & typeof its postMessage is 'object'
	    ...
	    isCallable$b(globalThis$I.postMessage) &&
	...
	var safeGetBuiltIn$2 = function (name) {
	  if (!DESCRIPTORS$h) return globalThis$H[name];
	  var descriptor = getOwnPropertyDescriptor$2(globalThis$H, name);
	...
	if (!microtask$2) {
	  ...
	  // - setTimeout
	    ...
	    macrotask = bind$7(macrotask, globalThis$G);
	    notify$1 = function () {
	      macrotask(flush);
	    };
	  }
	...
	var NATIVE_PROMISE_REJECTION_EVENT$1 = isCallable$a(globalThis$E.PromiseRejectionEvent);
	...
	var TypeError$7 = globalThis$D.TypeError;
	...
	var isThenable = function (it) {
	  var then;
	  return isObject$g(it) && isCallable$9(then = it.then) ? then : false;
	};
	...
	var onUnhandled = function (state) {
	  call$t(task, globalThis$D, function () {
	...
	// https://tc39.es/ecma262/#sec-get-regexp.prototype.flags
	if (DESCRIPTORS$g && !regExpFlagsDetection$1.correct) {
	  defineBuiltInAccessor$9(RegExp.prototype, 'flags', {
	    configurable: true,
	...
	var forEach$4 = uncurryThis$C(SetPrototype.forEach);
	var keys$1 = uncurryThis$C(SetPrototype.keys);
	var next = keys$1(new Set$4()).next;

	var setIterate$1 = function (set, fn, interruptible) {
	  return interruptible ? iterateSimple$6({ iterator: keys$1(set), next: next }, fn) : forEach$4(set, fn);
	};
	...
	SetRecord.prototype = {
	  getIterator: function () {
	    return getIteratorDirect$8(anObject$h(call$n(this.keys, this.set)));
	  },
	...
	var getSetRecord$7 = function (obj) {
	  ...
	  // eslint-disable-next-line no-self-compare -- NaN check
	  if (numSize !== numSize) throw new $TypeError$e(INVALID_SIZE);
	...
	var FORCED$8 = SET_LIKE_INCORRECT_BEHAVIOR || fails$n(function () {
	...
	// `Set.prototype.intersection` method
	// https://tc39.es/ecma262/#sec-set.prototype.intersection
	$$L({ target: 'Set', proto: true, real: true, forced: INCORRECT$3 }, {
	...
	var setIsDisjointFrom = function isDisjointFrom(other) {
	  ...
	  return iterateSimple$3(iterator, function (e) {
	    if (has$5(O, e)) return iteratorClose$7(iterator, 'normal', false);
	  }) !== false;
	};
	...
	// `Set.prototype.isDisjointFrom` method
	// https://tc39.es/ecma262/#sec-set.prototype.isdisjointfrom
	$$K({ target: 'Set', proto: true, real: true, forced: INCORRECT$2 }, {
	...
	// `Set.prototype.isSubsetOf` method
	// https://tc39.es/ecma262/#sec-set.prototype.issubsetof
	$$J({ target: 'Set', proto: true, real: true, forced: INCORRECT$1 }, {
	...
	var setIsSupersetOf = function isSupersetOf(other) {
	  ...
	  return iterateSimple$2(iterator, function (e) {
	    if (!has$4(O, e)) return iteratorClose$6(iterator, 'normal', false);
	  }) !== false;
	};
	...
	var FORCED$7 = !setMethodAcceptSetLike$1('symmetricDifference') || !setMethodGetKeysBeforeCloning$1('symmetricDifference');

	// `Set.prototype.symmetricDifference` method
	// https://tc39.es/ecma262/#sec-set.prototype.symmetricdifference
	$$H({ target: 'Set', proto: true, real: true, forced: FORCED$7 }, {
	...
	var FORCED$6 = !setMethodAcceptSetLike('union') || !setMethodGetKeysBeforeCloning('union');

	// `Set.prototype.union` method
	// https://tc39.es/ecma262/#sec-set.prototype.union
	$$G({ target: 'Set', proto: true, real: true, forced: FORCED$6 }, {
	  union: union
	});
	...
	$$F({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG$1 && !CORRECT_IS_REGEXP_LOGIC$1 }, {
	  endsWith: function endsWith(searchString /* , endPosition = @length */) {
	    ...
	    var len = that.length;
	    var end = endPosition === undefined ? len : min$6(toLength$8(endPosition), len);
	...
	var stringIndexOf$4 = uncurryThis$A(''.indexOf);
	...
	var regexpGetFlags = regExpFlagsDetection.correct ? function (it) {
	  ...
	  return (!regExpFlagsDetection.correct && isPrototypeOf$3(RegExpPrototype$3, it) && !hasOwn$a(it, 'flags'))
	    ? call$l(regExpFlagsGetterImplementation, it)
	    : it.flags;
	};
	...
	var regexpExecAbstract = function (R, S) {
	  ...
	  if (classof$9(R) === 'RegExp') return call$k(regexpExec, R, S);
	...
	fixRegExpWellKnownSymbolLogic$3('match', function (MATCH, nativeMatch, maybeCallNative) {
	  return [
	    ...
	    function match(regexp) {
	      ...
	      var matcher = isObject$d(regexp) ? getMethod$5(regexp, MATCH) : undefined;
	      return matcher ? call$j(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$c(O));
	    },
	    ...
	    function (string) {
	      ...
	      var flags = toString$c(getRegExpFlags$5(rx));
	...
	fixRegExpWellKnownSymbolLogic$2('replace', function (_, nativeReplace, maybeCallNative) {
	  ...
	  return [
	    ...
	    function replace(searchValue, replaceValue) {
	      ...
	      var replacer = isObject$c(searchValue) ? getMethod$4(searchValue, REPLACE$1) : undefined;
	      return replacer
	    ...
	    function (string, replaceValue) {
	      ...
	      var flags = toString$b(getRegExpFlags$4(rx));
	      ...
	      for (var i = 0; i < results.length; i++) {
	        ...
	        var position = max$1(min$5(toIntegerOrInfinity$7(result.index), S.length), 0);
	        var captures = [];
	        var replacement;
	        ...
	        if (functionalReplace) {
	          ...
	          replacement = toString$b(apply$3(replaceValue, undefined, replacerArgs));
	        } else {
	...
	fixRegExpWellKnownSymbolLogic$1('search', function (SEARCH, nativeSearch, maybeCallNative) {
	  return [
	    ...
	    function search(regexp) {
	      ...
	      var searcher = isObject$b(regexp) ? getMethod$3(regexp, SEARCH) : undefined;
	      return searcher ? call$h(searcher, regexp, O) : new RegExp(regexp)[SEARCH](toString$a(O));
	    },
	...
	$$D({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG && !CORRECT_IS_REGEXP_LOGIC }, {
	  startsWith: function startsWith(searchString /* , position = 0 */) {
	    ...
	    var index = toLength$5(min$4(arguments.length > 1 ? arguments[1] : undefined, that.length));
	    var search = toString$9(searchString);
	    return stringSlice$6(that, index, index + search.length) === search;
	  }
	});
	...
	var collectionWeak$2 = {
	  getConstructor: function (wrapper, CONSTRUCTOR_NAME, IS_MAP, ADDER) {
	    var Constructor = wrapper(function (that, iterable) {
	      ...
	      if (!isNullOrUndefined$1(iterable)) iterate$7(iterable, that[ADDER], { that: that, AS_ENTRIES: IS_MAP });
	    });
	...
	var nativeSet = uncurryThis$s(WeakMapPrototype$1.set);
	...
	if (NATIVE_WEAK_MAP) if (IS_IE11) {
	  ...
	  var nativeDelete = uncurryThis$s(WeakMapPrototype$1['delete']);
	  var nativeHas = uncurryThis$s(WeakMapPrototype$1.has);
	  var nativeGet = uncurryThis$s(WeakMapPrototype$1.get);
	...
	var weakMapHelpers = {
	  // eslint-disable-next-line es/no-weak-map -- safe
	  WeakMap: WeakMap,
	  set: uncurryThis$r(WeakMapPrototype.set),
	  get: uncurryThis$r(WeakMapPrototype.get),
	  has: uncurryThis$r(WeakMapPrototype.has),
	  remove: uncurryThis$r(WeakMapPrototype['delete'])
	};
	...
	var has$1 = WeakMapHelpers$2.has;
	var set$3 = WeakMapHelpers$2.set;

	// `WeakMap.prototype.getOrInsert` method
	// https://github.com/tc39/proposal-upsert
	$$B({ target: 'WeakMap', proto: true, real: true, forced: IS_PURE$1 }, {
	  getOrInsert: function getOrInsert(key, value) {
	    if (has$1(aWeakMap$1(this), key)) return get$2(this, key);
	...
	var set$2 = WeakMapHelpers$1.set;
	...
	var set$1 = WeakMapHelpers.set;

	var FORCED$5 = !function () {
	  try {
	...
	// https://github.com/tc39/proposal-upsert
	$$A({ target: 'WeakMap', proto: true, real: true, forced: FORCED$5 }, {
	  getOrInsertComputed: function getOrInsertComputed(key, callbackfn) {
	    aWeakMap(this);
	    aWeakKey(key);
	    aCallable$c(callbackfn);
	    if (has(this, key)) return get$1(this, key);
	    var value = callbackfn(key);
	...
	for (var COLLECTION_NAME$1 in DOMIterables$1) {
	  if (DOMIterables$1[COLLECTION_NAME$1]) {
	    handlePrototype$1(globalThis$w[COLLECTION_NAME$1] && globalThis$w[COLLECTION_NAME$1].prototype);
	  }
	}
	...
	for (var COLLECTION_NAME in DOMIterables) {
	  handlePrototype(globalThis$v[COLLECTION_NAME] && globalThis$v[COLLECTION_NAME].prototype, COLLECTION_NAME);
	}
	...
	var $DOMException = function DOMException() {
	  ...
	  inheritIfRequired$3(that, this, $DOMException);
	  return that;
	};
	...
	// eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	var descriptor$1 = NativeDOMException && DESCRIPTORS$f && Object.getOwnPropertyDescriptor(globalThis$u, DOM_EXCEPTION);
	...
	$$y({ global: true, bind: true, enumerable: true, forced: globalThis$t.clearImmediate !== clearImmediate }, {
	...
	var WRAP = /MSIE .\./.test(USER_AGENT) || ENVIRONMENT$1 === 'BUN' && (function () {
	  var version = globalThis$s.Bun.version.split('.');
	...
	// https://github.com/oven-sh/bun/issues/1633
	var setImmediate = globalThis$r.setImmediate ? schedulersFix(setTask, false) : setTask;

	// `setImmediate` method
	// http://w3c.github.io/setImmediate/#si-setImmediate
	$$x({ global: true, bind: true, enumerable: true, forced: globalThis$r.setImmediate !== setImmediate }, {
	...
	var WRONG_ARITY = fails$h(function () {
	  // getOwnPropertyDescriptor for prevent experimental warning in Node 11
	  // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	  return DESCRIPTORS$e && Object.getOwnPropertyDescriptor(globalThis$q, 'queueMicrotask').value.length !== 1;
	});

	// `queueMicrotask` method
	// https://html.spec.whatwg.org/multipage/timers-and-user-prompts.html#dom-queuemicrotask
	$$w({ global: true, enumerable: true, dontCallGetSet: true, forced: WRONG_ARITY }, {
	  queueMicrotask: function queueMicrotask(fn) {
	    validateArgumentsLength$5(arguments.length, 1);
	    microtask(aCallable$b(fn));
	  }
	});
	...
	var INCORRECT_VALUE = globalThis$p.self !== globalThis$p;
	...
	try {
	  if (DESCRIPTORS$d) {
	    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	    var descriptor = Object.getOwnPropertyDescriptor(globalThis$p, 'self');
	    // some engines have `self`, but with incorrect descriptor
	    // https://github.com/denoland/deno/issues/15765
	    if (INCORRECT_VALUE || !descriptor || !descriptor.get || !descriptor.enumerable) {
	      defineBuiltInAccessor$8(globalThis$p, 'self', {
	        get: function self() {
	          return globalThis$p;
	        },
	        set: function self(value) {
	          if (this !== globalThis$p) throw new $TypeError$b('Illegal invocation');
	          defineProperty$2(globalThis$p, 'self', {
	            value: value,
	            writable: true,
	            configurable: true,
	            enumerable: true
	...
	var objectAssign = !$assign || fails$f(function () {
	  ...
	  if (DESCRIPTORS$b && $assign({ b: 1 }, $assign(defineProperty$1({}, 'a', {
	    enumerable: true,
	    get: function () {
	  ...
	  while (argumentsLength > index) {
	    ...
	    while (length > j) {
	      key = keys[j++];
	      if (!DESCRIPTORS$b || call$g(propertyIsEnumerable, S, key)) T[key] = S[key];
	    }
	  } return T;
	} : $assign;
	...
	var exec$4 = uncurryThis$p(regexSeparators.exec);
	  ...
	  while (counter < length) {
	    ...
	    if (value >= 0xD800 && value <= 0xDBFF && counter < length) {
	      ...
	      if ((extra & 0xFC00) === 0xDC00) { // Low surrogate.
	        push$8(output, ((value & 0x3FF) << 10) + (extra & 0x3FF) + 0x10000);
	      } else {
	...
	var encode = function (input) {
	  ...
	  for (i = 0; i < input.length; i++) {
	    ...
	    if (currentValue < 0x80) {
	      push$8(output, fromCharCode$2(currentValue));
	    }
	  }
	    ...
	    for (i = 0; i < input.length; i++) {
	      ...
	      if (currentValue === n) {
	        ...
	        while (true) {
	          ...
	          push$8(output, fromCharCode$2(digitToBasic(t + qMinusT % baseMinusT)));
	          q = floor$4(qMinusT / baseMinusT);
	          k += base;
	        }

	        push$8(output, fromCharCode$2(digitToBasic(q)));
	...
	var stringPunycodeToAscii = function (input) {
	  ...
	  for (i = 0; i < labels.length; i++) {
	    label = labels[i];
	    push$8(encoded, exec$4(regexNonASCII, label) ? 'xn--' + encode(label) : label);
	  }
	...
	var encodeURIComponent$1 = globalThis$o.encodeURIComponent;
	  ...
	  parseObject: function (object) {
	    ...
	    if (iteratorMethod) {
	      ...
	      while (!(step = call$f(next, iterator)).done) {
	        ...
	        if (
	          (first = call$f(entryNext, entryIterator)).done ||
	          (second = call$f(entryNext, entryIterator)).done ||
	          !call$f(entryNext, entryIterator).done
	        ) throw new TypeError$6('Expected sequence with length 2');
	        push$7(entries, { key: $toString$1(first.value), value: $toString$1(second.value) });
	      }
	    } else for (var key in object) if (hasOwn$7(object, key)) {
	      push$7(entries, { key: key, value: $toString$1(object[key]) });
	    }
	  },
	...
	defineBuiltIns$1(URLSearchParamsPrototype$3, {
	  ...
	  append: function append(name, value) {
	    ...
	    push$7(state.entries, { key: $toString$1(name), value: $toString$1(value) });
	    if (!DESCRIPTORS$a) this.size++;
	    state.updateURL();
	  },
	...
	$$s({ global: true, constructor: true, forced: !USE_NATIVE_URL, sham: !DESCRIPTORS$9 }, {
	  URL: URLConstructor
	});
	...
	var append = uncurryThis$l(URLSearchParamsPrototype$2.append);
	var $delete = uncurryThis$l(URLSearchParamsPrototype$2['delete']);
	var forEach$2 = uncurryThis$l(URLSearchParamsPrototype$2.forEach);
	...
	var getAll = uncurryThis$k(URLSearchParamsPrototype$1.getAll);
	var $has = uncurryThis$k(URLSearchParamsPrototype$1.has);
	...
	var forEach$1 = uncurryThis$j(URLSearchParamsPrototype.forEach);
	...
	var push$4 = uncurryThis$i(test.push);
	...
	$$n({ target: 'Iterator', proto: true, real: true, forced: findWithoutClosingOnEarlyError }, {
	  find: function find(predicate) {
	    ...
	    if (findWithoutClosingOnEarlyError) return call$c(findWithoutClosingOnEarlyError, this, predicate);
	...
	var FAILS_ON_INITIAL_UNDEFINED = fails$d(function () {
	...
	$$m({ target: 'Iterator', proto: true, real: true, forced: FAILS_ON_INITIAL_UNDEFINED || reduceWithoutClosingOnEarlyError }, {
	...
	$$l({ target: 'Object', stat: true, sham: !DESCRIPTORS$7 }, {
	...
	var SyntaxError$3 = globalThis$m.SyntaxError;
	var exec$1 = uncurryThis$h(RegExpPrototype$2.exec);
	...
	if (isForced('RegExp', BASE_FORCED)) {
	  ...
	  defineBuiltIn$2(globalThis$m, 'RegExp', RegExpWrapper, { constructor: true });
	}
	...
	fixRegExpWellKnownSymbolLogic('split', function (SPLIT, nativeSplit, maybeCallNative) {
	  ...
	  return [
	    ...
	    function split(separator, limit) {
	      ...
	      var splitter = isObject$7(separator) ? getMethod$2(separator, SPLIT) : undefined;
	      return splitter
	  ...
	  while (sourceIndex < sourceLen) {
	    if (sourceIndex in source) {
	      ...
	      if (depth > 0 && isArray(element)) {
	        ...
	        createProperty$2(target, targetIndex, element);
	      }
	...
	$$j({ target: 'Array', proto: true }, {
	  flatMap: function flatMap(callbackfn /* , thisArg */) {
	    ...
	    flattenIntoArray$1(A, O, O, sourceLen, 0, 1, callbackfn, arguments.length > 1 ? arguments[1] : undefined);
	    return A;
	  }
	});
	...
	var FORCED$2 = FLAT_MAP_WITHOUT_THROWING_ON_INVALID_ITERATOR || flatMapWithoutClosingOnEarlyError
	...
	$$i({ target: 'Iterator', proto: true, real: true, forced: FORCED$2 }, {
	...
	$$g({ target: 'Iterator', proto: true, real: true }, {
	  toArray: function toArray() {
	    var result = [];
	    var index = 0;
	    iterate$1(getIteratorDirect$1(anObject$3(this)), function (element) {
	...
	var IE_BUG = DESCRIPTORS$4 && fails$a(function () {
	  // eslint-disable-next-line es/no-object-create -- safe
	...
	$$c({ target: 'Array', proto: true }, {
	  flat: function flat(/* depthArg = 1 */) {
	    ...
	    flattenIntoArray(A, O, O, sourceLen, 0, depthArg === undefined ? 1 : toIntegerOrInfinity$6(depthArg));
	    return A;
	  }
	});
	...
	var FORCED$1 = NEGATIVE_ZERO || !STRICT_METHOD;
	...
	var arrayLastIndexOf = FORCED$1 ? function lastIndexOf(searchElement /* , fromIndex = @[*-1] */) {
	  ...
	  var index = length - 1;
	  if (arguments.length > 1) index = min$2(index, toIntegerOrInfinity$5(arguments[1]));
	...
	$$b({ target: 'Array', proto: true, forced: lastIndexOf !== [].lastIndexOf }, {
	...
	if (DESCRIPTORS$3 && !('detached' in ArrayBufferPrototype$3)) {
	...
	if ($transfer$1) $$a({ target: 'ArrayBuffer', proto: true }, {
	...
	if ($transfer) $$9({ target: 'ArrayBuffer', proto: true }, {
	...
	var nativeMatchAll = uncurryThis$c(''.matchAll);
	...
	$$8({ target: 'String', proto: true, forced: WORKS_WITH_NON_GLOBAL_REGEX }, {
	  matchAll: function matchAll(regexp) {
	    ...
	    if (isObject$6(regexp)) {
	      if (isRegExp$1(regexp)) {
	        flags = toString$1(requireObjectCoercible$1(getRegExpFlags$2(regexp)));
	        if (!~stringIndexOf(flags, 'g')) throw new $TypeError$6('`.matchAll` does not allow non-global regexes');
	      }
	...
	var Uint8Array$6 = globalThis$b.Uint8Array;
	...
	exportTypedArrayMethod$3('toReversed', function toReversed() {
	  ...
	  var A = new (getTypedArrayConstructor$2(O))(len);
	  var k = 0;
	...
	var Uint8Array$5 = globalThis$8.Uint8Array;
	...
	if (Uint8Array$4) $$5({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS$2 }, {
	...
	var Uint8Array$3 = globalThis$5.Uint8Array;
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (globalThis$4.Uint8Array) $$4({ target: 'Uint8Array', proto: true, forced: throwsOnLengthTrackingView() }, {
	...
	var Uint8Array$2 = globalThis$3.Uint8Array;
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (Uint8Array$2) $$3({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS$1 }, {
	...
	var Uint8Array$1 = globalThis$2.Uint8Array;
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (Uint8Array$1) $$2({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS }, {
	...
	var tryToTransfer = function (rawTransfer, map) {
	  ...
	  iterate(rawTransfer, function (value) {
	    push(transfer, anObject$1(value));
	  });
	...
	$$1({ global: true, enumerable: true, sham: !PROPER_STRUCTURED_CLONE_TRANSFER, forced: FORCED_REPLACEMENT }, {
	  structuredClone: function structuredClone(value /* , { transfer } */) {
	    var options = validateArgumentsLength(arguments.length, 1) > 1 && !isNullOrUndefined(arguments[1]) ? anObject$1(arguments[1]) : undefined;
	...
	var FORCED = DROP_WITHOUT_THROWING_ON_INVALID_ITERATOR || dropWithoutClosingOnEarlyError;
