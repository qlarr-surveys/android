...
(function () {
  ...
  System.register(['./index-legacy-BE0djssm.js', './Android-legacy-DcRmsPsH.js'], function (exports, module) {
    ...
    var reactExports, useTheme, jsxRuntimeExports, invariant, shallowEqual, wrapConnectorHooks, isRef, useDragDropManager, useIsomorphicLayoutEffect, registerTarget, useOptionalFactory, useCollectedProps, useDispatch, useSelector, shallowEqual$1, Box, valueChange, orderChange, useDrag, Content;
    return {
      setters: [module => {
        ...
        invariant = module.ad;
        shallowEqual = module.ae;
        wrapConnectorHooks = module.af;
        isRef = module.ag;
        useDragDropManager = module.ah;
        useIsomorphicLayoutEffect = module.ai;
        registerTarget = module.aj;
        useOptionalFactory = module.ak;
        useCollectedProps = module.al;
        useDispatch = module.J;
        useSelector = module.E;
        shallowEqual$1 = module.H;
        Box = module.a2;
        valueChange = module.L;
        orderChange = module.am;
        useDrag = module.an;
        Content = module.O;
      }],
...
//# sourceMappingURL=Ranking-legacy-ZOXD5z01.js.map
