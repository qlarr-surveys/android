...
const iconPaths = {
  ...
  sort: (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 24 24",
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("g", { fill: "none", stroke: "currentColor", "stroke-width": "1.5", children: [
...
export {
  ...
  Menu as W,
  routes as X,
  MANAGE_SURVEY_LANDING_PAGES as Y,
  setLoading as Z,
  ErrorLayout as _,
  ...
  warning as a8,
  error as a9,
  onBaseLangChanged as aA,
  onAdditionalLangAdded as aB,
  onAdditionalLangRemoved as aC,
  Button as aD,
  List as aE,
  resetSetup as aF,
  onAddComponentsVisibilityChange as aG,
  GetData as aH,
  surveyReceived as aI,
  designStateReceived as aJ,
  Container as aK,
  Stack as aL,
  Modal as aM,
  PROCESSED_ERRORS as aN,
  Close as aO,
  PREVIEW_MODE as aP,
  SurveyIcon as aQ,
  BG_COLOR as aR,
  shallowEqual$1 as aS,
  valueChange as aT,
  ...
  ownerWindow as aZ,
  debounce as a_,
  menuItemClasses as aa,
  dividerClasses as ab,
  drawerClasses as ac,
  svgIconClasses as ad,
  buttonClasses as ae,
  listClasses as af,
  SvgIcon as ag,
  paperClasses as ah,
  listItemIconClasses as ai,
  iconButtonClasses as aj,
  formControlClasses as ak,
  inputBaseClasses as al,
  outlinedInputClasses as am,
  filledInputClasses as an,
  typographyClasses as ao,
  rtlLanguage as ap,
  palette as aq,
  ThemeProvider as ar,
  CompactLayout as as,
  Image as at,
  setLangFromSession as au,
  cacheRtl as av,
  manageStore as aw,
  FormControl as ax,
  LANGUAGE_DEF as ay,
  ...
  useForkRef as b,
  warnOnce as b$,
  downloadFileAsBase64 as b0,
  previewUrl as b1,
  uploadDataUrl as b2,
  uploadFile as b3,
  useFormControl as b4,
  formControlState as b5,
  Input as b6,
  FilledInput as b7,
  OutlinedInput as b8,
  useDrag as b9,
  FRONT_END_HOST as bA,
  invariant as bB,
  createStore as bC,
  DndContext as bD,
  defaultTheme as bE,
  _inheritsLoose as bF,
  forceReflow as bG,
  FocusTrap as bH,
  TransitionGroup as bI,
  FormControlContext as bJ,
  createChainedFunction as bK,
  shallowEqual as bL,
  wrapConnectorHooks as bM,
  isRef as bN,
  useDragDropManager as bO,
  useIsomorphicLayoutEffect as bP,
  registerTarget as bQ,
  useOptionalFactory as bR,
  useCollectedProps as bS,
  ButtonGroupContext as bT,
  resolveProps as bU,
  InputBase as bV,
  getDividerUtilityClass as bW,
  Popover as bX,
  surveyAttributeChanged as bY,
  setSaving$1 as bZ,
  newVersionReceived as b_,
  orderChange as ba,
  getContrastColor as bb,
  fileTypesToMimesArray as bc,
  truncateWithEllipsis as bd,
  processApiError as be,
  getDirFromSession as bf,
  Transition as bg,
  reflow as bh,
  getTransitionProps as bi,
  getDrawerUtilityClass as bj,
  stripTags as bk,
  navigatePrevious as bl,
  navigateNext as bm,
  questionIconByType as bn,
  jump as bo,
  langChange as bp,
  isEquivalent as bq,
  setFetching as br,
  continueNavigation as bs,
  stateReceived as bt,
  loadScript as bu,
  defualtTheme as bv,
  startNavigation as bw,
  CLOUD_URL as bx,
  BACKEND_BASE_URL as by,
  PROTOCOL as bz,
  composeClasses as c,
  warn as c0,
  setRef$1 as c1,
  inputClasses as c2,
  ArrowDropDownIcon as c3,
  ButtonGroupButtonContext as c4,
  listItemTextClasses as c5,
  getListItemTextUtilityClass as c6,
  slotShouldForwardProp as c7,
  useCollector as c8,
  isGroup as c9,
  removeSkipDestination as cA,
  editSkipDestination as cB,
  editSkipToEnd as cC,
  instructionByCode as cD,
  updatePriorityByType as cE,
  updatePriority as cF,
  updateRandomByType as cG,
  updateRandom as cH,
  defaultSurveyTheme as cI,
  setupToggleExpand as cJ,
  NewComponentsPanel$1 as cK,
  setDesignModeToLang as cL,
  setDesignModeToTheme as cM,
  setDesignModeToReorder as cN,
  isQuestion as ca,
  setup as cb,
  setupOptions as cc,
  surveySetup as cd,
  ...
  removeAnswer as ci,
  onDrag as cj,
  changeResources as ck,
  contentEditable as cl,
  axios as cm,
  DESIGN_SURVEY_MODE as cn,
  hasMajorSetup as co,
  deleteQuestion as cp,
  cloneQuestion as cq,
  nextId as cr,
  addNewAnswer as cs,
  isDisplay as ct,
  deleteGroup as cu,
  changeAttribute as cv,
  changeValidationValue as cw,
  _slicedToArray as cx,
  connect as cy,
  changeRelevance as cz,
...
//# sourceMappingURL=use-service-Ce_K4Bne.js.map
