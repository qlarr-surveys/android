...
(function () {
  ...
  System.register(['./index-legacy-CoMmlwbr.js', './vendor-legacy-lhtLtiSI.js', './mui-legacy-b38CRKaY.js', './redux-legacy-ZqSxVvAn.js', './Android-legacy-Csf5qFR4.js', './i18n-legacy-BRT6G2_g.js', './editor-legacy-Dx3AxXyy.js', './dnd-legacy-DGW9B2he.js', './charts-legacy-BBm9rbLh.js'], function (exports, module) {
    'use strict';

    var jsx, jsxs, reactExports, Box, useTheme, css, useSelector, shallowEqual, useDispatch, buildResourceUrl, Content, setDirty, valueChange, rtlLanguage;
    return {
      setters: [module => {
        jsx = module.n;
        jsxs = module.o;
      ...
      execute: function execute() {
        ...
        __vite_style__.textContent = "._imageGrid_1ulv8_1 {\n  margin-top: 16px;\n}\n\n._imageContainer_1ulv8_5 {\n  background-size: cover;\n  background-position: center;\n  background-repeat: no-repeat;\n  position: relative;\n}\n\n._rankContainer_1ulv8_12 {\n  position: absolute;\n  top: 8px;\n  left: 8px;\n  cursor: pointer;\n  width: 32px;\n  height: 32px;\n  min-width: 32px;\n  min-height: 32px;\n  border-radius: 50%;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\n\n._rankValue_1ulv8_27 {\n  color: white;\n  font-weight: 600;\n  font-size: 16px;\n  line-height: 1;\n}\n\n._imageFlexContainer_1ulv8_34 {\n  display: flex;\n  flex-wrap: wrap;\n}/*$vite$:1*/";
        ...
        function ImageRanking(props) {
          ...
          return /* @__PURE__ */jsx(Box, {
            ...
            children: props.component.answers.map(option => {
              return /* @__PURE__ */jsx(ImageRankingItem, {
                option,
        ...
        function ImageRankingItem(props) {
          ...
          const backgroundImage = (_props$option$resourc = props.option.resources) !== null && _props$option$resourc !== void 0 && _props$option$resourc.image ? `url('${buildResourceUrl(props.option.resources.image)}')` : `url('/placeholder-image.jpg')`;
          return /* @__PURE__ */jsxs(Box, {
            ...
            children: [/* @__PURE__ */jsx(Box, {
              ...
              children: state.value > 0 && /* @__PURE__ */jsx("div", {
                style: {
                ...
                children: /* @__PURE__ */jsx("span", {
                  ...
                  css: /* @__PURE__ */css("{color:", theme.textStyles.text.color, ";}" + "", ""),
...
//# sourceMappingURL=ImageRanking-legacy-CuxydVCY.js.map
