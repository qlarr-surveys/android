;
(function () {
  System.register(['./index-legacy-DHZhPI7F.js', './use-service-legacy-Dvd5TXWp.js', './common-legacy-B-ynqPDp.js', './index-legacy-CBeFNk_C.js', './isTouchDevice-legacy-DpSdFl0J.js', './CardMedia-legacy-0wAW1jt0.js', './Card-legacy-C3ntY_pV.js', './Toolbar-legacy-Bj141DPD.js'], function (exports, module) {
    'use strict';

    var jsxRuntimeExports, useService, useSelector, useDispatch, previewUrl, uploadFile, valueChange, getFileFromPath, Box;
    return {
      setters: [module => {
...
//# sourceMappingURL=PhotoCapture-legacy-4wZr7k1x.js.map
