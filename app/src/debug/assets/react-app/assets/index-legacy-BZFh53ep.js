  ...
  System.register(['./index-legacy-DbBgSDRL.js', './Android-legacy-DTaKd7fz.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        __vitePreload = module.ay;
        getAugmentedNamespace = module.Q;
        commonjsGlobal = module.au;
        getDefaultExportFromCjs = module.e;
      }, module => {
        propTypesExports = module.U;
      }],
      execute: function execute() {
        ...
        var players_default = [{
          ...
          './FilePlayer-legacy-AyyH0fEF.js').then(n => n.F), false ? __VITE_PRELOAD__ : void 0))
        }];
        ...
        './Preview-legacy-DZr13_Kg.js').then(n => n.P), false ? __VITE_PRELOAD__ : void 0));
...
//# sourceMappingURL=index-legacy-BZFh53ep.js.map
