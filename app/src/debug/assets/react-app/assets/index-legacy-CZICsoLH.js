    ...
    return {
      execute: function execute() {
        ...
        if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
          try {
            __vitePreload(() => module.import('./browser-ponyfill-legacy-CBp0DRQz.js').then(n => n.b), false ? __VITE_PRELOAD__ : void 0).then(function (mod) {
        ...
        const Web = null;
        const Android = reactExports.lazy(() => __vitePreload(() => module.import('./Android-legacy-B5yqEvUd.js').then(n => n.au), false ? __VITE_PRELOAD__ : void 0));
        function App() {
...
//# sourceMappingURL=index-legacy-CZICsoLH.js.map
