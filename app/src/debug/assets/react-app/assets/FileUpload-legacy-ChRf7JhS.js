...
(function () {
  ...
  System.register(['./index-legacy-BxErIW5G.js', './vendor-legacy-HgAAkC3y.js', './Android-legacy-CFOeS1X5.js', './redux-legacy-N3F3Fg7Q.js', './i18n-legacy-QVJZeAmy.js', './mui-legacy-CrWa9ZRQ.js', './dnd-legacy-Cs5Ow6iI.js'], function (exports, module) {
    'use strict';

    var jsxs, jsx, LoadingDots, reactExports, React, useService, NAMESPACES, fileTypesToMimesArray, ValidationItem, previewUrlByFilename, valueChange, setDirty, uploadFile, useSelector, useDispatch, useTranslation, Button, Link, styled;
    return {
      setters: [module => {
        jsxs = module.o;
        jsx = module.n;
        ...
        useService = module.a;
        NAMESPACES = module.N;
        fileTypesToMimesArray = module.h;
        ValidationItem = module.i;
...
//# sourceMappingURL=FileUpload-legacy-ChRf7JhS.js.map
