...
(function () {
  ...
  System.register(['./index-legacy-DbBgSDRL.js', './Android-legacy-DTaKd7fz.js'], function (exports, module) {
    'use strict';

    var THEME_ID, _objectWithoutPropertiesLoose, React, _extends, reactExports, generateUtilityClass, generateUtilityClasses, extendSxProp, jsxRuntimeExports, clsx$1, resolveBreakpointValues, handleBreakpoints, capitalize, getDefaultExportFromCjs, commonjsGlobal, useTheme$1, jsx, Fragment, useThemeProps$1, defaultTheme, _inheritsLoose, forceReflow, Transition, useDefaultProps, useTheme, styled, composeClasses, useFormControl, FormControlContext, Typography, ButtonBase, createSvgIcon, useEnhancedEffect, debounce, ownerWindow, useRtl, useSlotProps, useEventCallback, ownerDocument, alpha, useControlled, Fade, TransitionGroup, useForkRef, IconButton, useId, Button, DialogActions, Grow, FocusTrap, Popper, Paper, Dialog, dialogClasses, DialogContent, useMediaQuery, useSelector, shallowEqual, useDispatch, TextField, valueChange;
    return {
      setters: [module => {
        THEME_ID = module.P;
        _objectWithoutPropertiesLoose = module.x;
        React = module.X;
        _extends = module.z;
        reactExports = module.r;
        generateUtilityClass = module.H;
        generateUtilityClasses = module.t;
        extendSxProp = module.o;
        jsxRuntimeExports = module.m;
        clsx$1 = module.F;
        resolveBreakpointValues = module.K;
        handleBreakpoints = module.J;
        capitalize = module.h;
        getDefaultExportFromCjs = module.e;
        commonjsGlobal = module.au;
        useTheme$1 = module.u;
        jsx = module.as;
        Fragment = module.aw;
      }, module => {
        ...
        useFormControl = module.e;
        FormControlContext = module.F;
        Typography = module.g;
        ButtonBase = module.B;
        createSvgIcon = module.h;
        useEnhancedEffect = module.i;
        debounce = module.j;
        ownerWindow = module.o;
        useRtl = module.k;
        useSlotProps = module.l;
        useEventCallback = module.m;
        ownerDocument = module.n;
        alpha = module.p;
        useControlled = module.q;
        Fade = module.r;
        TransitionGroup = module.t;
        useForkRef = module.v;
        IconButton = module.I;
        useId = module.w;
        Button = module.x;
        DialogActions = module.D;
        Grow = module.G;
        FocusTrap = module.y;
        Popper = module.P;
        Paper = module.z;
        Dialog = module.A;
        dialogClasses = module.C;
        DialogContent = module.E;
        useMediaQuery = module.H;
      ...
      execute: function execute() {
        ...
        function DayPicker(inProps) {
          ...
          const _reactExports$useStat13 = reactExports.useState(() => focusedDay || now),
            _reactExports$useStat14 = _slicedToArray(_reactExports$useStat13, 2),
            internalFocusedDay = _reactExports$useStat14[0],
            setInternalFocusedDay = _reactExports$useStat14[1];
          const changeHasFocus = reactExports.useCallback(newHasFocus => {
            if (onFocusedViewChange) {
              onFocusedViewChange(newHasFocus);
            }
        ...
        function useViews({
          ...
          const _useControlled3 = useControlled({
            ...
            openView = _useControlled4[0],
            setOpenView = _useControlled4[1];
        ...
        const YearPicker = /* @__PURE__ */reactExports.forwardRef(function YearPicker2(inProps, ref) {
          ...
          const _reactExports$useStat15 = reactExports.useState(() => currentYear || utils.getYear(now)),
            _reactExports$useStat16 = _slicedToArray(_reactExports$useStat15, 2),
            focusedYear = _reactExports$useStat16[0],
            setFocusedYear = _reactExports$useStat16[1];
        ...
        const useMaskedInput = ({
          ...
          const _reactExports$useStat17 = reactExports.useState(parsedValue),
            _reactExports$useStat18 = _slicedToArray(_reactExports$useStat17, 2),
            innerInputValue = _reactExports$useStat18[0],
            setInnerInputValue = _reactExports$useStat18[1]; // control the input text

          const _reactExports$useStat19 = reactExports.useState(getDisplayDate(utils, rawValue, inputFormat)),
            _reactExports$useStat20 = _slicedToArray(_reactExports$useStat19, 2),
            innerDisplayedInputValue = _reactExports$useStat20[0],
            setInnerDisplayedInputValue = _reactExports$useStat20[1]; // Inspired from autocomplete: https://github.com/mui/material-ui/blob/2c89d036dc2e16f100528f161600dffc83241768/packages/mui-base/src/AutocompleteUnstyled/useAutocomplete.js#L185:L201
        ...
        const useIsLandscape = (views, customOrientation) => {
          const _reactExports$useStat21 = reactExports.useState(getOrientation),
            _reactExports$useStat22 = _slicedToArray(_reactExports$useStat21, 2),
            orientation = _reactExports$useStat22[0],
            setOrientation = _reactExports$useStat22[1];
          useEnhancedEffect(() => {
            const eventHandler = () => {
        ...
        const useFocusManagement = ({
          ...
          const _reactExports$useStat23 = reactExports.useState(autoFocus ? openView : null),
            _reactExports$useStat24 = _slicedToArray(_reactExports$useStat23, 2),
            focusedView = _reactExports$useStat24[0],
            setFocusedView = _reactExports$useStat24[1];
        ...
        const useOpenState = ({
          ...
          const _reactExports$useStat25 = reactExports.useState(false),
            ...
            openState = _reactExports$useStat26[0],
            setIsOpenState = _reactExports$useStat26[1]; // It is required to update inner state in useEffect in order to avoid situation when
        ...
        const usePickerState = (props, valueManager) => {
          ...
          const _reactExports$useStat27 = reactExports.useState(parsedDateValue),
            _reactExports$useStat28 = _slicedToArray(_reactExports$useStat27, 2),
            lastValidDateValue = _reactExports$useStat28[0],
            setLastValidDateValue = _reactExports$useStat28[1];
          const _reactExports$useStat29 = reactExports.useState(() => ({
            ...
            dateState = _reactExports$useStat30[0],
            setDateState = _reactExports$useStat30[1];
          ...
          const _reactExports$useStat31 = reactExports.useState(false),
            ...
            isMobileKeyboardViewOpen = _reactExports$useStat32[0],
            setMobileKeyboardViewOpen = _reactExports$useStat32[1];
            ...
            children: /* @__PURE__ */jsx(LocalizationProvider, {
              ...
              children: props.component.type == "date_time" ? /* @__PURE__ */jsx(Fragment, {
                children: /* @__PURE__ */jsx(DateTimePicker, {
                  renderInput: props2 => /* @__PURE__ */jsx(TextField, _objectSpread({
                    size: "small",
                ...
                renderInput: params => /* @__PURE__ */jsx(TextField, _objectSpread({
                  size: "small",
                  onKeyDown: e => e.preventDefault()
                }, params)),
                margin: "normal",
...
//# sourceMappingURL=DateTimeQuestion-legacy-C6U4N2yh.js.map
