import { p as dayjs, n as jsx, F as Fragment } from "./index-Eqa58ok4.js";
import { d as commonjsGlobal, g as getDefaultExportFromCjs } from "./vendor-BxDgTFXe.js";
import { u as useSelector, s as shallowEqual, b as useDispatch } from "./redux-CLa1pDoQ.js";
import { N as NAMESPACES, v as valueChange } from "./Android-D_6dlUuh.js";
import { V as useTheme, W as LocalizationProvider, X as DateTimePicker, o as TextField, Y as TimePicker, Z as DatePicker } from "./mui-D3o-L0Jn.js";
...
function DateTimeQuestion(props) {
  ...
  const hintLabel = props.component.showHint && ((_a = props.component.content) == null ? void 0 : _a.hint) || defaultFormat;
  return /* @__PURE__ */ jsx("div", { className: styles.wrapper, children: /* @__PURE__ */ jsx(LocalizationProvider, { dateAdapter: AdapterDayjs, adapterLocale: i18n.language, children: props.component.type == "date_time" ? /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(DateTimePicker, { renderInput: (params) => /* @__PURE__ */ jsx(TextField, { ...params, size: "small", label: hintLabel, onKeyDown: (e) => e.preventDefault() }), margin: "normal", value: state.value, inputFormat: dateFormat + " " + (props.component.fullDayFormat ? "HH:mm" : "hh:mm A"), PaperProps: {
    sx: {
...
//# sourceMappingURL=DateTimeQuestion-EJaSI_Yp.js.map
