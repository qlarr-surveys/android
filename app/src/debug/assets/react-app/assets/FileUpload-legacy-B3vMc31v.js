...
(function () {
  ...
  System.register(['./index-legacy-BE0djssm.js', './Android-legacy-DcRmsPsH.js'], function (exports, module) {
    ...
    var generateUtilityClasses, generateUtilityClass, getPath, alpha_1, reactExports, _objectWithoutPropertiesLoose, _extends, jsxRuntimeExports, clsx, React, LoadingDots, useDefaultProps, useIsFocusVisible, useForkRef, styled, capitalize, composeClasses, Typography, useService, useTheme, useTranslation, fileTypesToMimesArray, useSelector, useDispatch, Button, ValidationItem, previewUrlByFilename, setDirty, uploadFile, valueChange;
    return {
      setters: [module => {
        ...
        clsx = module.D;
        React = module.Y;
        LoadingDots = module.a8;
      }, module => {
        useDefaultProps = module.a;
        useIsFocusVisible = module.ap;
        useForkRef = module.y;
        styled = module.s;
        capitalize = module.e;
        ...
        useService = module.$;
        useTheme = module.b;
        useTranslation = module.aa;
        fileTypesToMimesArray = module.aq;
        useSelector = module.E;
        useDispatch = module.J;
        Button = module.z;
        ValidationItem = module.ar;
        previewUrlByFilename = module.a1;
        setDirty = module.Q;
        uploadFile = module.a5;
        ...
        function FileUpload(props) {
          ...
          const onButtonClick = event => {
            if (window["Android"]) {
              ...
              window["Android"].selectFile(code, (accepted === null || accepted === void 0 ? void 0 : accepted.join(",")) || "", maxFileSize);
...
//# sourceMappingURL=FileUpload-legacy-B3vMc31v.js.map
