...
(function () {
  ...
  System.register(['./vendor-legacy-HgAAkC3y.js', './i18n-legacy-QVJZeAmy.js', './mui-legacy-CrWa9ZRQ.js'], function (exports, module) {
    'use strict';

    var reactExports, getAugmentedNamespace, commonjsGlobal, getDefaultExportFromCjs, __vitePreload, propTypesExports;
    return {
      setters: [module => {
      ...
      execute: function execute() {
        ...
        var players_default = [{
          ...
          './FilePlayer-legacy-DmJ7J48N.js').then(n => n.F), false ? __VITE_PRELOAD__ : void 0))
        }];
        ...
        './Preview-legacy-Dh_rYb8x.js').then(n => n.P), false ? __VITE_PRELOAD__ : void 0));
...
//# sourceMappingURL=player-legacy-D4XdQu3u.js.map
