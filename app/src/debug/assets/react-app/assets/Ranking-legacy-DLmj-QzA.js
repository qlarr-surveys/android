  ...
  System.register(['./index-legacy-BTM6HcrS.js', './Android-legacy-Cy_R2t8i.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        invariant = module.af;
        shallowEqual = module.ag;
        wrapConnectorHooks = module.ah;
        isRef = module.ai;
        useDragDropManager = module.aj;
        useIsomorphicLayoutEffect = module.ak;
        registerTarget = module.al;
        useOptionalFactory = module.am;
        useCollectedProps = module.an;
        useDispatch = module.M;
        useSelector = module.K;
        shallowEqual$1 = module.L;
        Box = module.a4;
        valueChange = module.O;
        orderChange = module.ao;
        useDrag = module.ap;
        Content = module.R;
      }],
...
//# sourceMappingURL=Ranking-legacy-DLmj-QzA.js.map
