import { h as capitalize, r as reactExports, b as _objectWithoutPropertiesLoose, _ as _extends, d as clsx, j as jsxRuntimeExports, q as interopRequireDefaultExports, B as Box, s as useNavigate, y as useTheme, A as LoadingDots } from "./index-X8N9IRh7.js";
import { f as styled, j as useDefaultProps, x as useSlotProps, c as composeClasses, e as createSvgIcon, K as requireCreateSvgIcon, I as IconButton, T as Typography, bc as truncateWithEllipsis, M as useTranslation, R as useService, U as useDispatch, aL as Stack, Z as setLoading, aN as PROCESSED_ERRORS, bd as processApiError, V as getDirFromSession, aK as Container, aD as Button, aX as Fade, J as TokenService } from "./use-service-CuBoVPEx.js";
import { u as usePreviousProps, d as default_1$3, a as default_1$5, D as DeleteModal } from "./Image-C57uL_fA.js";
import { s as serverDateTimeToLocalDateTime, l as localDateToServerDateTime } from "./DateUtils-D9XCaXee.js";
import { b as badgeClasses, g as getBadgeUtilityClass, C as CustomTooltip, E as Edit, S as SavingSurvey, a as Snackbar, A as Alert, i as isSurveyAdmin, d as default_1$4, c as default_1$6, e as RHFSelect, u as useForm, F as FormProvider, R as RHFTextField, f as FileUpload, h as SurveyClone, j as ROLES } from "./Web-D9a6B_N2.js";
import { d as dayjs } from "./dayjs.min-BKBOmHKb.js";
import { d as default_1$7 } from "./Delete-CegMG_AQ.js";
...
import { D as Divider } from "./Divider-senH77du.js";
import { c as create$3, a as create$6, o, L as LoadingButton } from "./yup-DuhXSTIa.js";
import { S as SURVEY_MODE } from "./survey-B8WvHOv0.js";
import { T as TablePagination } from "./TablePagination-CZw37hF_.js";
...
const EditableSurveyTitle = ({ survey, onSave, isEditable = true }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { className: styles$2.titleContainer, children: isEditing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    title.length > 20 ? /* @__PURE__ */ jsxRuntimeExports.jsx(CustomTooltip, { title, showIcon: false, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h4", sx: { px: 3 }, noWrap: true, children: truncateWithEllipsis(title, 18) }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "h4", sx: { px: 3 }, noWrap: true, children: truncateWithEllipsis(title, 18) }),
...
//# sourceMappingURL=index-BmtcMC9p.js.map
