...
(function () {
  ...
  System.register(['./index-legacy-ppEgxGbl.js', './yup-legacy-hoJlT6dt.js', './Web-legacy-fPm5GX2O.js', './use-service-legacy-BbL3A7cT.js', './use-boolean-legacy-DngmeOJL.js', './Link-legacy-CyFPht-Y.js', './index-legacy-DOLTvmJE.js', './InputAdornment-legacy-8aLN3GSj.js', './Checkbox-legacy-BOCzBChM.js', './SwitchBase-legacy-tIJzAgb-.js', './Tabs-legacy-CXNTfVGs.js', './radioClasses-legacy-Cc_gAbFN.js', './tableRowClasses-legacy-DKGRrcou.js', './TextField-legacy-Dle1a096.js', './FormControlLabel-legacy-BPCe018b.js'], function (exports, module) {
    'use strict';

    var reactExports, jsxRuntimeExports, Box, useNavigate, create$3, create$6, LoadingButton, o, addMethod, create$9, useForm, FormProvider, RHFCode, Iconify, RHFTextField, Snackbar, Alert, routes, useService, Modal, Stack, Image, Typography, Button, useSelector, useTranslation, TokenService, useDispatch, setLoading, PROCESSED_ERRORS, Container, IconButton, useBoolean, Link, SuccessSnackbar, InputAdornment;
    return {
      setters: [module => {
...
//# sourceMappingURL=index-legacy-CAObAXBZ.js.map
