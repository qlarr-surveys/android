  ...
  System.register([], function (exports, module) {
    ...
    return {
      execute: function execute() {
        ...
        exports({
          A: useTheme$1,
          B: formatMuiErrorMessage$1,
          D: clamp$1,
          F: clsx,
          G: GlobalStyles,
          H: generateUtilityClass,
          J: handleBreakpoints,
          K: resolveBreakpointValues,
          L: createUnarySpacing,
          M: mergeBreakpointsInOrder,
          N: getValue,
          O: createTheme,
          Q: getAugmentedNamespace,
          W: _setPrototypeOf,
          ...
          t: generateUtilityClasses,
          u: useTheme,
          v: createBox,
          x: _objectWithoutPropertiesLoose,
          y: styled,
          z: _extends$2
        });
        ...
        var commonjsGlobal = exports("au", typeof globalThis !== 'undefined' ? globalThis : typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : {});
        ...
        const React = exports("X", /*@__PURE__*/getDefaultExportFromCjs(reactExports));
        ...
        function delimit$1(type) {
          return trim$1(slice$2(position$1 - 1, delimiter$1(type === 91 ? type + 2 : type === 40 ? type + 1 : type)));
        }
        ...
        function escaping$1(index, count) {
          ...
          return slice$2(index, caret$1() + (count < 6 && peek$1() == 32 && next$1() == 32));
        }
        ...
        function commenter$1(type, index) {
          ...
          return '/*' + slice$2(index, position$1 - 1) + '*' + from$1(type === 47 ? type : next$1());
        }
        ...
        function identifier$1(index) {
          ...
          return slice$2(index, position$1);
        }
        ...
        var createCache = exports("ap", function createCache(options) {
          var key = options.key;
          if (key === 'css') {
        ...
        function _extends$2() {
          return exports("z", _extends$2 = Object.assign ? Object.assign.bind() : function (n) {
        ...
        var CacheProvider = exports("aB", EmotionCacheContext.Provider);
        ...
        var useTheme$2 = exports("ar", function useTheme() {
        ...
        var Fragment = exports("aw", jsxRuntimeExports.Fragment);
        var jsx$1 = exports("as", function jsx(type, props, key) {
          if (!hasOwn.call(props, 'css')) {
            return jsxRuntimeExports.jsx(type, props, key);
          }
          return jsxRuntimeExports.jsx(Emotion$1, createEmotionProps(type, props), key);
        });
        var jsxs = exports("at", function jsxs(type, props, key) {
          if (!hasOwn.call(props, 'css')) {
        ...
        var reactDomExports = exports("a3", reactDom.exports);
        const fo = exports("Y", /*@__PURE__*/getDefaultExportFromCjs(reactDomExports));
        var createRoot;
        ...
        const seen = {};
        const __vitePreload = exports("ay", function preload(baseModule, deps, importerUrl) {
        ...
        function _setPrototypeOf(t, e) {
          return exports("W", _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function (t, e) {
        ...
        if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
          try {
            __vitePreload(() => module.import('./browser-ponyfill-legacy-0DGdoeHz.js').then(n => n.b), false ? __VITE_PRELOAD__ : void 0).then(function (mod) {
        ...
        const THEME_ID = exports("P", '$$material');
        ...
        const internal_processStyles = exports("w", (tag, processor) => {
        ...
        var interopRequireDefaultExports = exports("V", interopRequireDefault.exports);
        ...
        var alpha_1 = exports("$", colorManipulator.alpha = alpha);
        colorManipulator.blend = blend;
        colorManipulator.colorChannel = void 0;
        var darken_1 = exports("a1", colorManipulator.darken = darken);
        colorManipulator.decomposeColor = decomposeColor;
        var emphasize_1 = exports("a5", colorManipulator.emphasize = emphasize);
        var getContrastRatio_1 = colorManipulator.getContrastRatio = getContrastRatio;
        colorManipulator.getLuminance = getLuminance;
        colorManipulator.hexToRgb = hexToRgb;
        colorManipulator.hslToRgb = hslToRgb;
        var lighten_1 = exports("a2", colorManipulator.lighten = lighten);
        ...
        const Box = exports("av", createBox({
          themeId: THEME_ID,
          defaultTheme,
        ...
        var MS = exports("a9", '-ms-');
        var MOZ = exports("ad", '-moz-');
        var WEBKIT = exports("aa", '-webkit-');
        var COMMENT = 'comm';
        var RULESET = exports("ag", 'rule');
        var DECLARATION = exports("al", 'decl');
        var MEDIA = '@media';
        var IMPORT = '@import';
        var SUPPORTS = '@supports';
        var KEYFRAMES = exports("ai", '@keyframes');
         ...
         * @return {object}
         */
        var assign = exports("an", Object.assign);
        ...
        const Web = null;
        const Android = reactExports.lazy(() => __vitePreload(() => module.import('./Android-legacy-BuzJjxPU.js').then(n => n.ao), false ? __VITE_PRELOAD__ : void 0));
        function App() {
          switch ("android-debuggable") {
            ...
            case "android":
              ...
              return /* @__PURE__ */jsx$1(I18nextProvider, {
                i18n: instance,
                children: /* @__PURE__ */jsx$1(reactExports.Suspense, {
                  fallback: /* @__PURE__ */jsx$1(LoadingDots, {
                    fullHeight: true
                  }),
                  children: /* @__PURE__ */jsx$1(Android, {})
                })
              });
            default:
              reactExports.useEffect(() => {
                instance.use(Backend).use(Browser).init({
                  ...
                  supportedLngs: ["en", "ar", "de", "es", "pt", "fr", "nl"],
                  load: "languageOnly"
                  // Optional: loads 'en' instead of 'en-US'
                });
              }, []);
              return /* @__PURE__ */jsx$1(I18nextProvider, {
                i18n: instance,
        ...
        root.render(/* @__PURE__ */jsx$1(BrowserRouter, {
...
//# sourceMappingURL=index-legacy-1AolfYmu.js.map
