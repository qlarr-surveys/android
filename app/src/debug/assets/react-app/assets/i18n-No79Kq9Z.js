const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-ponyfill-C5DXFp0P.js","assets/vendor-BxDgTFXe.js"])))=>i.map(i=>d[i]);
import { t as toPropertyKey, _ as _setPrototypeOf, a as _typeof$3, b as _assertThisInitialized } from "./mui-D3o-L0Jn.js";
...
var Logger = function() {
  ...
  _createClass$1(Logger2, [{
    ...
    value: function create(moduleName) {
      return new Logger2(this.logger, _objectSpread$3(_objectSpread$3({}, {
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    __vitePreload(() => import("./browser-ponyfill-C5DXFp0P.js").then((n) => n.b), true ? __vite__mapDeps([0,1]) : void 0).then(function(mod) {
...
export {
  ...
  _defineProperty$2 as _,
  __vitePreload as a,
  Browser as b,
  instance as i,
  useTranslation as u
};
//# sourceMappingURL=i18n-No79Kq9Z.js.map
