const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Android-B0bohYHY.js","assets/Android-BwbR7PYY.css"])))=>i.map(i=>d[i]);
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    __vitePreload(() => import("./browser-ponyfill-B_j1Zs-p.js").then((n2) => n2.b), true ? [] : void 0).then(function(mod) {
...
const Web = null;
const Android = reactExports.lazy(() => __vitePreload(() => import("./Android-B0bohYHY.js").then((n2) => n2.au), true ? __vite__mapDeps([0,1]) : void 0));
function App() {
...
//# sourceMappingURL=index-B0gHvSdN.js.map
