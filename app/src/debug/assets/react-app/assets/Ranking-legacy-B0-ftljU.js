...
(function () {
  ...
  System.register(['./index-legacy-BxErIW5G.js', './vendor-legacy-HgAAkC3y.js', './redux-legacy-N3F3Fg7Q.js', './Android-legacy-CFOeS1X5.js', './mui-legacy-CrWa9ZRQ.js', './dnd-legacy-Cs5Ow6iI.js', './i18n-legacy-QVJZeAmy.js'], function (exports, module) {
    'use strict';

    var jsxs, jsx, reactExports, useDispatch, useSelector, shallowEqual, valueChange, orderChange, Content, useTheme, Box, useDrop, useDrag;
    return {
      setters: [module => {
        jsxs = module.o;
        jsx = module.n;
...
//# sourceMappingURL=Ranking-legacy-B0-ftljU.js.map
