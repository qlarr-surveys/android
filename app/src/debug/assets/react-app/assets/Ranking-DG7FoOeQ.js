import { r as reactExports, a8 as useTheme, m as jsxRuntimeExports } from "./index-CDhdfxEQ.js";
import { af as invariant, ag as shallowEqual, ah as wrapConnectorHooks, ai as isRef, aj as useDragDropManager, ak as useIsomorphicLayoutEffect, al as registerTarget, am as useOptionalFactory, an as useCollectedProps, M as useDispatch, K as useSelector, L as shallowEqual$1, a4 as Box, O as valueChange, ao as orderChange, ap as useDrag, R as Content } from "./Android-BIErA7z6.js";
...
function Ranking(props) {
  ...
  const visibleAnswers = useSelector(
    (state2) => props.component.answers.filter((ans) => {
      var _a, _b;
    ...
    Box,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Content,
        {
          ...
          name: "label",
          lang,
          content: (_a = option.content) == null ? void 0 : _a.label
        }
      )
    }
  ) });
...
//# sourceMappingURL=Ranking-DG7FoOeQ.js.map
