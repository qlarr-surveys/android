(function () {
	...
	var stringSlice$d = uncurryThis$10(''.slice);
	...
	var toString$o = uncurryThis$Y(1.1.toString);
	...
	var ie8DomDefine = !DESCRIPTORS$y && !fails$O(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	var v8PrototypeDefineBug = DESCRIPTORS$w && fails$N(function () {
	  // eslint-disable-next-line es/no-object-defineproperty -- required for testing
	...
	var CONFIGURABLE_LENGTH = DESCRIPTORS$s && !fails$M(function () {
	...
	var isForced$4 = function (feature, detection) {
	  ...
	  return value === POLYFILL ? true
	    : value === NATIVE ? false
	    : isCallable$n(detection) ? fails$L(detection)
	    : !!detection;
	};
	...
	*/
	...
	if (DESCRIPTORS$r && isCallable$l(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  ...
	  var regexp = /^Symbol\((.*)\)[^)]+$/;
	  var replace$9 = uncurryThis$T(''.replace);
	...
	var functionUncurryThisAccessor = function (object, key, method) {
	  try {
	    // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
	    return uncurryThis$S(aCallable$m(Object.getOwnPropertyDescriptor(object, key)[method]));
	  } catch (error) { /* empty */ }
	};
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  $$1e({ global: true, constructor: true, arity: 1, forced: FORCED$g }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    $$1e({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$g }, O);
	  }
	};
	...
	var isConstructor$5 = !construct || fails$J(function () {
	  var called;
	...
	// `Array.from` method
	// https://tc39.es/ecma262/#sec-array.from
	$$1b({ target: 'Array', stat: true, forced: INCORRECT_ITERATION }, {
	  from: from
	});
	...
	// `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	$$1a({ target: 'Array', proto: true, forced: BROKEN_ON_SPARSE }, {
	...
	var NEW_ITERATOR_PROTOTYPE = !isObject$n(IteratorPrototype$4) || fails$D(function () {
	  var test = {};
	...
	var iteratorDefine = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (DEFAULT) {
	    ...
	    } else $$18({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS || INCORRECT_VALUES_NAME }, methods);
	  }
	...
	// https://tc39.es/ecma262/#sec-array.prototype.map
	// with adding support of @@species
	$$17({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$2 }, {
	...
	$$16({ target: 'Array', proto: true, arity: 1, forced: FORCED$d }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var createMethod$4 = function (IS_RIGHT) {
	  return function (that, callbackfn, argumentsLength, memo) {
	    ...
	    if (length === 0 && argumentsLength < 2) throw new $TypeError$l(REDUCE_EMPTY);
	    ...
	    if (argumentsLength < 2) while (true) {
	      ...
	      if (IS_RIGHT ? index < 0 : length <= index) {
	        throw new $TypeError$l(REDUCE_EMPTY);
	      }
	    }
	...
	var FORCED$c = CHROME_BUG || !arrayMethodIsStrict$3('reduce');

	// `Array.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-array.prototype.reduce
	$$15({ target: 'Array', proto: true, forced: FORCED$c }, {
	...
	var deletePropertyOrThrow$3 = function (O, P) {
	  if (!delete O[P]) throw new $TypeError$k('Cannot delete property ' + tryToString$3(P) + ' of ' + tryToString$3(O));
	};
	...
	var push$c = uncurryThis$K(test.push);
	...
	var FORCED$b = FAILS_ON_UNDEFINED || !FAILS_ON_NULL || !STRICT_METHOD$2 || !STABLE_SORT$1;
	...
	$$13({ target: 'Array', proto: true, forced: FORCED$b }, {
	...
	$$12({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	  splice: function splice(start, deleteCount /* , ...items */) {
	    ...
	    if (argumentsLength === 0) {
	      ...
	      actualDeleteCount = min$7(max$3(toIntegerOrInfinity$d(deleteCount), 0), len - actualStart);
	    }
	...
	var FORCED$a = INCORRECT_RESULT || !properErrorOnNonWritableLength();

	// `Array.prototype.unshift` method
	// https://tc39.es/ecma262/#sec-array.prototype.unshift
	$$11({ target: 'Array', proto: true, arity: 1, forced: FORCED$a }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$10({ global: true, forced: globalThis$O.globalThis !== globalThis$O }, {
	...
	var FORCED$9 = !isCallable$f(NativeIterator)
	...
	var IteratorConstructor = function Iterator() {
	  ...
	  if (getPrototypeOf$2(this) === IteratorPrototype$1) throw new $TypeError$i('Abstract class Iterator not directly constructable');
	};
	...
	if (FORCED$9 || !hasOwn$f(IteratorPrototype$1, CONSTRUCTOR) || IteratorPrototype$1[CONSTRUCTOR] === Object) {
	...
	$$$({ global: true, constructor: true, forced: FORCED$9 }, {
	...
	var iterate$f = function (iterable, unboundFunction, options) {
	  ...
	  if (IS_RECORD) {
	    ...
	    if (!iterFn) throw new $TypeError$h(tryToString$2(iterable) + ' is not iterable');
	...
	$$_({ target: 'Iterator', proto: true, real: true, forced: everyWithoutClosingOnEarlyError }, {
	  every: function every(predicate) {
	    ...
	    if (everyWithoutClosingOnEarlyError) return call$z(everyWithoutClosingOnEarlyError, this, predicate);
	  ...
	  return defineBuiltIns$5(create$5(IteratorPrototype), {
	    ...
	    'return': function () {
	      ...
	      if (IS_ITERATOR) {
	        ...
	        return returnMethod ? call$y(returnMethod, iterator) : createIterResultObject$4(undefined, true);
	      }
	      if (state.inner) try {
	...
	var FORCED$8 = FILTER_WITHOUT_THROWING_ON_INVALID_ITERATOR || filterWithoutClosingOnEarlyError;
	...
	var IteratorProxy$3 = createIteratorProxy$3(function () {
	  ...
	  while (true) {
	    result = anObject$n(call$x(next, iterator));
	...
	$$Z({ target: 'Iterator', proto: true, real: true, forced: FORCED$8 }, {
	  filter: function filter(predicate) {
	    ...
	    if (filterWithoutClosingOnEarlyError) return call$x(filterWithoutClosingOnEarlyError, this, predicate);
	...
	$$Y({ target: 'Iterator', proto: true, real: true, forced: findWithoutClosingOnEarlyError }, {
	...
	$$X({ target: 'Iterator', proto: true, real: true, forced: forEachWithoutClosingOnEarlyError }, {
	...
	var FORCED$7 = MAP_WITHOUT_THROWING_ON_INVALID_ITERATOR || mapWithoutClosingOnEarlyError;

	var IteratorProxy$2 = createIteratorProxy$2(function () {
	  var iterator = this.iterator;
	  var result = anObject$k(call$u(this.next, iterator));
	...
	var FAILS_ON_INITIAL_UNDEFINED = fails$z(function () {
	  // eslint-disable-next-line es/no-iterator-prototype-reduce, es/no-array-prototype-keys, array-callback-return -- required for testing
	  [].keys().reduce(function () { /* empty */ }, undefined);
	});

	var reduceWithoutClosingOnEarlyError = !FAILS_ON_INITIAL_UNDEFINED && iteratorHelperWithoutClosingOnEarlyError$3('reduce', $TypeError$g);

	// `Iterator.prototype.reduce` method
	// https://tc39.es/ecma262/#sec-iterator.prototype.reduce
	$$V({ target: 'Iterator', proto: true, real: true, forced: FAILS_ON_INITIAL_UNDEFINED || reduceWithoutClosingOnEarlyError }, {
	  reduce: function reduce(reducer /* , initialValue */) {
	    ...
	    if (noInitial) throw new $TypeError$g('Reduce of empty iterator with no initial value');
	    return accumulator;
	  }
	});
	...
	var WRONG_SYMBOLS_CONVERSION = !NATIVE_SYMBOL$1 || fails$x(function () {
	...
	var getReplacerFunction = function (replacer) {
	  ...
	  for (var i = 0; i < rawLength; i++) {
	    ...
	    else if (typeof element == 'number' || classof$d(element) === 'Number' || classof$d(element) === 'String') push$b(keys, toString$j(element));
	  }
	...
	if ($stringify) $$U({ target: 'JSON', stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE || !NATIVE_RAW_JSON }, {
	  stringify: function stringify(text, replacer, space) {
	    ...
	    var json = stringifyWithProperSymbolsConversion(text, function (key, value) {
	      // some old implementations (like WebKit) could pass numbers as keys
	      var v = isCallable$e(replacerFunction) ? call$t(replacerFunction, this, $String$1(key), value) : value;
	      return !NATIVE_RAW_JSON && isRawJSON(v) ? MARK + (push$b(rawStrings, v.rawJSON) - 1) : v;
	    }, space);
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var REPLACE = isForced$2(
	    CONSTRUCTOR_NAME,
	    !isCallable$d(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$t(function () {
	...
	$$R({ target: 'Object', stat: true, sham: !DESCRIPTORS$i }, {
	...
	var aConstructor$2 = function (argument) {
	  ...
	  throw new $TypeError$f(tryToString$1(argument) + ' is not a constructor');
	};
	...
	var speciesConstructor$3 = function (O, defaultConstructor) {
	  ...
	  var S;
	  return C === undefined || isNullOrUndefined$2(S = anObject$i(C)[SPECIES$2]) ? defaultConstructor : aConstructor$1(S);
	};
	...
	var onUnhandled = function (state) {
	  call$s(task, globalThis$E, function () {
	...
	var FLAGS_GETTER_IS_CORRECT = !fails$r(function () {
	...
	var regexpGetFlags = regExpFlagsDetection$1.correct ? function (it) {
	  ...
	  return (!regExpFlagsDetection$1.correct && isPrototypeOf$3(RegExpPrototype$4, it) && !hasOwn$b(it, 'flags'))
	    ? call$o(regExpFlagsGetterImplementation$1, it)
	    : it.flags;
	};
	...
	var exec$6 = uncurryThis$F(RegExpPrototype$3.exec);
	var charAt$9 = uncurryThis$F(''.charAt);
	var replace$6 = uncurryThis$F(''.replace);
	var stringIndexOf$4 = uncurryThis$F(''.indexOf);
	...
	if (isForced('RegExp', BASE_FORCED)) {
	  var RegExpWrapper = function RegExp(pattern, flags) {
	    ...
	    result = inheritIfRequired$3(NativeRegExp(pattern, flags), thisIsRegExp ? this : RegExpPrototype$3, RegExpWrapper);
	  ...
	  defineBuiltIn$7(globalThis$y, 'RegExp', RegExpWrapper, { constructor: true });
	}
	...
	if (DESCRIPTORS$f && UNSUPPORTED_DOT_ALL$1) {
	  defineBuiltInAccessor$9(RegExpPrototype$2, 'dotAll', {
	    configurable: true,
	    get: function dotAll() {
	...
	$$H({ target: 'RegExp', proto: true, forced: !DELEGATES_TO_EXEC }, {
	  test: function (S) {
	    ...
	    var exec = R.exec;
	    if (!isCallable$8(exec)) return call$m(nativeTest, R, string);
	    var result = call$m(exec, R, string);
	...
	SetRecord.prototype = {
	  getIterator: function () {
	    return getIteratorDirect$5(anObject$e(call$k(this.keys, this.set)));
	  },
	...
	var getSetRecord$7 = function (obj) {
	  ...
	  // eslint-disable-next-line no-self-compare -- NaN check
	  if (numSize !== numSize) throw new $TypeError$b(INVALID_SIZE);
	...
	var FORCED$6 = SET_LIKE_INCORRECT_BEHAVIOR || fails$m(function () {
	...
	var FORCED$5 = !setMethodAcceptSetLike$1('symmetricDifference') || !setMethodGetKeysBeforeCloning$1('symmetricDifference');

	// `Set.prototype.symmetricDifference` method
	// https://tc39.es/ecma262/#sec-set.prototype.symmetricdifference
	$$B({ target: 'Set', proto: true, real: true, forced: FORCED$5 }, {
	...
	var FORCED$4 = !setMethodAcceptSetLike('union') || !setMethodGetKeysBeforeCloning('union');

	// `Set.prototype.union` method
	// https://tc39.es/ecma262/#sec-set.prototype.union
	$$A({ target: 'Set', proto: true, real: true, forced: FORCED$4 }, {
	  union: union
	});
	...
	var slice$3 = uncurryThis$B(''.slice);
	var min$6 = Math.min;
	...
	var regexpExecAbstract = function (R, S) {
	  ...
	  if (classof$8(R) === 'RegExp') return call$i(regexpExec, R, S);
	...
	fixRegExpWellKnownSymbolLogic$3('match', function (MATCH, nativeMatch, maybeCallNative) {
	  return [
	    ...
	    function match(regexp) {
	      ...
	      return matcher ? call$h(matcher, regexp, O) : new RegExp(regexp)[MATCH](toString$c(O));
	    },
	  ...
	  return [
	    ...
	    function replace(searchValue, replaceValue) {
	      ...
	      return replacer
	        ...
	        : call$g(nativeReplace, toString$b(O), searchValue, replaceValue);
	    },
	    ...
	    function (string, replaceValue) {
	      ...
	      var flags = toString$b(getRegExpFlags$3(rx));
	      ...
	      for (var i = 0; i < results.length; i++) {
	        ...
	        var position = max$1(min$5(toIntegerOrInfinity$a(result.index), S.length), 0);
	        var captures = [];
	        var replacement;
	...
	fixRegExpWellKnownSymbolLogic$1('search', function (SEARCH, nativeSearch, maybeCallNative) {
	  return [
	    ...
	    function search(regexp) {
	      ...
	      return searcher ? call$f(searcher, regexp, O) : new RegExp(regexp)[SEARCH](toString$a(O));
	    },
	...
	fixRegExpWellKnownSymbolLogic('split', function (SPLIT, nativeSplit, maybeCallNative) {
	  ...
	  return [
	    ...
	    function split(separator, limit) {
	      ...
	      var splitter = isObject$b(separator) ? getMethod$2(separator, SPLIT) : undefined;
	      return splitter
	...
	$$x({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG && !CORRECT_IS_REGEXP_LOGIC }, {
	  startsWith: function startsWith(searchString /* , position = 0 */) {
	    ...
	    var index = toLength$4(min$3(arguments.length > 1 ? arguments[1] : undefined, that.length));
	...
	var splice$1 = uncurryThis$s([].splice);
	var id = 0;
	...
	var nativeSet = uncurryThis$r(WeakMapPrototype.set);
	...
	if (NATIVE_WEAK_MAP) if (IS_IE11) {
	  ...
	  var nativeDelete = uncurryThis$r(WeakMapPrototype['delete']);
	  var nativeHas = uncurryThis$r(WeakMapPrototype.has);
	  var nativeGet = uncurryThis$r(WeakMapPrototype.get);
	...
	var internalize = function (holder, name, reviver, node) {
	  ...
	  if (isObject$8(val)) {
	    ...
	    if (nodeIsArray) {
	      ...
	      len = lengthOfArrayLike$f(val);
	      for (i = 0; i < len; i++) {
	        internalizeProperty(val, i, internalize(val, '' + i, reviver, i < elementRecordsLen ? nodes[i] : undefined));
	      }
	    } else {
	      keys = enumerableOwnProperties(val);
	      len = lengthOfArrayLike$f(keys);
	      for (i = 0; i < len; i++) {
	        P = keys[i];
	...
	var NO_SOURCE_SUPPORT = fails$f(function () {
	  var unsafeInt = '9007199254740993';
	  var source;
	...
	var PROPER_BASE_PARSE = NATIVE_SYMBOL && !fails$f(function () {
	  // Safari 9 bug
	...
	$$t({ global: true, bind: true, enumerable: true, forced: globalThis$s.clearImmediate !== clearImmediate }, {
	...
	$$s({ global: true, bind: true, enumerable: true, forced: globalThis$q.setImmediate !== setImmediate }, {
	...
	var WRONG_ARITY = fails$e(function () {
	...
	$$r({ global: true, enumerable: true, dontCallGetSet: true, forced: WRONG_ARITY }, {
	...
	try {
	    ...
	    if (INCORRECT_VALUE || !descriptor || !descriptor.get || !descriptor.enumerable) {
	      defineBuiltInAccessor$7(globalThis$o, 'self', {
	        ...
	        set: function self(value) {
	          if (this !== globalThis$o) throw new $TypeError$8('Illegal invocation');
	  ...
	  } else $$q({ global: true, simple: true, forced: INCORRECT_VALUE }, {
	    self: globalThis$o
	  });
	} catch (error) { /* empty */ }
	...
	var exec$3 = uncurryThis$o(regexSeparators.exec);
	...
	var toLowerCase$1 = uncurryThis$o(''.toLowerCase);
	...
	$$p({ target: 'String', stat: true, arity: 1, forced: INCORRECT_LENGTH }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	var shift$1 = uncurryThis$m([].shift);
	...
	if (!USE_NATIVE_URL$1 && isCallable$3(Headers)) {
	  var headersHas = uncurryThis$m(HeadersPrototype.has);
	  var headersSet = uncurryThis$m(HeadersPrototype.set);
	...
	var numberToString$1 = uncurryThis$l(1.1.toString);
	var pop = uncurryThis$l([].pop);
	var push$5 = uncurryThis$l([].push);
	var replace = uncurryThis$l(''.replace);
	var shift = uncurryThis$l([].shift);
	var split = uncurryThis$l(''.split);
	var stringSlice$2 = uncurryThis$l(''.slice);
	var toLowerCase = uncurryThis$l(''.toLowerCase);
	var unshift = uncurryThis$l([].unshift);
	...
	$$n({ global: true, constructor: true, forced: !USE_NATIVE_URL, sham: !DESCRIPTORS$6 }, {
	  URL: URLConstructor
	});
	...
	var append = uncurryThis$k(URLSearchParamsPrototype$2.append);
	var $delete = uncurryThis$k(URLSearchParamsPrototype$2['delete']);
	var forEach$2 = uncurryThis$k(URLSearchParamsPrototype$2.forEach);
	...
	var getAll = uncurryThis$j(URLSearchParamsPrototype$1.getAll);
	var $has = uncurryThis$j(URLSearchParamsPrototype$1.has);
	...
	var forEach$1 = uncurryThis$i(URLSearchParamsPrototype.forEach);
