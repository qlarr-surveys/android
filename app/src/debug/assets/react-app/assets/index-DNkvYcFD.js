import { j as jsxRuntimeExports, R as React, r as reactExports, B as Box, q as interopRequireDefaultExports, y as useTheme } from "./index-Ceq5-OQz.js";
import { H as HelpOutline, c as classNames, A as Accordion, a as AccordionSummary, d as default_1$4, b as AccordionDetails } from "./index-ZwQp_h_g.js";
import { S as SurveyActiveFromTo } from "./index-sqGBf4sl.js";
import { i as isSurveyAdmin, e as RHFSelect, C as CustomTooltip, D as DialogTitle, v as default_1$3, t as RHFSwitch } from "./Web-B1oTo6QA.js";
import { a as SURVEY_STATUS, S as SURVEY_MODE } from "./survey-B8WvHOv0.js";
import { e as createSvgIcon, M as useTranslation, H as useSelector, U as useDispatch, T as Typography, I as IconButton, bY as surveyAttributeChanged, K as requireCreateSvgIcon, F as propTypesExports, aD as Button, aQ as SurveyIcon, R as useService, bZ as setSaving, b_ as newVersionReceived } from "./use-service-Ce_K4Bne.js";
import { l as localDateToServerDateTime } from "./DateUtils-D9XCaXee.js";
import { S as SuccessSnackbar } from "./index-Dp4_Dj-r.js";
import { s as sharingUrl } from "./common-BojVgIsY.js";
import { a as Dialog, b as DialogContent } from "./Tabs-BDHm_R_v.js";
import { T as TextField } from "./TextField-CR7hcx6T.js";
import "./index-C-Y4S3-p.js";
import "./dayjs.min-KP351193.js";
import "./DateTimePicker-WPN0yHXi.js";
...
function EditSurveyGeneral() {
  ...
  const [surveyMode, setSurveyMode] = reactExports.useState("");
  const [surveyDateError, setSurveyDateError] = reactExports.useState("");
  reactExports.useEffect(() => {
    const newSurveyMode = (survey == null ? void 0 : survey.usage) || "";
    setSurveyMode(newSurveyMode);
  }, [survey]);
  const dispatch = useDispatch();
  const isDisabled = !isSurveyAdmin() || (survey == null ? void 0 : survey.status) == SURVEY_STATUS.CLOSED;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.generalContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      RHFSelect,
      {
        ...
        children: surveyMode_options.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option.value, children: t(option.label) }, option.value))
      }
    ),
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            CustomTooltip,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconButton, { size: "small", "aria-label": "help", style: { marginLeft: 4 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(HelpOutline, { fontSize: "small" }) })
            }
          )
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { className: styles$3.blockItem, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      SurveyActiveFromTo,
      {
        error: surveyDateError,
        disabled: isDisabled,
        surveyActiveFrom: survey == null ? void 0 : survey.startDate,
        surveyActiveTo: survey == null ? void 0 : survey.endDate,
...
function createShareButton(networkName, link, optsMap, defaultProps) {
  function CreatedButton(props, ref) {
    ...
    return React.createElement(ShareButton, __assign({}, defaultProps, passedProps, { forwardedRef: ref, networkName, networkLink: link, opts: optsMap(props) }));
  }
...
function SurveySharing() {
  ...
  const { t } = useTranslation("manage");
  const survey = useSelector((state) => state.editState.survey);
  const url = sharingUrl(survey == null ? void 0 : survey.id);
  const [isQRDialogOpen, setQRDialogOpen] = reactExports.useState(false);
  ...
  const downloadQRCode = () => {
    ...
    image.onload = () => {
      ...
      a.download = "".concat(survey == null ? void 0 : survey.name, "_QRCode.png");
  ...
  const mailSurveyLink = "mailto:?subject=Survey Link&body=Please complete this survey: ".concat(encodeURIComponent(
    url
  ));
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles$2.mainContainer, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { className: styles$2.defaultUrl, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { className: styles$2.urlLink, href: url, children: [
        url.slice(0, 50),
        "...",
        url.slice(-10)
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles$2.buttonContainer, display: "flex", gap: 2, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            fullWidth: true,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SurveyIcon, { name: "qrCode" }),
              t("launch.qr_code")
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { fullWidth: true, className: styles$2.actionButton, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SurveyIcon, { name: "email" }),
              t("launch.email_link")
            ] })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            ...
            onClick: clickCopy,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SurveyIcon, { name: "duplicate", color: "#fff" }),
              t("launch.copy_link")
            ]
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { className: styles$2.socialSharing, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles$2.socialLink, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(FacebookShareButton, { url, children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$2, { className: styles$2.iconShareFb }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TwitterShareButton, { url, children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1, { className: styles$2.iconShareTw }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LinkedinShareButton, { url, children: /* @__PURE__ */ jsxRuntimeExports.jsx(default_1$1, { className: styles$2.iconShareLn }) })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Dialog,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { sx: { m: 0, p: 2 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            IconButton,
            {
              "aria-label": "close",
              onClick: toggleQRDialog,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { dividers: true, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: qrRef, children: /* @__PURE__ */ jsxRuntimeExports.jsx(_default, { value: url, size: 256 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                fullWidth: true,
...
function LaunchPage({ onPublish }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles$1.box, children: [
    !published && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Box,
      {
        display: "flex",
        alignItems: "center",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { variant: "subtitle1", children: t("launch.publish_text") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            CustomTooltip,
            {
              showIcon: false,
              title: !hasFatalErrors ? "".concat(t("launch.publish_tooltip")) : "".concat(t("launch.publish_error")),
              placement: "top",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Button,
                {
                  fullWidth: true,
                  variant: "contained",
...
function SurveyQuota() {
  ...
  const { t } = useTranslation("manage");
  const survey = useSelector((state) => state.editState.survey);
  const [checked, setChecked] = reactExports.useState((survey == null ? void 0 : survey.quota) > 0);
  const [limit, setLimit] = reactExports.useState((survey == null ? void 0 : survey.quota) >= 0 ? survey.quota : "");
  ...
  const isDisabled = !isSurveyAdmin() || (survey == null ? void 0 : survey.status) == SURVEY_STATUS.CLOSED;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Box, { className: styles.mainContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles.boxContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles.flexContainer, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { color: "#1a2052", fontWeight: "500", children: t("label.apply_quota") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        TextField,
        {
          variant: "standard",
...
function ExportSurvey() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outlined", component: "label", onClick, children: [
    t("edit_survey.export"),
    /* @__PURE__ */ jsxRuntimeExports.jsx(FileDownload, {})
  ] });
}
...
function EditSurvey({ onPublish }) {
  ...
  return survey && /* @__PURE__ */ jsxRuntimeExports.jsxs(Box, { className: styles$4.mainContainer, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Accordion, { className: styles$4.accordionContainer, defaultExpanded: true, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        AccordionSummary,
        {
          ...
          id: "panel1a-header",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Typography, { fontWeight: "600", color: "#1a2052", variant: "h5", children: t("edit_survey.launch") })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionDetails, { className: styles$4.accordionDetails, children: /* @__PURE__ */ jsxRuntimeExports.jsx(LaunchPage, { onPublish }) })
    ] }),
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Accordion,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionDetails, { className: styles$4.accordionDetails, children: section.component })
          ]
        },
        section.id
      );
...
//# sourceMappingURL=index-DNkvYcFD.js.map
