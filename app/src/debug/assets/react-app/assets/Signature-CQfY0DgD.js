import { Q as getAugmentedNamespace, au as commonjsGlobal, e as getDefaultExportFromCjs, r as reactExports, at as jsxs, as as jsx, aw as Fragment } from "./index-CM5T10V1.js";
import { U as propTypesExports, W as useService, X as useTranslation, Y as NAMESPACES, J as useSelector, L as useDispatch, Z as downloadFileAsBase64, $ as previewUrlByFilename, a0 as Box, x as Button, a1 as uploadDataUrl, N as valueChange } from "./Android-BBYOUnem.js";
var build$1 = { exports: {} };
/*!
...
function Signature(props) {
  ...
  const clear = () => {
    var _a;
    (_a = sigCanvas.current) == null ? void 0 : _a.clear();
    setSignature(void 0);
  ...
  const submit = () => {
    ...
    uploadDataUrl(runService, props.component.qualifiedCode, preview, dataUrl, "signature.png").then((response) => {
  ...
  reactExports.useEffect(() => {
    if (state && state.stored_filename) {
      ...
      downloadFileAsBase64(previewUrlByFilename(state.stored_filename)).then((response) => {
        setSubmitEnabled(false);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    }, className: styles.container, children: /* @__PURE__ */ jsx(Box, { ref: containerRef, sx: {
      maxWidth: Math.min(canvasWidth, 400) + "px"
    }, className: styles.signatureCanvas, children: signature ? /* @__PURE__ */ jsx("img", { src: signature, style: {
      width: Math.min(canvasWidth, 400) + "px",
      height: "200px"
    } }) : /* @__PURE__ */ jsx(SignatureCanvas, { penColor: "red", clearOnResize: true, onBegin: () => {
      setSubmitEnabled(true);
      setClearEnabled(true);
    }, ref: sigCanvas, canvasProps: {
      width: Math.min(canvasWidth, 400),
      height: 200
    } }) }) }),
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsxs("div", { className: styles.buttonContainer, children: [
      /* @__PURE__ */ jsx(Button, { onClick: () => clear(), disabled: !clearEnabled, children: t("clear") }),
      /* @__PURE__ */ jsx(Button, { onClick: () => submit(), disabled: !submitEnabled, children: t("submit") })
    ] })
  ] });
}
export {
...
//# sourceMappingURL=Signature-CQfY0DgD.js.map
