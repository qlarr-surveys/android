  ...
  System.register(['./index-legacy-DHZhPI7F.js', './use-service-legacy-Dvd5TXWp.js'], function (exports, module) {
    ...
    return {
      setters: [module => {
        ...
        Select = module.S;
        Input = module.b6;
        FilledInput = module.b7;
        OutlinedInput = module.b8;
      }],
      execute: function execute() {
        ...
        const FormHelperText = exports("a", /* @__PURE__ */reactExports.forwardRef(function FormHelperText2(inProps, ref) {
        ...
        const FormLabel = exports("F", /* @__PURE__ */reactExports.forwardRef(function FormLabel2(inProps, ref) {
          const props = useDefaultProps({
            props: inProps,
            name: "MuiFormLabel"
          });
        ...
        const inputLabelClasses = exports("i", generateUtilityClasses('MuiInputLabel', ['root', 'focused', 'disabled', 'error', 'required', 'asterisk', 'formControl', 'sizeSmall', 'shrink', 'animated', 'standard', 'filled', 'outlined']));
        ...
        const InputLabel = exports("I", /* @__PURE__ */reactExports.forwardRef(function InputLabel2(inProps, ref) {
          const props = useDefaultProps({
            name: "MuiInputLabel",
            props: inProps
          });
...
//# sourceMappingURL=TextField-legacy-C04XnsWd.js.map
