const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Android-CSEUy22g.js","assets/Android-BDBi0ToP.css"])))=>i.map(i=>d[i]);
...
const co = /* @__PURE__ */ getDefaultExportFromCjs(reactDomExports);
var createRoot;
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    __vitePreload(() => import("./browser-ponyfill-hNMFK4fk.js").then((n2) => n2.b), true ? [] : void 0).then(function(mod) {
...
function deepClone$1(source) {
  ...
  Object.keys(source).forEach((key) => {
    output2[key] = deepClone$1(source[key]);
  });
  return output2;
}
  ...
  if (isPlainObject$1(target) && isPlainObject$1(source)) {
    Object.keys(source).forEach((key) => {
      ...
      Object.prototype.hasOwnProperty.call(target, key) && isPlainObject$1(target[key])) {
        ...
        output2[key] = isPlainObject$1(source[key]) ? deepClone$1(source[key]) : source[key];
      } else {
        output2[key] = source[key];
      }
    });
...
function createPalette(palette) {
  ...
  const augmentColor = ({
    ...
    if (!color2.hasOwnProperty("main")) {
      throw new Error(formatMuiErrorMessage$2(11, name ? " (".concat(name, ")") : "", mainShade));
    }
    if (typeof color2.main !== "string") {
      throw new Error(formatMuiErrorMessage$2(12, name ? " (".concat(name, ")") : "", JSON.stringify(color2.main)));
    }
...
const Web = null;
const Android = reactExports.lazy(() => __vitePreload(() => import("./Android-CSEUy22g.js").then((n2) => n2.as), true ? __vite__mapDeps([0,1]) : void 0));
function App() {
...
unregister();
export {
  _assertThisInitialized as $,
  formatMuiErrorMessage$1 as A,
  clamp$1 as B,
  React$1 as C,
  clsx as D,
  handleBreakpoints as E,
  resolveBreakpointValues as F,
  GlobalStyles as G,
  createUnarySpacing as H,
  I18nContext as I,
...
//# sourceMappingURL=index-DAqwKGVD.js.map
