  ...
  System.register(['./vendor-legacy-HgAAkC3y.js', './player-legacy-D4XdQu3u.js'], function (exports, module) {
    ...
    return {
      ...
      execute: function execute() {
          ...
          load(url) {
            ...
            (0, import_utils.getSDK)(SDK_URL, SDK_GLOBAL).then(Vimeo2 => {
              ...
              const _this$props$config = this.props.config,
                playerOptions = _this$props$config.playerOptions,
                title = _this$props$config.title;
              this.player = new Vimeo2.Player(this.container, _objectSpread({
                url: cleanUrl(url),
        ...
        const Vimeo_default = /*@__PURE__*/getDefaultExportFromCjs(Vimeo_1);
        const Vimeo$1 = /*#__PURE__*/_mergeNamespaces({
          __proto__: null,
...
//# sourceMappingURL=Vimeo-legacy-BNr8Nwqu.js.map
