(function () {
	...
	var getterFor = function (TYPE) {
	  return function (it) {
	    var state;
	    if (!isObject$u(it) || (state = get$1(it)).type !== TYPE) {
	...
	*/
	...
	if (DESCRIPTORS$r && isCallable$l(NativeSymbol) && (!('description' in SymbolPrototype) ||
	  ...
	  $$1d({ global: true, constructor: true, forced: true }, {
	...
	var exportGlobalErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  ...
	  $$1c({ global: true, constructor: true, arity: 1, forced: FORCED$f }, O);
	};
	...
	var exportWebAssemblyErrorCauseWrapper = function (ERROR_NAME, wrapper) {
	  if (WebAssembly && WebAssembly[ERROR_NAME]) {
	    ...
	    $$1c({ target: WEB_ASSEMBLY, stat: true, constructor: true, arity: 1, forced: FORCED$f }, O);
	  }
	};
	...
	$$1b({ target: 'Array', proto: true, arity: 1, forced: FORCED$e }, {
	...
	var getIterator$4 = function (argument, usingIterator) {
	  ...
	  if (aCallable$k(iteratorMethod)) return anObject$t(call$D(iteratorMethod, argument));
	  throw new $TypeError$n(tryToString$4(argument) + ' is not iterable');
	};
	...
	// `Array.prototype.includes` method
	// https://tc39.es/ecma262/#sec-array.prototype.includes
	$$18({ target: 'Array', proto: true, forced: BROKEN_ON_SPARSE }, {
	...
	// `Array.prototype.indexOf` method
	// https://tc39.es/ecma262/#sec-array.prototype.indexof
	$$17({ target: 'Array', proto: true, forced: FORCED$d }, {
	...
	var iteratorDefine = function (Iterable, NAME, IteratorConstructor, next, DEFAULT, IS_SET, FORCED) {
	  ...
	  if (DEFAULT) {
	    ...
	    } else $$16({ target: NAME, proto: true, forced: BUGGY_SAFARI_ITERATORS || INCORRECT_VALUES_NAME }, methods);
	  }
	...
	$$14({ target: 'Array', proto: true, arity: 1, forced: FORCED$c }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$13({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$1 }, {
	...
	// with adding support of @@species
	$$12({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT }, {
	...
	$$11({ target: 'Array', proto: true, arity: 1, forced: FORCED$b }, {
	  // eslint-disable-next-line no-unused-vars -- required for `.length`
	...
	$$10({ global: true, forced: globalThis$P.globalThis !== globalThis$P }, {
	...
	var FORCED$a = !isCallable$f(NativeIterator)
	...
	if (FORCED$a || !hasOwn$f(IteratorPrototype$1, CONSTRUCTOR) || IteratorPrototype$1[CONSTRUCTOR] === Object) {
	...
	$$$({ global: true, constructor: true, forced: FORCED$a }, {
	...
	var FORCED$9 = FILTER_WITHOUT_THROWING_ON_INVALID_ITERATOR || filterWithoutClosingOnEarlyError;
	...
	$$_({ target: 'Iterator', proto: true, real: true, forced: FORCED$9 }, {
	...
	$$Z({ target: 'Iterator', proto: true, real: true, forced: forEachWithoutClosingOnEarlyError }, {
	...
	$$Y({ target: 'Iterator', proto: true, real: true, forced: FORCED$8 }, {
	...
	var nativeRawJson = !fails$z(function () {
	...
	var slice$4 = uncurryThis$I(''.slice);
	...
	var WRONG_SYMBOLS_CONVERSION = !NATIVE_SYMBOL$1 || fails$y(function () {
	...
	var ILL_FORMED_UNICODE = fails$y(function () {
	  return $stringify('\uDF06\uD834') !== '"\\udf06\\ud834"'
	    || $stringify('\uDEAD') !== '"\\udead"';
	});
	...
	var stringifyWithProperSymbolsConversion = WRONG_SYMBOLS_CONVERSION ? function (it, replacer) {
	  ...
	  args[1] = function (key, value) {
	    ...
	    if (isCallable$e($replacer)) value = call$v($replacer, this, $String$1(key), value);
	...
	var fixIllFormedJSON = function (match, offset, string) {
	  ...
	  if ((exec$7(lowSurrogates, match) && !exec$7(hiSurrogates, next)) || (exec$7(hiSurrogates, match) && !exec$7(lowSurrogates, prev))) {
	...
	var getReplacerFunction = function (replacer) {
	  ...
	  for (var i = 0; i < rawLength; i++) {
	    ...
	    else if (typeof element == 'number' || classof$e(element) === 'Number' || classof$e(element) === 'String') push$c(keys, toString$j(element));
	  }
	...
	if ($stringify) $$X({ target: 'JSON', stat: true, arity: 3, forced: WRONG_SYMBOLS_CONVERSION || ILL_FORMED_UNICODE || !NATIVE_RAW_JSON }, {
	  stringify: function stringify(text, replacer, space) {
	    ...
	    var json = stringifyWithProperSymbolsConversion(text, function (key, value) {
	      // some old implementations (like WebKit) could pass numbers as keys
	      var v = isCallable$e(replacerFunction) ? call$v(replacerFunction, this, $String$1(key), value) : value;
	      return !NATIVE_RAW_JSON && isRawJSON(v) ? MARK + (push$c(rawStrings, v.rawJSON) - 1) : v;
	    }, space);
	    ...
	    for (var i = 0; i < length; i++) {
	      ...
	      if (chr === '"') {
	        ...
	        var string = slice$4(json, i, end);
	        result += slice$4(string, 0, MARK_LENGTH) === MARK
	          ? rawStrings[slice$4(string, MARK_LENGTH)]
	          : '"' + string + '"';
	        i = end;
	      } else result += chr;
	    }
	...
	var FAILS_ON_PRIMITIVES = fails$w(function () { $isExtensible(1); });
	...
	var collection$4 = function (CONSTRUCTOR_NAME, wrapper, common) {
	  ...
	  var REPLACE = isForced$2(
	    CONSTRUCTOR_NAME,
	    !isCallable$d(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$u(function () {
	...
	var environment = (function () {
	  ...
	  if (classof$b(globalThis$L.process) === 'process') return 'NODE';
	...
	var safeGetBuiltIn$2 = function (name) {
	  if (!DESCRIPTORS$i) return globalThis$I[name];
	...
	var isThenable = function (it) {
	  var then;
	  return isObject$h(it) && isCallable$a(then = it.then) ? then : false;
	};
	...
	var onUnhandled = function (state) {
	  call$u(task, globalThis$E, function () {
	...
	$$T({ target: 'Promise', stat: true, forced: PROMISE_STATICS_INCORRECT_ITERATION$2 }, {
	...
	var $RegExp$2 = globalThis$C.RegExp;
	...
	var $RegExp = globalThis$A.RegExp;
	...
	$$N({ target: 'RegExp', proto: true, forced: /./.exec !== exec$6 }, {
	  exec: exec$6
	});
	...
	// https://tc39.es/ecma262/#sec-get-regexp.prototype.flags
	if (DESCRIPTORS$h && !regExpFlagsDetection$1.correct) {
	...
	$$M({ target: 'RegExp', proto: true, forced: !DELEGATES_TO_EXEC }, {
	  test: function (S) {
	    var R = anObject$i(this);
	    var string = toString$h(S);
	    var exec = R.exec;
	    if (!isCallable$8(exec)) return call$q(nativeTest, R, string);
	    var result = call$q(exec, R, string);
	...
	var forEach$4 = uncurryThis$D(SetPrototype.forEach);
	var keys$1 = uncurryThis$D(SetPrototype.keys);
	...
	SetRecord.prototype = {
	  getIterator: function () {
	    return getIteratorDirect$8(anObject$h(call$o(this.keys, this.set)));
	  },
	  includes: function (it) {
	    return call$o(this.has, this.set, it);
	  }
	};
	...
	var FORCED$7 = SET_LIKE_INCORRECT_BEHAVIOR || fails$o(function () {
	...
	// `Set.prototype.intersection` method
	// https://tc39.es/ecma262/#sec-set.prototype.intersection
	$$K({ target: 'Set', proto: true, real: true, forced: INCORRECT$3 }, {
	...
	// `Set.prototype.isDisjointFrom` method
	// https://tc39.es/ecma262/#sec-set.prototype.isdisjointfrom
	$$J({ target: 'Set', proto: true, real: true, forced: INCORRECT$2 }, {
	...
	// `Set.prototype.isSubsetOf` method
	// https://tc39.es/ecma262/#sec-set.prototype.issubsetof
	$$I({ target: 'Set', proto: true, real: true, forced: INCORRECT$1 }, {
	...
	// `Set.prototype.union` method
	// https://tc39.es/ecma262/#sec-set.prototype.union
	$$F({ target: 'Set', proto: true, real: true, forced: FORCED$5 }, {
	  union: union
	});
	...
	var slice$3 = uncurryThis$C(''.slice);
	var min$6 = Math.min;
	...
	$$E({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG$1 && !CORRECT_IS_REGEXP_LOGIC$1 }, {
	  endsWith: function endsWith(searchString /* , endPosition = @length */) {
	    var that = toString$g(requireObjectCoercible$a(this));
	...
	var regexpGetFlags = regExpFlagsDetection.correct ? function (it) {
	  ...
	  return (!regExpFlagsDetection.correct && isPrototypeOf$3(RegExpPrototype$3, it) && !hasOwn$b(it, 'flags'))
	    ? call$m(regExpFlagsGetterImplementation, it)
	    : it.flags;
	};
	...
	var regexpExecAbstract = function (R, S) {
	  ...
	  if (classof$9(R) === 'RegExp') return call$l(regexpExec, R, S);
	...
	fixRegExpWellKnownSymbolLogic$3('match', function (MATCH, nativeMatch, maybeCallNative) {
	  return [
	    ...
	    function match(regexp) {
	      ...
	      var matcher = isObject$e(regexp) ? getMethod$5(regexp, MATCH) : undefined;
	    ...
	    function (string) {
	      ...
	      var flags = toString$d(getRegExpFlags$5(rx));
	...
	fixRegExpWellKnownSymbolLogic$2('replace', function (_, nativeReplace, maybeCallNative) {
	  ...
	  return [
	    ...
	    function replace(searchValue, replaceValue) {
	      ...
	      var replacer = isObject$d(searchValue) ? getMethod$4(searchValue, REPLACE$1) : undefined;
	      return replacer
	    ...
	    function (string, replaceValue) {
	      ...
	      var flags = toString$c(getRegExpFlags$4(rx));
	...
	fixRegExpWellKnownSymbolLogic$1('search', function (SEARCH, nativeSearch, maybeCallNative) {
	  return [
	    ...
	    function search(regexp) {
	      ...
	      var searcher = isObject$c(regexp) ? getMethod$3(regexp, SEARCH) : undefined;
	...
	var splice$1 = uncurryThis$u([].splice);
	var id = 0;
	...
	var IS_IE11 = !globalThis$y.ActiveXObject && 'ActiveXObject' in globalThis$y;
	var InternalWeakMap;
	...
	var nativeSet = uncurryThis$t(WeakMapPrototype.set);
	...
	if (NATIVE_WEAK_MAP) if (IS_IE11) {
	  ...
	  var nativeDelete = uncurryThis$t(WeakMapPrototype['delete']);
	  var nativeHas = uncurryThis$t(WeakMapPrototype.has);
	  var nativeGet = uncurryThis$t(WeakMapPrototype.get);
	...
	var JSON$1 = globalThis$x.JSON;
	var Number$1 = globalThis$x.Number;
	...
	var internalize = function (holder, name, reviver, node) {
	  ...
	  return call$h(reviver, holder, name, val, context);
	};
	...
	Context.prototype = {
	  ...
	  parse: function () {
	    ...
	    if (exec$5(IS_NUMBER_START, chr)) return fork.number();
	    switch (chr) {
	      case '{':
	        return fork.object();
	      case '[':
	  ...
	  number: function () {
	    ...
	    else if (exec$5(IS_NON_ZERO_DIGIT, at$1(source, i))) i = this.skip(IS_DIGIT, i + 1);
	  ...
	  keyword: function (value) {
	    ...
	    if (slice$2(this.source, index, endIndex) !== keyword) throw new SyntaxError$4('Failed to parse value at: ' + index);
	    return this.node(PRIMITIVE, value, index, endIndex);
	  },
	  skip: function (regex, i) {
	    var source = this.source;
	    for (; i < source.length; i++) if (!exec$5(regex, at$1(source, i))) break;
	    return i;
	  },
	...
	var NO_SOURCE_SUPPORT = fails$i(function () {
	  var unsafeInt = '9007199254740993';
	  var source;
	...
	var PROPER_BASE_PARSE = NATIVE_SYMBOL && !fails$i(function () {
	  // Safari 9 bug
	...
	// https://github.com/tc39/proposal-json-parse-with-source
	$$A({ target: 'JSON', stat: true, forced: NO_SOURCE_SUPPORT }, {
	...
	var exec$4 = uncurryThis$q(regexSeparators.exec);
	var floor$4 = Math.floor;
	var fromCharCode$2 = String.fromCharCode;
	var charCodeAt = uncurryThis$q(''.charCodeAt);
	...
	var encode = function (input) {
	  ...
	  for (i = 0; i < input.length; i++) {
	    ...
	    if (currentValue < 0x80) {
	      push$9(output, fromCharCode$2(currentValue));
	    }
	  }
	    ...
	    for (i = 0; i < input.length; i++) {
	      ...
	      if (currentValue === n) {
	        ...
	        while (true) {
	          ...
	          push$9(output, fromCharCode$2(digitToBasic(t + qMinusT % baseMinusT)));
	          q = floor$4(qMinusT / baseMinusT);
	          k += base;
	        }

	        push$9(output, fromCharCode$2(digitToBasic(q)));
	...
	var stringPunycodeToAscii = function (input) {
	  ...
	  for (i = 0; i < labels.length; i++) {
	    label = labels[i];
	    push$9(encoded, exec$4(regexNonASCII, label) ? 'xn--' + encode(label) : label);
	  }
	...
	var join$2 = uncurryThis$o([].join);
	var push$8 = uncurryThis$o([].push);
	var replace$2 = uncurryThis$o(''.replace);
	...
	var exec$2 = uncurryThis$n(/./.exec);
	var join$1 = uncurryThis$n([].join);
	var numberToString$1 = uncurryThis$n(1.1.toString);
	...
	var forEach$2 = uncurryThis$m(URLSearchParamsPrototype$2.forEach);
	...
	var forEach$1 = uncurryThis$k(URLSearchParamsPrototype.forEach);
	...
	var DataView$3 = globalThis$l.DataView;
	...
	if (DESCRIPTORS$7 && !('detached' in ArrayBufferPrototype$3)) {
	  defineBuiltInAccessor$4(ArrayBufferPrototype$3, 'detached', {
	    configurable: true,
	...
	var slice$1 = uncurryThis$j(ArrayBufferPrototype$2.slice);
	...
	var getInt8 = uncurryThis$j(DataViewPrototype$1.getInt8);
	...
	var reduceWithoutClosingOnEarlyError = !FAILS_ON_INITIAL_UNDEFINED && iteratorHelperWithoutClosingOnEarlyError$4('reduce', $TypeError$8);
	...
	$$l({ target: 'Object', stat: true, sham: !DESCRIPTORS$6 }, {
	...
	var NativeRegExp = globalThis$g.RegExp;
	var RegExpPrototype$2 = NativeRegExp.prototype;
	var SyntaxError$3 = globalThis$g.SyntaxError;
	var exec$1 = uncurryThis$i(RegExpPrototype$2.exec);
	...
	if (isForced('RegExp', BASE_FORCED)) {
	  ...
	  defineBuiltIn$2(globalThis$g, 'RegExp', RegExpWrapper, { constructor: true });
	}
	...
	var push$5 = uncurryThis$h(test.push);
	...
	var getIteratorFlattenable$1 = function (obj, stringHandling) {
	  if (!stringHandling || typeof obj !== 'string') anObject$7(obj);
	  var method = getIteratorMethod$1(obj);
	  return getIteratorDirect$4(anObject$7(method !== undefined ? call$b(method, obj) : obj));
	};
	...
	var IteratorProxy$1 = createIteratorProxy$1(function () {
	  ...
	  while (true) {
	    if (inner = this.inner) try {
	      result = anObject$6(call$a(inner.next, inner.iterator));
	      if (!result.done) return result.value;
	      this.inner = null;
	    } catch (error) { iteratorClose$2(iterator, 'throw', error); }

	    result = anObject$6(call$a(this.next, iterator));
	...
	$$h({ target: 'Iterator', proto: true, real: true, forced: FORCED$2 }, {
	  flatMap: function flatMap(mapper) {
	    ...
	    if (flatMapWithoutClosingOnEarlyError) return call$a(flatMapWithoutClosingOnEarlyError, this, mapper);
	...
	$$f({ target: 'Iterator', proto: true, real: true }, {
	  toArray: function toArray() {
	    var result = [];
	    iterate$2(getIteratorDirect$1(anObject$4(this)), push$4, { that: result, IS_RECORD: true });
	    return result;
	  }
	});
	...
	var IteratorProxy = createIteratorProxy(function () {
	  ...
	  while (this.remaining) {
	    this.remaining--;
	    result = anObject$3(call$8(next, iterator));
	    done = this.done = !!result.done;
	    if (done) return;
	  }
	  result = anObject$3(call$8(next, iterator));
	...
	$$9({ target: 'Array', proto: true }, {
	  flat: function flat(/* depthArg = 1 */) {
	    ...
	    var sourceLen = lengthOfArrayLike$8(O);
	...
	var nativeMatchAll = uncurryThis$e(''.matchAll);
	...
	var $RegExpStringIterator = createIteratorConstructor(function RegExpStringIterator(regexp, string, $global, fullUnicode) {
	  ...
	  if (state.global) {
	    if (toString$2(match[0]) === '') R.lastIndex = advanceStringIndex$1(S, toLength$3(R.lastIndex), state.unicode);
	...
	$$8({ target: 'String', proto: true, forced: WORKS_WITH_NON_GLOBAL_REGEX }, {
	  matchAll: function matchAll(regexp) {
	    ...
	    if (isObject$7(regexp)) {
	      if (isRegExp$1(regexp)) {
	        flags = toString$2(requireObjectCoercible$2(getRegExpFlags$2(regexp)));
	      ...
	      if (matcher) return call$7(matcher, regexp, O);
	...
	$$7({ target: 'String', proto: true }, {
	  replaceAll: function replaceAll(searchValue, replaceValue) {
	    ...
	    var result = '';
	    if (isObject$6(searchValue)) {
	      IS_REG_EXP = isRegExp(searchValue);
	      if (IS_REG_EXP) {
	        flags = toString$1(requireObjectCoercible$1(getRegExpFlags$1(searchValue)));
	      ...
	      if (replacer) return call$6(replacer, searchValue, O, replaceValue);
	    }
	    string = toString$1(O);
	...
	fixRegExpWellKnownSymbolLogic('split', function (SPLIT, nativeSplit, maybeCallNative) {
	  ...
	  return [
	    ...
	    function split(separator, limit) {
	      ...
	      var splitter = isObject$5(separator) ? getMethod(separator, SPLIT) : undefined;
	      return splitter
	...
	if (Uint8Array$3) $$5({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS$2 }, {
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (globalThis$4.Uint8Array) $$4({ target: 'Uint8Array', proto: true }, {
	...
	// https://github.com/tc39/proposal-arraybuffer-base64
	if (Uint8Array$1) $$3({ target: 'Uint8Array', proto: true, forced: INCORRECT_BEHAVIOR_OR_DOESNT_EXISTS$1 }, {
	...
	var tryToTransfer = function (rawTransfer, map) {
	  ...
	  iterate$1(rawTransfer, function (value) {
