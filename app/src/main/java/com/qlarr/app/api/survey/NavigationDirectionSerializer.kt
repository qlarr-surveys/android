...
class NavigationDirectionDeserializer :
    StdDeserializer<NavigationDirection>(NavigationDirection::class.java) {
...
class NavigationDirectionSerializer :
    StdSerializer<NavigationDirection>(NavigationDirection::class.java) {
